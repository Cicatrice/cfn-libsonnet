(import '../../../extensions/attributes.libsonnet') + {
  ...
  '#withExplainerConfig':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sagemaker-endpointconfig.html#cfn-sagemaker-endpointconfig-explainerconfig', args=[d.arg(name='explainerConfig', type=d.T.object)]),
  withExplainerConfig(explainerConfig): { Properties+: { ExplainerConfig: explainerConfig } },
  '#withExplainerConfigMixin':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sagemaker-endpointconfig.html#cfn-sagemaker-endpointconfig-explainerconfig', args=[d.arg(name='explainerConfig', type=d.T.object)]),
  withExplainerConfigMixin(explainerConfig): { Properties+: { ExplainerConfig+: explainerConfig } },
