(import '../../../extensions/attributes.libsonnet') + {
  ...
  '#withInvokeMode':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-lambda-url.html#cfn-lambda-url-invokemode', args=[d.arg(name='invokeMode', type=d.T.string)]),
  withInvokeMode(invokeMode): { Properties+: { InvokeMode: invokeMode } },
