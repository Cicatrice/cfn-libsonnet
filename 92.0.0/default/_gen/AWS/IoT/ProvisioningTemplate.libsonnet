(import '../../../extensions/attributes.libsonnet') + {
  ...
  '#withTemplateType':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iot-provisioningtemplate.html#cfn-iot-provisioningtemplate-templatetype', args=[d.arg(name='templateType', type=d.T.string)]),
  withTemplateType(templateType): { Properties+: { TemplateType: templateType } },
}
