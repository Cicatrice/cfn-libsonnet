(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::AppFlow::ConnectorProfile', Properties: { ConnectorProfileName: if errorOnEmptyProp then (error 'You need to define ConnectorProfileName properties for AWS::AppFlow::ConnectorProfile resource') else null, ConnectorType: if errorOnEmptyProp then (error 'You need to define ConnectorType properties for AWS::AppFlow::ConnectorProfile resource') else null, ConnectionMode: if errorOnEmptyProp then (error 'You need to define ConnectionMode properties for AWS::AppFlow::ConnectorProfile resource') else null } },
  ...
  '#withConnectorLabel':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appflow-connectorprofile.html#cfn-appflow-connectorprofile-connectorlabel', args=[d.arg(name='connectorLabel', type=d.T.string)]),
  withConnectorLabel(connectorLabel): { Properties+: { ConnectorLabel: connectorLabel } },
