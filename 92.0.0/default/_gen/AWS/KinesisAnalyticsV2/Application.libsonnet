(import '../../../extensions/attributes.libsonnet') + {
  ...
  '#withApplicationMaintenanceConfiguration':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-kinesisanalyticsv2-application.html#cfn-kinesisanalyticsv2-application-applicationmaintenanceconfiguration', args=[d.arg(name='applicationMaintenanceConfiguration', type=d.T.object)]),
  withApplicationMaintenanceConfiguration(applicationMaintenanceConfiguration): { Properties+: { ApplicationMaintenanceConfiguration: applicationMaintenanceConfiguration } },
  '#withApplicationMaintenanceConfigurationMixin':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-kinesisanalyticsv2-application.html#cfn-kinesisanalyticsv2-application-applicationmaintenanceconfiguration', args=[d.arg(name='applicationMaintenanceConfiguration', type=d.T.object)]),
  withApplicationMaintenanceConfigurationMixin(applicationMaintenanceConfiguration): { Properties+: { ApplicationMaintenanceConfiguration+: applicationMaintenanceConfiguration } },
  ...
  '#withRunConfiguration':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-kinesisanalyticsv2-application.html#cfn-kinesisanalyticsv2-application-runconfiguration', args=[d.arg(name='runConfiguration', type=d.T.object)]),
  withRunConfiguration(runConfiguration): { Properties+: { RunConfiguration: runConfiguration } },
  '#withRunConfigurationMixin':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-kinesisanalyticsv2-application.html#cfn-kinesisanalyticsv2-application-runconfiguration', args=[d.arg(name='runConfiguration', type=d.T.object)]),
  withRunConfigurationMixin(runConfiguration): { Properties+: { RunConfiguration+: runConfiguration } },
