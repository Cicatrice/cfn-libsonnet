(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Location::Tracker', Properties: { TrackerName: if errorOnEmptyProp then (error 'You need to define TrackerName properties for AWS::Location::Tracker resource') else null } },
