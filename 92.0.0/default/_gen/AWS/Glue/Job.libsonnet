(import '../../../extensions/attributes.libsonnet') + {
  ...
  '#withExecutionClass':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-glue-job.html#cfn-glue-job-executionclass', args=[d.arg(name='executionClass', type=d.T.string)]),
  withExecutionClass(executionClass): { Properties+: { ExecutionClass: executionClass } },
  ...
  '#withNonOverridableArguments':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-glue-job.html#cfn-glue-job-nonoverridablearguments', args=[d.arg(name='nonOverridableArguments', type=d.T.object)]),
  withNonOverridableArguments(nonOverridableArguments): { Properties+: { NonOverridableArguments: nonOverridableArguments } },
  '#withNonOverridableArgumentsMixin':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-glue-job.html#cfn-glue-job-nonoverridablearguments', args=[d.arg(name='nonOverridableArguments', type=d.T.object)]),
  withNonOverridableArgumentsMixin(nonOverridableArguments): { Properties+: { NonOverridableArguments+: nonOverridableArguments } },
