(import '../../../extensions/attributes.libsonnet') + {
  ...
  '#withTlsPolicyName':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-lightsail-loadbalancer.html#cfn-lightsail-loadbalancer-tlspolicyname', args=[d.arg(name='tlsPolicyName', type=d.T.string)]),
  withTlsPolicyName(tlsPolicyName): { Properties+: { TlsPolicyName: tlsPolicyName } },
}
