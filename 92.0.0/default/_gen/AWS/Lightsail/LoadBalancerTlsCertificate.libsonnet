(import '../../../extensions/attributes.libsonnet') + {
  ...
  '#withHttpsRedirectionEnabled':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-lightsail-loadbalancertlscertificate.html#cfn-lightsail-loadbalancertlscertificate-httpsredirectionenabled', args=[d.arg(name='httpsRedirectionEnabled', type=d.T.bool)]),
  withHttpsRedirectionEnabled(httpsRedirectionEnabled): { Properties+: { HttpsRedirectionEnabled: httpsRedirectionEnabled } },
