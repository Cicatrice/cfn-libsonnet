(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Lightsail::Instance', Properties: { InstanceName: if errorOnEmptyProp then (error 'You need to define InstanceName properties for AWS::Lightsail::Instance resource') else null, BlueprintId: if errorOnEmptyProp then (error 'You need to define BlueprintId properties for AWS::Lightsail::Instance resource') else null, BundleId: if errorOnEmptyProp then (error 'You need to define BundleId properties for AWS::Lightsail::Instance resource') else null } },
