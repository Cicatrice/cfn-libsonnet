(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Logs::Destination', Properties: { RoleArn: if errorOnEmptyProp then (error 'You need to define RoleArn properties for AWS::Logs::Destination resource') else null, TargetArn: if errorOnEmptyProp then (error 'You need to define TargetArn properties for AWS::Logs::Destination resource') else null, DestinationName: if errorOnEmptyProp then (error 'You need to define DestinationName properties for AWS::Logs::Destination resource') else null } },
