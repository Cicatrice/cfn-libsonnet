(import '../../../extensions/attributes.libsonnet') + {
  ...
  '#withOptions':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-transitgatewayattachment.html#cfn-ec2-transitgatewayattachment-options', args=[d.arg(name='options', type=d.T.object)]),
  withOptions(options): { Properties+: { Options: options } },
  '#withOptionsMixin':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-transitgatewayattachment.html#cfn-ec2-transitgatewayattachment-options', args=[d.arg(name='options', type=d.T.object)]),
