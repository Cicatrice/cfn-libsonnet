(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::GuardDuty::Filter', Properties: { FindingCriteria: if errorOnEmptyProp then (error 'You need to define FindingCriteria properties for AWS::GuardDuty::Filter resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::GuardDuty::Filter resource') else null, Rank: if errorOnEmptyProp then (error 'You need to define Rank properties for AWS::GuardDuty::Filter resource') else null, Action: if errorOnEmptyProp then (error 'You need to define Action properties for AWS::GuardDuty::Filter resource') else null, Description: if errorOnEmptyProp then (error 'You need to define Description properties for AWS::GuardDuty::Filter resource') else null, DetectorId: if errorOnEmptyProp then (error 'You need to define DetectorId properties for AWS::GuardDuty::Filter resource') else null } },
  ...
  '#withTags':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-guardduty-filter.html#cfn-guardduty-filter-tags', args=[d.arg(name='tags', type=d.T.array)]),
  withTags(tags): { Properties+: { Tags: tags } },
  '#withTagsMixin':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-guardduty-filter.html#cfn-guardduty-filter-tags', args=[d.arg(name='tags', type=d.T.array)]),
