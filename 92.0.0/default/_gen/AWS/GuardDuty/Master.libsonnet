(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::GuardDuty::Master', Properties: { MasterId: if errorOnEmptyProp then (error 'You need to define MasterId properties for AWS::GuardDuty::Master resource') else null, DetectorId: if errorOnEmptyProp then (error 'You need to define DetectorId properties for AWS::GuardDuty::Master resource') else null } },
