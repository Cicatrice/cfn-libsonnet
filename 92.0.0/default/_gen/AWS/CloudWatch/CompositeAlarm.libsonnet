(import '../../../extensions/attributes.libsonnet') + {
  ...
  '#withActionsSuppressor':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cloudwatch-compositealarm.html#cfn-cloudwatch-compositealarm-actionssuppressor', args=[d.arg(name='actionsSuppressor', type=d.T.string)]),
  withActionsSuppressor(actionsSuppressor): { Properties+: { ActionsSuppressor: actionsSuppressor } },
  '#withActionsSuppressorExtensionPeriod':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cloudwatch-compositealarm.html#cfn-cloudwatch-compositealarm-actionssuppressorextensionperiod', args=[d.arg(name='actionsSuppressorExtensionPeriod', type=d.T.number)]),
  withActionsSuppressorExtensionPeriod(actionsSuppressorExtensionPeriod): { Properties+: { ActionsSuppressorExtensionPeriod: actionsSuppressorExtensionPeriod } },
  '#withActionsSuppressorWaitPeriod':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cloudwatch-compositealarm.html#cfn-cloudwatch-compositealarm-actionssuppressorwaitperiod', args=[d.arg(name='actionsSuppressorWaitPeriod', type=d.T.number)]),
  withActionsSuppressorWaitPeriod(actionsSuppressorWaitPeriod): { Properties+: { ActionsSuppressorWaitPeriod: actionsSuppressorWaitPeriod } },
