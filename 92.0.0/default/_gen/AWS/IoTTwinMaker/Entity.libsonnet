(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::IoTTwinMaker::Entity', Properties: { EntityName: if errorOnEmptyProp then (error 'You need to define EntityName properties for AWS::IoTTwinMaker::Entity resource') else null, WorkspaceId: if errorOnEmptyProp then (error 'You need to define WorkspaceId properties for AWS::IoTTwinMaker::Entity resource') else null } },
