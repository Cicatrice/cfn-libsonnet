(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::IoTTwinMaker::Scene', Properties: { SceneId: if errorOnEmptyProp then (error 'You need to define SceneId properties for AWS::IoTTwinMaker::Scene resource') else null, WorkspaceId: if errorOnEmptyProp then (error 'You need to define WorkspaceId properties for AWS::IoTTwinMaker::Scene resource') else null, ContentLocation: if errorOnEmptyProp then (error 'You need to define ContentLocation properties for AWS::IoTTwinMaker::Scene resource') else null } },
