(import '../../../extensions/attributes.libsonnet') + {
  ...
  '#withOutpostConfig':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-eks-cluster.html#cfn-eks-cluster-outpostconfig', args=[d.arg(name='outpostConfig', type=d.T.object)]),
  withOutpostConfig(outpostConfig): { Properties+: { OutpostConfig: outpostConfig } },
  '#withOutpostConfigMixin':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-eks-cluster.html#cfn-eks-cluster-outpostconfig', args=[d.arg(name='outpostConfig', type=d.T.object)]),
  withOutpostConfigMixin(outpostConfig): { Properties+: { OutpostConfig+: outpostConfig } },
