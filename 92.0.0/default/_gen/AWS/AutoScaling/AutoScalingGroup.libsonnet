(import '../../../extensions/attributes.libsonnet') + {
  ...
  '#withDefaultInstanceWarmup':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-as-group.html#cfn-as-group-defaultinstancewarmup', args=[d.arg(name='defaultInstanceWarmup', type=d.T.number)]),
  withDefaultInstanceWarmup(defaultInstanceWarmup): { Properties+: { DefaultInstanceWarmup: defaultInstanceWarmup } },
