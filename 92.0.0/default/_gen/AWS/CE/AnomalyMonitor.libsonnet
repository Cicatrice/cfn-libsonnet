(import '../../../extensions/attributes.libsonnet') + {
  ...
  '#withResourceTags':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ce-anomalymonitor.html#cfn-ce-anomalymonitor-resourcetags', args=[d.arg(name='resourceTags', type=d.T.array)]),
  withResourceTags(resourceTags): { Properties+: { ResourceTags: resourceTags } },
  '#withResourceTagsMixin':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ce-anomalymonitor.html#cfn-ce-anomalymonitor-resourcetags', args=[d.arg(name='resourceTags', type=d.T.array)]),
