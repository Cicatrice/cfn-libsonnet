(import '../../../extensions/attributes.libsonnet') + {
  ...
  '#withCustomDeliveryConfiguration':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pinpoint-campaign.html#cfn-pinpoint-campaign-customdeliveryconfiguration', args=[d.arg(name='customDeliveryConfiguration', type=d.T.object)]),
  withCustomDeliveryConfiguration(customDeliveryConfiguration): { Properties+: { CustomDeliveryConfiguration: customDeliveryConfiguration } },
  '#withCustomDeliveryConfigurationMixin':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pinpoint-campaign.html#cfn-pinpoint-campaign-customdeliveryconfiguration', args=[d.arg(name='customDeliveryConfiguration', type=d.T.object)]),
  withCustomDeliveryConfigurationMixin(customDeliveryConfiguration): { Properties+: { CustomDeliveryConfiguration+: customDeliveryConfiguration } },
  ...
  '#withTemplateConfiguration':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pinpoint-campaign.html#cfn-pinpoint-campaign-templateconfiguration', args=[d.arg(name='templateConfiguration', type=d.T.object)]),
  withTemplateConfiguration(templateConfiguration): { Properties+: { TemplateConfiguration: templateConfiguration } },
  '#withTemplateConfigurationMixin':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pinpoint-campaign.html#cfn-pinpoint-campaign-templateconfiguration', args=[d.arg(name='templateConfiguration', type=d.T.object)]),
  withTemplateConfigurationMixin(templateConfiguration): { Properties+: { TemplateConfiguration+: templateConfiguration } },
