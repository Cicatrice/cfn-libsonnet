(import '../../../extensions/attributes.libsonnet') + {
  ...
  '#withAttributeDefinitions':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-dynamodb-table.html#cfn-dynamodb-table-attributedefinitions', args=[d.arg(name='attributeDefinitions', type=d.T.array)]),
  withAttributeDefinitions(attributeDefinitions): { Properties+: { AttributeDefinitions: attributeDefinitions } },
  '#withAttributeDefinitionsMixin':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-dynamodb-table.html#cfn-dynamodb-table-attributedefinitions', args=[d.arg(name='attributeDefinitions', type=d.T.array)]),
  ...
  '#withContributorInsightsSpecification':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-dynamodb-table.html#cfn-dynamodb-table-contributorinsightsspecification', args=[d.arg(name='contributorInsightsSpecification', type=d.T.object)]),
  ...
  '#withContributorInsightsSpecificationMixin':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-dynamodb-table.html#cfn-dynamodb-table-contributorinsightsspecification', args=[d.arg(name='contributorInsightsSpecification', type=d.T.object)]),
  ...
  '#withGlobalSecondaryIndexes':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-dynamodb-table.html#cfn-dynamodb-table-globalsecondaryindexes', args=[d.arg(name='globalSecondaryIndexes', type=d.T.array)]),
  withGlobalSecondaryIndexes(globalSecondaryIndexes): { Properties+: { GlobalSecondaryIndexes: globalSecondaryIndexes } },
  '#withGlobalSecondaryIndexesMixin':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-dynamodb-table.html#cfn-dynamodb-table-globalsecondaryindexes', args=[d.arg(name='globalSecondaryIndexes', type=d.T.array)]),
  withGlobalSecondaryIndexesMixin(globalSecondaryIndexes): { Properties+: { GlobalSecondaryIndexes+: globalSecondaryIndexes } },
  '#withImportSourceSpecification':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-dynamodb-table.html#cfn-dynamodb-table-importsourcespecification', args=[d.arg(name='importSourceSpecification', type=d.T.object)]),
  withImportSourceSpecification(importSourceSpecification): { Properties+: { ImportSourceSpecification: importSourceSpecification } },
  '#withImportSourceSpecificationMixin':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-dynamodb-table.html#cfn-dynamodb-table-importsourcespecification', args=[d.arg(name='importSourceSpecification', type=d.T.object)]),
  withImportSourceSpecificationMixin(importSourceSpecification): { Properties+: { ImportSourceSpecification+: importSourceSpecification } },
  ...
  '#withLocalSecondaryIndexes':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-dynamodb-table.html#cfn-dynamodb-table-localsecondaryindexes', args=[d.arg(name='localSecondaryIndexes', type=d.T.array)]),
  withLocalSecondaryIndexes(localSecondaryIndexes): { Properties+: { LocalSecondaryIndexes: localSecondaryIndexes } },
  '#withLocalSecondaryIndexesMixin':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-dynamodb-table.html#cfn-dynamodb-table-localsecondaryindexes', args=[d.arg(name='localSecondaryIndexes', type=d.T.array)]),
