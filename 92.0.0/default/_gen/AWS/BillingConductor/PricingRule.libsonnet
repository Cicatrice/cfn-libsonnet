(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::BillingConductor::PricingRule', Properties: { Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::BillingConductor::PricingRule resource') else null, Scope: if errorOnEmptyProp then (error 'You need to define Scope properties for AWS::BillingConductor::PricingRule resource') else null, Type: if errorOnEmptyProp then (error 'You need to define Type properties for AWS::BillingConductor::PricingRule resource') else null, ModifierPercentage: if errorOnEmptyProp then (error 'You need to define ModifierPercentage properties for AWS::BillingConductor::PricingRule resource') else null } },
