(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::CE::AnomalyMonitor', Properties: { MonitorName: if errorOnEmptyProp then (error 'You need to define MonitorName properties for AWS::CE::AnomalyMonitor resource') else null, MonitorType: if errorOnEmptyProp then (error 'You need to define MonitorType properties for AWS::CE::AnomalyMonitor resource') else null } },
