{
  ...
  new(): { Type: 'AWS::CE::AnomalyMonitor', Properties: { MonitorType: (error 'You need to define MonitorType properties for AWS::CE::AnomalyMonitor resource'), MonitorName: (error 'You need to define MonitorName properties for AWS::CE::AnomalyMonitor resource') } },
