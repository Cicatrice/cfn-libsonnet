(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Macie::CustomDataIdentifier', Properties: { Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::Macie::CustomDataIdentifier resource') else null, Regex: if errorOnEmptyProp then (error 'You need to define Regex properties for AWS::Macie::CustomDataIdentifier resource') else null } },
