{
  ...
  new(): { Type: 'AWS::GameLift::MatchmakingConfiguration', Properties: { Name: (error 'You need to define Name properties for AWS::GameLift::MatchmakingConfiguration resource'), RequestTimeoutSeconds: (error 'You need to define RequestTimeoutSeconds properties for AWS::GameLift::MatchmakingConfiguration resource'), AcceptanceRequired: (error 'You need to define AcceptanceRequired properties for AWS::GameLift::MatchmakingConfiguration resource'), RuleSetName: (error 'You need to define RuleSetName properties for AWS::GameLift::MatchmakingConfiguration resource') } },
