(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::GameLift::Fleet', Properties: {} },
  ...
  '#withLocations':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-gamelift-fleet.html#cfn-gamelift-fleet-locations', args=[d.arg(name='locations', type=d.T.array)]),
  withLocations(locations): { Properties+: { Locations: locations } },
  '#withLocationsMixin':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-gamelift-fleet.html#cfn-gamelift-fleet-locations', args=[d.arg(name='locations', type=d.T.array)]),
