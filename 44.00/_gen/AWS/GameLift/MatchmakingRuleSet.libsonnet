{
  ...
  new(): { Type: 'AWS::GameLift::MatchmakingRuleSet', Properties: { RuleSetBody: (error 'You need to define RuleSetBody properties for AWS::GameLift::MatchmakingRuleSet resource'), Name: (error 'You need to define Name properties for AWS::GameLift::MatchmakingRuleSet resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-gamelift-matchmakingruleset.html', args=[]),
