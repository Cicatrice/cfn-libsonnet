{
  ...
  '#':: d.pkg(name='AWS.GameLift.MatchmakingRuleSet', url='', help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-gamelift-matchmakingruleset.html'),
