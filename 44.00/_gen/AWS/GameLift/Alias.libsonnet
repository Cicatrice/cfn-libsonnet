{
  ...
  new(): { Type: 'AWS::GameLift::Alias', Properties: { Name: (error 'You need to define Name properties for AWS::GameLift::Alias resource'), RoutingStrategy: (error 'You need to define RoutingStrategy properties for AWS::GameLift::Alias resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-gamelift-alias.html', args=[]),
