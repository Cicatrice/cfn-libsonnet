{
  ...
  '#':: d.pkg(name='AWS.AppFlow.ConnectorProfile', url='', help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appflow-connectorprofile.html'),
