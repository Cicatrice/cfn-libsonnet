(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::SSO::Assignment', Properties: { TargetId: if errorOnEmptyProp then (error 'You need to define TargetId properties for AWS::SSO::Assignment resource') else null, TargetType: if errorOnEmptyProp then (error 'You need to define TargetType properties for AWS::SSO::Assignment resource') else null, PermissionSetArn: if errorOnEmptyProp then (error 'You need to define PermissionSetArn properties for AWS::SSO::Assignment resource') else null, PrincipalType: if errorOnEmptyProp then (error 'You need to define PrincipalType properties for AWS::SSO::Assignment resource') else null, PrincipalId: if errorOnEmptyProp then (error 'You need to define PrincipalId properties for AWS::SSO::Assignment resource') else null, InstanceArn: if errorOnEmptyProp then (error 'You need to define InstanceArn properties for AWS::SSO::Assignment resource') else null } },
