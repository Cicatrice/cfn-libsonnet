{
  ...
  new(): { Type: 'AWS::CodeBuild::Project', Properties: { Environment: (error 'You need to define Environment properties for AWS::CodeBuild::Project resource'), Source: (error 'You need to define Source properties for AWS::CodeBuild::Project resource'), Artifacts: (error 'You need to define Artifacts properties for AWS::CodeBuild::Project resource'), ServiceRole: (error 'You need to define ServiceRole properties for AWS::CodeBuild::Project resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-codebuild-project.html', args=[]),
