{
  ...
  new(): { Type: 'AWS::CloudWatch::Dashboard', Properties: { DashboardBody: (error 'You need to define DashboardBody properties for AWS::CloudWatch::Dashboard resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cloudwatch-dashboard.html', args=[]),
