{
  ...
  new(): { Type: 'AWS::ElasticLoadBalancingV2::TargetGroup' },
  ...
  '#withHealthCheckEnabled':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-elasticloadbalancingv2-targetgroup.html#cfn-elasticloadbalancingv2-targetgroup-healthcheckenabled', args=[d.arg(name='healthCheckEnabled', type=d.T.string)]),
  withHealthCheckEnabled(healthCheckEnabled): { Properties+: { HealthCheckEnabled: healthCheckEnabled } },
  '#withHealthCheckIntervalSeconds':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-elasticloadbalancingv2-targetgroup.html#cfn-elasticloadbalancingv2-targetgroup-healthcheckintervalseconds', args=[d.arg(name='healthCheckIntervalSeconds', type=d.T.string)]),
  ...
  '#withHealthCheckTimeoutSeconds':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-elasticloadbalancingv2-targetgroup.html#cfn-elasticloadbalancingv2-targetgroup-healthchecktimeoutseconds', args=[d.arg(name='healthCheckTimeoutSeconds', type=d.T.string)]),
  withHealthCheckTimeoutSeconds(healthCheckTimeoutSeconds): { Properties+: { HealthCheckTimeoutSeconds: healthCheckTimeoutSeconds } },
  '#withHealthyThresholdCount':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-elasticloadbalancingv2-targetgroup.html#cfn-elasticloadbalancingv2-targetgroup-healthythresholdcount', args=[d.arg(name='healthyThresholdCount', type=d.T.string)]),
  ...
  '#withMatcher':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-elasticloadbalancingv2-targetgroup.html#cfn-elasticloadbalancingv2-targetgroup-matcher', args=[d.arg(name='matcher', type=d.T.string)]),
  ...
  '#withPort':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-elasticloadbalancingv2-targetgroup.html#cfn-elasticloadbalancingv2-targetgroup-port', args=[d.arg(name='port', type=d.T.string)]),
  ...
  '#withTags':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-elasticloadbalancingv2-targetgroup.html#cfn-elasticloadbalancingv2-targetgroup-tags', args=[d.arg(name='tags', type=d.T.string)]),
  withTags(tags): { Properties+: { Tags: tags } },
  '#withTargetGroupAttributes':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-elasticloadbalancingv2-targetgroup.html#cfn-elasticloadbalancingv2-targetgroup-targetgroupattributes', args=[d.arg(name='targetGroupAttributes', type=d.T.string)]),
  ...
  '#withTargets':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-elasticloadbalancingv2-targetgroup.html#cfn-elasticloadbalancingv2-targetgroup-targets', args=[d.arg(name='targets', type=d.T.string)]),
  withTargets(targets): { Properties+: { Targets: targets } },
  '#withUnhealthyThresholdCount':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-elasticloadbalancingv2-targetgroup.html#cfn-elasticloadbalancingv2-targetgroup-unhealthythresholdcount', args=[d.arg(name='unhealthyThresholdCount', type=d.T.string)]),
