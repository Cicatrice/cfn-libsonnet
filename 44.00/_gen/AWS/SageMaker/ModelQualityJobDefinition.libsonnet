{
  ...
  new(): { Type: 'AWS::SageMaker::ModelQualityJobDefinition', Properties: { ModelQualityAppSpecification: (error 'You need to define ModelQualityAppSpecification properties for AWS::SageMaker::ModelQualityJobDefinition resource'), JobResources: (error 'You need to define JobResources properties for AWS::SageMaker::ModelQualityJobDefinition resource'), ModelQualityJobInput: (error 'You need to define ModelQualityJobInput properties for AWS::SageMaker::ModelQualityJobDefinition resource'), ModelQualityJobOutputConfig: (error 'You need to define ModelQualityJobOutputConfig properties for AWS::SageMaker::ModelQualityJobDefinition resource'), RoleArn: (error 'You need to define RoleArn properties for AWS::SageMaker::ModelQualityJobDefinition resource') } },
