(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::SageMaker::Pipeline', Properties: { PipelineName: if errorOnEmptyProp then (error 'You need to define PipelineName properties for AWS::SageMaker::Pipeline resource') else null, PipelineDefinition: if errorOnEmptyProp then (error 'You need to define PipelineDefinition properties for AWS::SageMaker::Pipeline resource') else null, RoleArn: if errorOnEmptyProp then (error 'You need to define RoleArn properties for AWS::SageMaker::Pipeline resource') else null } },
