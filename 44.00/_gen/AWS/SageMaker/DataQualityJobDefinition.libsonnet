{
  ...
  new(): { Type: 'AWS::SageMaker::DataQualityJobDefinition', Properties: { JobResources: (error 'You need to define JobResources properties for AWS::SageMaker::DataQualityJobDefinition resource'), RoleArn: (error 'You need to define RoleArn properties for AWS::SageMaker::DataQualityJobDefinition resource'), DataQualityAppSpecification: (error 'You need to define DataQualityAppSpecification properties for AWS::SageMaker::DataQualityJobDefinition resource'), DataQualityJobInput: (error 'You need to define DataQualityJobInput properties for AWS::SageMaker::DataQualityJobDefinition resource'), DataQualityJobOutputConfig: (error 'You need to define DataQualityJobOutputConfig properties for AWS::SageMaker::DataQualityJobDefinition resource') } },
