{
  ...
  new(): { Type: 'AWS::SageMaker::Endpoint', Properties: { EndpointConfigName: (error 'You need to define EndpointConfigName properties for AWS::SageMaker::Endpoint resource') } },
