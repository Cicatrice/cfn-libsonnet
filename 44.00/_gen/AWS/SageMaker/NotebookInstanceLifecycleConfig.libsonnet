{
  ...
  '#':: d.pkg(name='AWS.SageMaker.NotebookInstanceLifecycleConfig', url='', help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sagemaker-notebookinstancelifecycleconfig.html'),
