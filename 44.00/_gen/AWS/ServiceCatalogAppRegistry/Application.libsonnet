{
  ...
  new(): { Type: 'AWS::ServiceCatalogAppRegistry::Application', Properties: { Name: (error 'You need to define Name properties for AWS::ServiceCatalogAppRegistry::Application resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-servicecatalogappregistry-application.html', args=[]),
