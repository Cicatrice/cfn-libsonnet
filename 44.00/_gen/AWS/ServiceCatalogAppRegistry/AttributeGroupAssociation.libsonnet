(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ServiceCatalogAppRegistry::AttributeGroupAssociation', Properties: { Application: if errorOnEmptyProp then (error 'You need to define Application properties for AWS::ServiceCatalogAppRegistry::AttributeGroupAssociation resource') else null, AttributeGroup: if errorOnEmptyProp then (error 'You need to define AttributeGroup properties for AWS::ServiceCatalogAppRegistry::AttributeGroupAssociation resource') else null } },
