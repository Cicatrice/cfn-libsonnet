{
  ...
  new(): { Type: 'AWS::ServiceCatalogAppRegistry::AttributeGroup', Properties: { Name: (error 'You need to define Name properties for AWS::ServiceCatalogAppRegistry::AttributeGroup resource'), Attributes: (error 'You need to define Attributes properties for AWS::ServiceCatalogAppRegistry::AttributeGroup resource') } },
