{
  ...
  new(): { Type: 'AWS::MediaConnect::FlowSource', Properties: { Name: (error 'You need to define Name properties for AWS::MediaConnect::FlowSource resource'), Description: (error 'You need to define Description properties for AWS::MediaConnect::FlowSource resource') } },
