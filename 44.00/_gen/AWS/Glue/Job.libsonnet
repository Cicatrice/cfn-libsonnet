{
  ...
  new(): { Type: 'AWS::Glue::Job', Properties: { Command: (error 'You need to define Command properties for AWS::Glue::Job resource'), Role: (error 'You need to define Role properties for AWS::Glue::Job resource') } },
