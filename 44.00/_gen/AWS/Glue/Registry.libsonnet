{
  ...
  new(): { Type: 'AWS::Glue::Registry', Properties: { Name: (error 'You need to define Name properties for AWS::Glue::Registry resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-glue-registry.html', args=[]),
