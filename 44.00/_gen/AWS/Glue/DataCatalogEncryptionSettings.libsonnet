(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Glue::DataCatalogEncryptionSettings', Properties: { DataCatalogEncryptionSettings: if errorOnEmptyProp then (error 'You need to define DataCatalogEncryptionSettings properties for AWS::Glue::DataCatalogEncryptionSettings resource') else null, CatalogId: if errorOnEmptyProp then (error 'You need to define CatalogId properties for AWS::Glue::DataCatalogEncryptionSettings resource') else null } },
