{
  ...
  new(): { Type: 'AWS::Glue::Connection', Properties: { ConnectionInput: (error 'You need to define ConnectionInput properties for AWS::Glue::Connection resource'), CatalogId: (error 'You need to define CatalogId properties for AWS::Glue::Connection resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-glue-connection.html', args=[]),
