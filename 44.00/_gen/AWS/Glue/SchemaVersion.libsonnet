(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Glue::SchemaVersion', Properties: { Schema: if errorOnEmptyProp then (error 'You need to define Schema properties for AWS::Glue::SchemaVersion resource') else null, SchemaDefinition: if errorOnEmptyProp then (error 'You need to define SchemaDefinition properties for AWS::Glue::SchemaVersion resource') else null } },
