(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Glue::Partition', Properties: { CatalogId: if errorOnEmptyProp then (error 'You need to define CatalogId properties for AWS::Glue::Partition resource') else null, PartitionInput: if errorOnEmptyProp then (error 'You need to define PartitionInput properties for AWS::Glue::Partition resource') else null, TableName: if errorOnEmptyProp then (error 'You need to define TableName properties for AWS::Glue::Partition resource') else null, DatabaseName: if errorOnEmptyProp then (error 'You need to define DatabaseName properties for AWS::Glue::Partition resource') else null } },
