{
  ...
  new(): { Type: 'AWS::LookoutVision::Project', Properties: { ProjectName: (error 'You need to define ProjectName properties for AWS::LookoutVision::Project resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-lookoutvision-project.html', args=[]),
