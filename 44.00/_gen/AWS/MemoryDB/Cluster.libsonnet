{
  ...
  new(): { Type: 'AWS::MemoryDB::Cluster', Properties: { NodeType: (error 'You need to define NodeType properties for AWS::MemoryDB::Cluster resource'), ClusterName: (error 'You need to define ClusterName properties for AWS::MemoryDB::Cluster resource'), ACLName: (error 'You need to define ACLName properties for AWS::MemoryDB::Cluster resource') } },
