{
  ...
  new(): { Type: 'AWS::DataBrew::Job', Properties: { Name: (error 'You need to define Name properties for AWS::DataBrew::Job resource'), Type: (error 'You need to define Type properties for AWS::DataBrew::Job resource'), RoleArn: (error 'You need to define RoleArn properties for AWS::DataBrew::Job resource') } },
