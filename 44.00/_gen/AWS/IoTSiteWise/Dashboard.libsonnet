{
  ...
  new(): { Type: 'AWS::IoTSiteWise::Dashboard', Properties: { DashboardName: (error 'You need to define DashboardName properties for AWS::IoTSiteWise::Dashboard resource'), DashboardDescription: (error 'You need to define DashboardDescription properties for AWS::IoTSiteWise::Dashboard resource'), DashboardDefinition: (error 'You need to define DashboardDefinition properties for AWS::IoTSiteWise::Dashboard resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iotsitewise-dashboard.html', args=[]),
