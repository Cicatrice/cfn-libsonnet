{
  ...
  new(): { Type: 'AWS::WAF::XssMatchSet', Properties: { Name: (error 'You need to define Name properties for AWS::WAF::XssMatchSet resource'), XssMatchTuples: (error 'You need to define XssMatchTuples properties for AWS::WAF::XssMatchSet resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-waf-xssmatchset.html', args=[]),
