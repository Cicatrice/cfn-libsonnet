{
  ...
  new(): { Type: 'AWS::WAF::SizeConstraintSet', Properties: { Name: (error 'You need to define Name properties for AWS::WAF::SizeConstraintSet resource'), SizeConstraints: (error 'You need to define SizeConstraints properties for AWS::WAF::SizeConstraintSet resource') } },
