{
  ...
  new(): { Type: 'AWS::WAF::SqlInjectionMatchSet', Properties: { Name: (error 'You need to define Name properties for AWS::WAF::SqlInjectionMatchSet resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-waf-sqlinjectionmatchset.html', args=[]),
