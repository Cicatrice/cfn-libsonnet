{
  ...
  new(): { Type: 'AWS::ApiGatewayV2::Model', Properties: { Schema: (error 'You need to define Schema properties for AWS::ApiGatewayV2::Model resource'), ApiId: (error 'You need to define ApiId properties for AWS::ApiGatewayV2::Model resource'), Name: (error 'You need to define Name properties for AWS::ApiGatewayV2::Model resource') } },
