{
  ...
  new(): { Type: 'AWS::GuardDuty::Member', Properties: { MemberId: (error 'You need to define MemberId properties for AWS::GuardDuty::Member resource'), Email: (error 'You need to define Email properties for AWS::GuardDuty::Member resource'), DetectorId: (error 'You need to define DetectorId properties for AWS::GuardDuty::Member resource') } },
