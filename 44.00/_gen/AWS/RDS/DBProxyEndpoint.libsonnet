(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::RDS::DBProxyEndpoint', Properties: { DBProxyEndpointName: if errorOnEmptyProp then (error 'You need to define DBProxyEndpointName properties for AWS::RDS::DBProxyEndpoint resource') else null, DBProxyName: if errorOnEmptyProp then (error 'You need to define DBProxyName properties for AWS::RDS::DBProxyEndpoint resource') else null, VpcSubnetIds: if errorOnEmptyProp then (error 'You need to define VpcSubnetIds properties for AWS::RDS::DBProxyEndpoint resource') else null } },
