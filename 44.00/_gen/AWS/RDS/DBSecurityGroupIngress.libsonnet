{
  ...
  new(): { Type: 'AWS::RDS::DBSecurityGroupIngress', Properties: { DBSecurityGroupName: (error 'You need to define DBSecurityGroupName properties for AWS::RDS::DBSecurityGroupIngress resource') } },
