{
  ...
  new(): { Type: 'AWS::Route53RecoveryReadiness::ReadinessCheck', Properties: { ReadinessCheckName: (error 'You need to define ReadinessCheckName properties for AWS::Route53RecoveryReadiness::ReadinessCheck resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-route53recoveryreadiness-readinesscheck.html', args=[]),
