{
  ...
  '#':: d.pkg(name='AWS.Route53RecoveryReadiness.ReadinessCheck', url='', help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-route53recoveryreadiness-readinesscheck.html'),
