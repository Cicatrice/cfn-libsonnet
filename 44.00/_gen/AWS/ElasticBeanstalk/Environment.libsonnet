{
  ...
  new(): { Type: 'AWS::ElasticBeanstalk::Environment', Properties: { ApplicationName: (error 'You need to define ApplicationName properties for AWS::ElasticBeanstalk::Environment resource') } },
