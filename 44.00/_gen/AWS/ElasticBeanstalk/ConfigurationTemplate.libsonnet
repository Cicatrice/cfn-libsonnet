{
  ...
  new(): { Type: 'AWS::ElasticBeanstalk::ConfigurationTemplate', Properties: { ApplicationName: (error 'You need to define ApplicationName properties for AWS::ElasticBeanstalk::ConfigurationTemplate resource') } },
