(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Pinpoint::EventStream', Properties: { ApplicationId: if errorOnEmptyProp then (error 'You need to define ApplicationId properties for AWS::Pinpoint::EventStream resource') else null, DestinationStreamArn: if errorOnEmptyProp then (error 'You need to define DestinationStreamArn properties for AWS::Pinpoint::EventStream resource') else null, RoleArn: if errorOnEmptyProp then (error 'You need to define RoleArn properties for AWS::Pinpoint::EventStream resource') else null } },
