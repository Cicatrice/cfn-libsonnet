{
  ...
  new(): { Type: 'AWS::Pinpoint::App', Properties: { Name: (error 'You need to define Name properties for AWS::Pinpoint::App resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pinpoint-app.html', args=[]),
