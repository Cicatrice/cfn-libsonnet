{
  ...
  new(): { Type: 'AWS::Pinpoint::APNSChannel', Properties: { ApplicationId: (error 'You need to define ApplicationId properties for AWS::Pinpoint::APNSChannel resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pinpoint-apnschannel.html', args=[]),
