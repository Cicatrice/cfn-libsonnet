(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Pinpoint::EmailChannel', Properties: { Identity: if errorOnEmptyProp then (error 'You need to define Identity properties for AWS::Pinpoint::EmailChannel resource') else null, FromAddress: if errorOnEmptyProp then (error 'You need to define FromAddress properties for AWS::Pinpoint::EmailChannel resource') else null, ApplicationId: if errorOnEmptyProp then (error 'You need to define ApplicationId properties for AWS::Pinpoint::EmailChannel resource') else null } },
