(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Pinpoint::ADMChannel', Properties: { ClientSecret: if errorOnEmptyProp then (error 'You need to define ClientSecret properties for AWS::Pinpoint::ADMChannel resource') else null, ClientId: if errorOnEmptyProp then (error 'You need to define ClientId properties for AWS::Pinpoint::ADMChannel resource') else null, ApplicationId: if errorOnEmptyProp then (error 'You need to define ApplicationId properties for AWS::Pinpoint::ADMChannel resource') else null } },
