{
  ...
  new(): { Type: 'AWS::Pinpoint::GCMChannel', Properties: { ApiKey: (error 'You need to define ApiKey properties for AWS::Pinpoint::GCMChannel resource'), ApplicationId: (error 'You need to define ApplicationId properties for AWS::Pinpoint::GCMChannel resource') } },
