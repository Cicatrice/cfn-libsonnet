{
  ...
  new(): { Type: 'AWS::AppConfig::Application', Properties: { Name: (error 'You need to define Name properties for AWS::AppConfig::Application resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appconfig-application.html', args=[]),
