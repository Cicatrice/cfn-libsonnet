{
  ...
  '#':: d.pkg(name='AWS.AppConfig.DeploymentStrategy', url='', help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appconfig-deploymentstrategy.html'),
