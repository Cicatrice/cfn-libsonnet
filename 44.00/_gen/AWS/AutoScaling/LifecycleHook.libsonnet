{
  ...
  '#':: d.pkg(name='AWS.AutoScaling.LifecycleHook', url='', help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-autoscaling-lifecyclehook.html'),
