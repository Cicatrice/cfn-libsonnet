{
  ...
  new(): { Type: 'AWS::AutoScaling::LaunchConfiguration', Properties: { ImageId: (error 'You need to define ImageId properties for AWS::AutoScaling::LaunchConfiguration resource'), InstanceType: (error 'You need to define InstanceType properties for AWS::AutoScaling::LaunchConfiguration resource') } },
