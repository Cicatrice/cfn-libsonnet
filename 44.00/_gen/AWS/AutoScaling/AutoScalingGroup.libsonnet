{
  ...
  new(): { Type: 'AWS::AutoScaling::AutoScalingGroup', Properties: { MinSize: (error 'You need to define MinSize properties for AWS::AutoScaling::AutoScalingGroup resource'), MaxSize: (error 'You need to define MaxSize properties for AWS::AutoScaling::AutoScalingGroup resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-as-group.html', args=[]),
