{
  ...
  new(): { Type: 'AWS::S3::StorageLens', Properties: { StorageLensConfiguration: (error 'You need to define StorageLensConfiguration properties for AWS::S3::StorageLens resource') } },
