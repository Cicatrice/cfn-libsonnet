{
  ...
  new(): { Type: 'AWS::IoT1Click::Device', Properties: { DeviceId: (error 'You need to define DeviceId properties for AWS::IoT1Click::Device resource'), Enabled: (error 'You need to define Enabled properties for AWS::IoT1Click::Device resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iot1click-device.html', args=[]),
