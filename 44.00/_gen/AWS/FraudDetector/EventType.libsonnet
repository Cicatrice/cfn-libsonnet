(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::FraudDetector::EventType', Properties: { Labels: if errorOnEmptyProp then (error 'You need to define Labels properties for AWS::FraudDetector::EventType resource') else null, EntityTypes: if errorOnEmptyProp then (error 'You need to define EntityTypes properties for AWS::FraudDetector::EventType resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::FraudDetector::EventType resource') else null, EventVariables: if errorOnEmptyProp then (error 'You need to define EventVariables properties for AWS::FraudDetector::EventType resource') else null } },
