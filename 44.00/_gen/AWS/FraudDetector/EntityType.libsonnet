{
  ...
  '#':: d.pkg(name='AWS.FraudDetector.EntityType', url='', help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-frauddetector-entitytype.html'),
  ...
  '#withTags':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-frauddetector-entitytype.html#cfn-frauddetector-entitytype-tags', args=[d.arg(name='tags', type=d.T.string)]),
