{
  ...
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-frauddetector-entitytype.html', args=[]),
  new(): { Type: 'AWS::FraudDetector::EntityType' },
