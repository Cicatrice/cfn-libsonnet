{
  ...
  new(): { Type: 'AWS::FraudDetector::Outcome', Properties: { Name: (error 'You need to define Name properties for AWS::FraudDetector::Outcome resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-frauddetector-outcome.html', args=[]),
