{
  ...
  new(): { Type: 'AWS::CodeGuruReviewer::RepositoryAssociation', Properties: { Name: (error 'You need to define Name properties for AWS::CodeGuruReviewer::RepositoryAssociation resource'), Type: (error 'You need to define Type properties for AWS::CodeGuruReviewer::RepositoryAssociation resource') } },
