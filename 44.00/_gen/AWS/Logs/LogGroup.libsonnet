(import '../../../extensions/attributes.libsonnet') + {
  ...
  '#withRetentionInDays':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-logs-loggroup.html#cfn-logs-loggroup-retentionindays', args=[d.arg(name='retentionInDays', type=d.T.number)]),
