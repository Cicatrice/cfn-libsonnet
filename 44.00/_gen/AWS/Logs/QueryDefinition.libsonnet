{
  ...
  new(): { Type: 'AWS::Logs::QueryDefinition', Properties: { Name: (error 'You need to define Name properties for AWS::Logs::QueryDefinition resource'), QueryString: (error 'You need to define QueryString properties for AWS::Logs::QueryDefinition resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-logs-querydefinition.html', args=[]),
