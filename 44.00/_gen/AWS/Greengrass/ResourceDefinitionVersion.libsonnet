{
  ...
  new(): { Type: 'AWS::Greengrass::ResourceDefinitionVersion', Properties: { Resources: (error 'You need to define Resources properties for AWS::Greengrass::ResourceDefinitionVersion resource'), ResourceDefinitionId: (error 'You need to define ResourceDefinitionId properties for AWS::Greengrass::ResourceDefinitionVersion resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-greengrass-resourcedefinitionversion.html', args=[]),
