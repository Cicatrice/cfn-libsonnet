{
  ...
  '#':: d.pkg(name='AWS.CodeStarConnections.Connection', url='', help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-codestarconnections-connection.html'),
