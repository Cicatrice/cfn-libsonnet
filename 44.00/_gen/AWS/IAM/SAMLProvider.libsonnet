{
  ...
  new(): { Type: 'AWS::IAM::SAMLProvider', Properties: { SamlMetadataDocument: (error 'You need to define SamlMetadataDocument properties for AWS::IAM::SAMLProvider resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iam-samlprovider.html', args=[]),
