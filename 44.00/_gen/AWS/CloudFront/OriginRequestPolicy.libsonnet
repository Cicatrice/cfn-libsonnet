{
  ...
  new(): { Type: 'AWS::CloudFront::OriginRequestPolicy', Properties: { OriginRequestPolicyConfig: (error 'You need to define OriginRequestPolicyConfig properties for AWS::CloudFront::OriginRequestPolicy resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cloudfront-originrequestpolicy.html', args=[]),
