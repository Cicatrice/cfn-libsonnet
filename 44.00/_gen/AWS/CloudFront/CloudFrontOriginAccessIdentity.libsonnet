{
  ...
  '#':: d.pkg(name='AWS.CloudFront.CloudFrontOriginAccessIdentity', url='', help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cloudfront-cloudfrontoriginaccessidentity.html'),
