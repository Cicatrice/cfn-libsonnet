{
  ...
  new(): { Type: 'AWS::CloudFront::PublicKey', Properties: { PublicKeyConfig: (error 'You need to define PublicKeyConfig properties for AWS::CloudFront::PublicKey resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cloudfront-publickey.html', args=[]),
