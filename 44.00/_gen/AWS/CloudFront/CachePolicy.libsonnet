{
  ...
  new(): { Type: 'AWS::CloudFront::CachePolicy', Properties: { CachePolicyConfig: (error 'You need to define CachePolicyConfig properties for AWS::CloudFront::CachePolicy resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cloudfront-cachepolicy.html', args=[]),
