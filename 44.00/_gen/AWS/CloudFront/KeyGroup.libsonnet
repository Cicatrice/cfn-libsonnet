{
  ...
  new(): { Type: 'AWS::CloudFront::KeyGroup', Properties: { KeyGroupConfig: (error 'You need to define KeyGroupConfig properties for AWS::CloudFront::KeyGroup resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cloudfront-keygroup.html', args=[]),
