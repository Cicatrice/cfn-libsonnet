{
  ...
  new(): { Type: 'AWS::ServiceCatalog::TagOptionAssociation', Properties: { TagOptionId: (error 'You need to define TagOptionId properties for AWS::ServiceCatalog::TagOptionAssociation resource'), ResourceId: (error 'You need to define ResourceId properties for AWS::ServiceCatalog::TagOptionAssociation resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-servicecatalog-tagoptionassociation.html', args=[]),
