{
  ...
  new(): { Type: 'AWS::ServiceCatalog::Portfolio', Properties: { ProviderName: (error 'You need to define ProviderName properties for AWS::ServiceCatalog::Portfolio resource'), DisplayName: (error 'You need to define DisplayName properties for AWS::ServiceCatalog::Portfolio resource') } },
