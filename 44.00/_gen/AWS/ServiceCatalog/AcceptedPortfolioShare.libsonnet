{
  ...
  '#':: d.pkg(name='AWS.ServiceCatalog.AcceptedPortfolioShare', url='', help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-servicecatalog-acceptedportfolioshare.html'),
