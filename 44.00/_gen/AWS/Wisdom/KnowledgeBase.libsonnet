(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Wisdom::KnowledgeBase', Properties: { KnowledgeBaseType: if errorOnEmptyProp then (error 'You need to define KnowledgeBaseType properties for AWS::Wisdom::KnowledgeBase resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::Wisdom::KnowledgeBase resource') else null } },
