(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ECS::TaskSet', Properties: { TaskDefinition: if errorOnEmptyProp then (error 'You need to define TaskDefinition properties for AWS::ECS::TaskSet resource') else null, Service: if errorOnEmptyProp then (error 'You need to define Service properties for AWS::ECS::TaskSet resource') else null, Cluster: if errorOnEmptyProp then (error 'You need to define Cluster properties for AWS::ECS::TaskSet resource') else null } },
