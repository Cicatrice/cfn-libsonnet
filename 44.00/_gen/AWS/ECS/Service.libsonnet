{
  ...
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ecs-service.html', args=[]),
  new(): { Type: 'AWS::ECS::Service' },
  ...
  '#withCapacityProviderStrategy':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ecs-service.html#cfn-ecs-service-capacityproviderstrategy', args=[d.arg(name='capacityProviderStrategy', type=d.T.string)]),
  ...
  '#withDeploymentConfiguration':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ecs-service.html#cfn-ecs-service-deploymentconfiguration', args=[d.arg(name='deploymentConfiguration', type=d.T.string)]),
  withDeploymentConfiguration(deploymentConfiguration): { Properties+: { DeploymentConfiguration: deploymentConfiguration } },
  '#withDeploymentController':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ecs-service.html#cfn-ecs-service-deploymentcontroller', args=[d.arg(name='deploymentController', type=d.T.string)]),
  withDeploymentController(deploymentController): { Properties+: { DeploymentController: deploymentController } },
  '#withDesiredCount':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ecs-service.html#cfn-ecs-service-desiredcount', args=[d.arg(name='desiredCount', type=d.T.string)]),
  withDesiredCount(desiredCount): { Properties+: { DesiredCount: desiredCount } },
  '#withEnableECSManagedTags':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ecs-service.html#cfn-ecs-service-enableecsmanagedtags', args=[d.arg(name='enableEcsmanagedTags', type=d.T.string)]),
  withEnableECSManagedTags(enableEcsmanagedTags): { Properties+: { EnableECSManagedTags: enableEcsmanagedTags } },
  '#withEnableExecuteCommand':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ecs-service.html#cfn-ecs-service-enableexecutecommand', args=[d.arg(name='enableExecuteCommand', type=d.T.string)]),
  withEnableExecuteCommand(enableExecuteCommand): { Properties+: { EnableExecuteCommand: enableExecuteCommand } },
  '#withHealthCheckGracePeriodSeconds':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ecs-service.html#cfn-ecs-service-healthcheckgraceperiodseconds', args=[d.arg(name='healthCheckGracePeriodSeconds', type=d.T.string)]),
  ...
  '#withLoadBalancers':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ecs-service.html#cfn-ecs-service-loadbalancers', args=[d.arg(name='loadBalancers', type=d.T.string)]),
  withLoadBalancers(loadBalancers): { Properties+: { LoadBalancers: loadBalancers } },
  '#withNetworkConfiguration':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ecs-service.html#cfn-ecs-service-networkconfiguration', args=[d.arg(name='networkConfiguration', type=d.T.string)]),
  withNetworkConfiguration(networkConfiguration): { Properties+: { NetworkConfiguration: networkConfiguration } },
  '#withPlacementConstraints':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ecs-service.html#cfn-ecs-service-placementconstraints', args=[d.arg(name='placementConstraints', type=d.T.string)]),
  withPlacementConstraints(placementConstraints): { Properties+: { PlacementConstraints: placementConstraints } },
  '#withPlacementStrategies':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ecs-service.html#cfn-ecs-service-placementstrategies', args=[d.arg(name='placementStrategies', type=d.T.string)]),
  ...
  '#withServiceRegistries':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ecs-service.html#cfn-ecs-service-serviceregistries', args=[d.arg(name='serviceRegistries', type=d.T.string)]),
  withServiceRegistries(serviceRegistries): { Properties+: { ServiceRegistries: serviceRegistries } },
  '#withTags':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ecs-service.html#cfn-ecs-service-tags', args=[d.arg(name='tags', type=d.T.string)]),
