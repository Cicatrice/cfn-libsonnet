{
  ...
  new(): { Type: 'AWS::Config::AggregationAuthorization', Properties: { AuthorizedAwsRegion: (error 'You need to define AuthorizedAwsRegion properties for AWS::Config::AggregationAuthorization resource'), AuthorizedAccountId: (error 'You need to define AuthorizedAccountId properties for AWS::Config::AggregationAuthorization resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-config-aggregationauthorization.html', args=[]),
