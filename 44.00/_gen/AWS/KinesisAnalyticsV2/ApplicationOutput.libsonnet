{
  ...
  new(): { Type: 'AWS::KinesisAnalyticsV2::ApplicationOutput', Properties: { ApplicationName: (error 'You need to define ApplicationName properties for AWS::KinesisAnalyticsV2::ApplicationOutput resource'), Output: (error 'You need to define Output properties for AWS::KinesisAnalyticsV2::ApplicationOutput resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-kinesisanalyticsv2-applicationoutput.html', args=[]),
