{
  ...
  new(): { Type: 'AWS::Connect::UserHierarchyGroup', Properties: { Name: (error 'You need to define Name properties for AWS::Connect::UserHierarchyGroup resource'), InstanceArn: (error 'You need to define InstanceArn properties for AWS::Connect::UserHierarchyGroup resource') } },
