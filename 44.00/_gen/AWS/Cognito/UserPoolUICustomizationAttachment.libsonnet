(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Cognito::UserPoolUICustomizationAttachment', Properties: { ClientId: if errorOnEmptyProp then (error 'You need to define ClientId properties for AWS::Cognito::UserPoolUICustomizationAttachment resource') else null, UserPoolId: if errorOnEmptyProp then (error 'You need to define UserPoolId properties for AWS::Cognito::UserPoolUICustomizationAttachment resource') else null } },
