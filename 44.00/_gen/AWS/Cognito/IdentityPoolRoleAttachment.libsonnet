{
  ...
  new(): { Type: 'AWS::Cognito::IdentityPoolRoleAttachment', Properties: { IdentityPoolId: (error 'You need to define IdentityPoolId properties for AWS::Cognito::IdentityPoolRoleAttachment resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cognito-identitypoolroleattachment.html', args=[]),
