{
  ...
  new(): { Type: 'AWS::Inspector::ResourceGroup', Properties: { ResourceGroupTags: (error 'You need to define ResourceGroupTags properties for AWS::Inspector::ResourceGroup resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-inspector-resourcegroup.html', args=[]),
