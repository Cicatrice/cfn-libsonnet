{
  ...
  new(): { Type: 'AWS::ElastiCache::CacheCluster', Properties: { Engine: (error 'You need to define Engine properties for AWS::ElastiCache::CacheCluster resource'), NumCacheNodes: (error 'You need to define NumCacheNodes properties for AWS::ElastiCache::CacheCluster resource'), CacheNodeType: (error 'You need to define CacheNodeType properties for AWS::ElastiCache::CacheCluster resource') } },
