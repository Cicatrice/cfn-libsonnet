{
  ...
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticache-cache-cluster.html', args=[]),
  new(): { Type: 'AWS::ElastiCache::CacheCluster' },
