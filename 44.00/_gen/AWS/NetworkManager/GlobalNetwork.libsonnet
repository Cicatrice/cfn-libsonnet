{
  ...
  new(): { Type: 'AWS::NetworkManager::GlobalNetwork', Properties: {} },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-networkmanager-globalnetwork.html', args=[]),
