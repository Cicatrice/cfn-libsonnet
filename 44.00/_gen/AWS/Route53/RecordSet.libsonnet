{
  ...
  new(): { Type: 'AWS::Route53::RecordSet', Properties: { Name: (error 'You need to define Name properties for AWS::Route53::RecordSet resource'), Type: (error 'You need to define Type properties for AWS::Route53::RecordSet resource') } },
