{
  ...
  new(): { Type: 'AWS::CloudFormation::ModuleVersion', Properties: { ModuleName: (error 'You need to define ModuleName properties for AWS::CloudFormation::ModuleVersion resource'), ModulePackage: (error 'You need to define ModulePackage properties for AWS::CloudFormation::ModuleVersion resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cloudformation-moduleversion.html', args=[]),
