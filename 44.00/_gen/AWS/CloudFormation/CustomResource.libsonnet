{
  ...
  new(): { Type: 'AWS::CloudFormation::CustomResource', Properties: { ServiceToken: (error 'You need to define ServiceToken properties for AWS::CloudFormation::CustomResource resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cfn-customresource.html', args=[]),
