{
  ...
  new(): { Type: 'AWS::Events::EventBus', Properties: { Name: (error 'You need to define Name properties for AWS::Events::EventBus resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-events-eventbus.html', args=[]),
