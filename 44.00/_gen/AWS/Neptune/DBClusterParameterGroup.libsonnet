{
  ...
  new(): { Type: 'AWS::Neptune::DBClusterParameterGroup', Properties: { Parameters: (error 'You need to define Parameters properties for AWS::Neptune::DBClusterParameterGroup resource'), Family: (error 'You need to define Family properties for AWS::Neptune::DBClusterParameterGroup resource'), Description: (error 'You need to define Description properties for AWS::Neptune::DBClusterParameterGroup resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-neptune-dbclusterparametergroup.html', args=[]),
