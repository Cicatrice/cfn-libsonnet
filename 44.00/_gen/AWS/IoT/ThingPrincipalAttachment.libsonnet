(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::IoT::ThingPrincipalAttachment', Properties: { Principal: if errorOnEmptyProp then (error 'You need to define Principal properties for AWS::IoT::ThingPrincipalAttachment resource') else null, ThingName: if errorOnEmptyProp then (error 'You need to define ThingName properties for AWS::IoT::ThingPrincipalAttachment resource') else null } },
