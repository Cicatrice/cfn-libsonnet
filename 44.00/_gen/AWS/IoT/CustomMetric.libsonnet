{
  ...
  new(): { Type: 'AWS::IoT::CustomMetric', Properties: { MetricType: (error 'You need to define MetricType properties for AWS::IoT::CustomMetric resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iot-custommetric.html', args=[]),
