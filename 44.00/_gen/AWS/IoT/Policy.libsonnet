{
  ...
  new(): { Type: 'AWS::IoT::Policy', Properties: { PolicyDocument: (error 'You need to define PolicyDocument properties for AWS::IoT::Policy resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iot-policy.html', args=[]),
