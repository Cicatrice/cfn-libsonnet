{
  ...
  new(): { Type: 'AWS::RoboMaker::RobotApplicationVersion', Properties: { Application: (error 'You need to define Application properties for AWS::RoboMaker::RobotApplicationVersion resource') } },
