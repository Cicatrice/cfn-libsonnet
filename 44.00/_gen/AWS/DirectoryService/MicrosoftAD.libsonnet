{
  ...
  new(): { Type: 'AWS::DirectoryService::MicrosoftAD', Properties: { Password: (error 'You need to define Password properties for AWS::DirectoryService::MicrosoftAD resource'), VpcSettings: (error 'You need to define VpcSettings properties for AWS::DirectoryService::MicrosoftAD resource'), Name: (error 'You need to define Name properties for AWS::DirectoryService::MicrosoftAD resource') } },
