(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Budgets::BudgetsAction', Properties: { NotificationType: if errorOnEmptyProp then (error 'You need to define NotificationType properties for AWS::Budgets::BudgetsAction resource') else null, ActionType: if errorOnEmptyProp then (error 'You need to define ActionType properties for AWS::Budgets::BudgetsAction resource') else null, ActionThreshold: if errorOnEmptyProp then (error 'You need to define ActionThreshold properties for AWS::Budgets::BudgetsAction resource') else null, ExecutionRoleArn: if errorOnEmptyProp then (error 'You need to define ExecutionRoleArn properties for AWS::Budgets::BudgetsAction resource') else null, Subscribers: if errorOnEmptyProp then (error 'You need to define Subscribers properties for AWS::Budgets::BudgetsAction resource') else null, Definition: if errorOnEmptyProp then (error 'You need to define Definition properties for AWS::Budgets::BudgetsAction resource') else null, BudgetName: if errorOnEmptyProp then (error 'You need to define BudgetName properties for AWS::Budgets::BudgetsAction resource') else null } },
