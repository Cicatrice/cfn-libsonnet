{
  ...
  new(): { Type: 'AWS::EC2::CustomerGateway', Properties: { Type: (error 'You need to define Type properties for AWS::EC2::CustomerGateway resource'), BgpAsn: (error 'You need to define BgpAsn properties for AWS::EC2::CustomerGateway resource'), IpAddress: (error 'You need to define IpAddress properties for AWS::EC2::CustomerGateway resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-customer-gateway.html', args=[]),
