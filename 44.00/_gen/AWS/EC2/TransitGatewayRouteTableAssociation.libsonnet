(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::EC2::TransitGatewayRouteTableAssociation', Properties: { TransitGatewayRouteTableId: if errorOnEmptyProp then (error 'You need to define TransitGatewayRouteTableId properties for AWS::EC2::TransitGatewayRouteTableAssociation resource') else null, TransitGatewayAttachmentId: if errorOnEmptyProp then (error 'You need to define TransitGatewayAttachmentId properties for AWS::EC2::TransitGatewayRouteTableAssociation resource') else null } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-transitgatewayroutetableassociation.html', args=[d.arg(name='errorOnEmptyProp', type=d.T.bool)]),
