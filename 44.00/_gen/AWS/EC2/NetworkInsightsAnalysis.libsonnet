(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::EC2::NetworkInsightsAnalysis', Properties: { NetworkInsightsPathId: if errorOnEmptyProp then (error 'You need to define NetworkInsightsPathId properties for AWS::EC2::NetworkInsightsAnalysis resource') else null } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-networkinsightsanalysis.html', args=[d.arg(name='errorOnEmptyProp', type=d.T.bool)]),
