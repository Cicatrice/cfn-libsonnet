{
  ...
  new(): { Type: 'AWS::EC2::InternetGateway', Properties: {} },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-internetgateway.html', args=[]),
