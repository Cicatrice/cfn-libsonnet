{
  ...
  '#':: d.pkg(name='AWS.EC2.VPCEndpointConnectionNotification', url='', help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-vpcendpointconnectionnotification.html'),
