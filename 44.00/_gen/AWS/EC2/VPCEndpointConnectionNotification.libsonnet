{
  ...
  new(): { Type: 'AWS::EC2::VPCEndpointConnectionNotification', Properties: { ConnectionEvents: (error 'You need to define ConnectionEvents properties for AWS::EC2::VPCEndpointConnectionNotification resource'), ConnectionNotificationArn: (error 'You need to define ConnectionNotificationArn properties for AWS::EC2::VPCEndpointConnectionNotification resource') } },
