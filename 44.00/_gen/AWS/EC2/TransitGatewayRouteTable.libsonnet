{
  ...
  new(): { Type: 'AWS::EC2::TransitGatewayRouteTable', Properties: { TransitGatewayId: (error 'You need to define TransitGatewayId properties for AWS::EC2::TransitGatewayRouteTable resource') } },
