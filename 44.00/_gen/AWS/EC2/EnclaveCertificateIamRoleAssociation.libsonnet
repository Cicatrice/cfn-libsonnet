{
  ...
  new(): { Type: 'AWS::EC2::EnclaveCertificateIamRoleAssociation', Properties: { CertificateArn: (error 'You need to define CertificateArn properties for AWS::EC2::EnclaveCertificateIamRoleAssociation resource'), RoleArn: (error 'You need to define RoleArn properties for AWS::EC2::EnclaveCertificateIamRoleAssociation resource') } },
