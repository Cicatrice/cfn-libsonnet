{
  ...
  new(): { Type: 'AWS::EC2::CarrierGateway', Properties: { VpcId: (error 'You need to define VpcId properties for AWS::EC2::CarrierGateway resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-carriergateway.html', args=[]),
