{
  ...
  new(): { Type: 'AWS::EC2::SubnetRouteTableAssociation', Properties: { RouteTableId: (error 'You need to define RouteTableId properties for AWS::EC2::SubnetRouteTableAssociation resource'), SubnetId: (error 'You need to define SubnetId properties for AWS::EC2::SubnetRouteTableAssociation resource') } },
