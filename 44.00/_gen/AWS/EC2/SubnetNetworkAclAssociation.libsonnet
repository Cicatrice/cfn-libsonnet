{
  ...
  new(): { Type: 'AWS::EC2::SubnetNetworkAclAssociation', Properties: { NetworkAclId: (error 'You need to define NetworkAclId properties for AWS::EC2::SubnetNetworkAclAssociation resource'), SubnetId: (error 'You need to define SubnetId properties for AWS::EC2::SubnetNetworkAclAssociation resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-subnet-network-acl-assoc.html', args=[]),
