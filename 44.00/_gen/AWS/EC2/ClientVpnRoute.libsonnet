{
  ...
  new(): { Type: 'AWS::EC2::ClientVpnRoute', Properties: { TargetVpcSubnetId: (error 'You need to define TargetVpcSubnetId properties for AWS::EC2::ClientVpnRoute resource'), DestinationCidrBlock: (error 'You need to define DestinationCidrBlock properties for AWS::EC2::ClientVpnRoute resource'), ClientVpnEndpointId: (error 'You need to define ClientVpnEndpointId properties for AWS::EC2::ClientVpnRoute resource') } },
