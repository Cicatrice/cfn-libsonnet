{
  ...
  new(): { Type: 'AWS::EC2::TransitGatewayMulticastGroupSource', Properties: { TransitGatewayMulticastDomainId: (error 'You need to define TransitGatewayMulticastDomainId properties for AWS::EC2::TransitGatewayMulticastGroupSource resource'), NetworkInterfaceId: (error 'You need to define NetworkInterfaceId properties for AWS::EC2::TransitGatewayMulticastGroupSource resource'), GroupIpAddress: (error 'You need to define GroupIpAddress properties for AWS::EC2::TransitGatewayMulticastGroupSource resource') } },
