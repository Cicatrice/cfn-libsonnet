{
  ...
  '#':: d.pkg(name='AWS.EC2.TransitGatewayPeeringAttachment', url='', help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-transitgatewaypeeringattachment.html'),
