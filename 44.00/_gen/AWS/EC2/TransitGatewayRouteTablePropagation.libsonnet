{
  ...
  new(): { Type: 'AWS::EC2::TransitGatewayRouteTablePropagation', Properties: { TransitGatewayRouteTableId: (error 'You need to define TransitGatewayRouteTableId properties for AWS::EC2::TransitGatewayRouteTablePropagation resource'), TransitGatewayAttachmentId: (error 'You need to define TransitGatewayAttachmentId properties for AWS::EC2::TransitGatewayRouteTablePropagation resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-transitgatewayroutetablepropagation.html', args=[]),
