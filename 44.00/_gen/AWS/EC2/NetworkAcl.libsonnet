{
  ...
  new(): { Type: 'AWS::EC2::NetworkAcl', Properties: { VpcId: (error 'You need to define VpcId properties for AWS::EC2::NetworkAcl resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-networkacl.html', args=[]),
