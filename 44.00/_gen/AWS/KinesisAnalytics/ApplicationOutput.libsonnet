(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::KinesisAnalytics::ApplicationOutput', Properties: { ApplicationName: if errorOnEmptyProp then (error 'You need to define ApplicationName properties for AWS::KinesisAnalytics::ApplicationOutput resource') else null, Output: if errorOnEmptyProp then (error 'You need to define Output properties for AWS::KinesisAnalytics::ApplicationOutput resource') else null } },
