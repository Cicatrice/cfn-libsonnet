{
  ...
  new(): { Type: 'AWS::KinesisAnalytics::ApplicationOutput', Properties: { ApplicationName: (error 'You need to define ApplicationName properties for AWS::KinesisAnalytics::ApplicationOutput resource'), Output: (error 'You need to define Output properties for AWS::KinesisAnalytics::ApplicationOutput resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-kinesisanalytics-applicationoutput.html', args=[]),
