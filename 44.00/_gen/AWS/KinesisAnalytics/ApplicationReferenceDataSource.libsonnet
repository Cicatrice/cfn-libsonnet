{
  ...
  new(): { Type: 'AWS::KinesisAnalytics::ApplicationReferenceDataSource', Properties: { ApplicationName: (error 'You need to define ApplicationName properties for AWS::KinesisAnalytics::ApplicationReferenceDataSource resource'), ReferenceDataSource: (error 'You need to define ReferenceDataSource properties for AWS::KinesisAnalytics::ApplicationReferenceDataSource resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-kinesisanalytics-applicationreferencedatasource.html', args=[]),
