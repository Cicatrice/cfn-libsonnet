(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ApiGateway::Resource', Properties: { PathPart: if errorOnEmptyProp then (error 'You need to define PathPart properties for AWS::ApiGateway::Resource resource') else null, RestApiId: if errorOnEmptyProp then (error 'You need to define RestApiId properties for AWS::ApiGateway::Resource resource') else null, ParentId: if errorOnEmptyProp then (error 'You need to define ParentId properties for AWS::ApiGateway::Resource resource') else null } },
