{
  ...
  new(): { Type: 'AWS::ApiGateway::ClientCertificate', Properties: {} },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-apigateway-clientcertificate.html', args=[]),
