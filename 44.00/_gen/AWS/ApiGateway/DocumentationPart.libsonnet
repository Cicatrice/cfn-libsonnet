{
  ...
  new(): { Type: 'AWS::ApiGateway::DocumentationPart', Properties: { Location: (error 'You need to define Location properties for AWS::ApiGateway::DocumentationPart resource'), Properties: (error 'You need to define Properties properties for AWS::ApiGateway::DocumentationPart resource'), RestApiId: (error 'You need to define RestApiId properties for AWS::ApiGateway::DocumentationPart resource') } },
