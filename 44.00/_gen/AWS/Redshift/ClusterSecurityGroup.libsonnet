{
  ...
  new(): { Type: 'AWS::Redshift::ClusterSecurityGroup', Properties: { Description: (error 'You need to define Description properties for AWS::Redshift::ClusterSecurityGroup resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-redshift-clustersecuritygroup.html', args=[]),
