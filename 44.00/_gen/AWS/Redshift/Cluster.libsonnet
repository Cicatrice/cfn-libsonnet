{
  ...
  new(): { Type: 'AWS::Redshift::Cluster', Properties: { MasterUserPassword: (error 'You need to define MasterUserPassword properties for AWS::Redshift::Cluster resource'), ClusterType: (error 'You need to define ClusterType properties for AWS::Redshift::Cluster resource'), DBName: (error 'You need to define DBName properties for AWS::Redshift::Cluster resource'), NodeType: (error 'You need to define NodeType properties for AWS::Redshift::Cluster resource'), MasterUsername: (error 'You need to define MasterUsername properties for AWS::Redshift::Cluster resource') } },
