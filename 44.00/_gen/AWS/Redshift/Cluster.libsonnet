{
  ...
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-redshift-cluster.html', args=[]),
  new(): { Type: 'AWS::Redshift::Cluster' },
  ...
  '#withAllowVersionUpgrade':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-redshift-cluster.html#cfn-redshift-cluster-allowversionupgrade', args=[d.arg(name='allowVersionUpgrade', type=d.T.string)]),
  ...
  '#withAutomatedSnapshotRetentionPeriod':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-redshift-cluster.html#cfn-redshift-cluster-automatedsnapshotretentionperiod', args=[d.arg(name='automatedSnapshotRetentionPeriod', type=d.T.string)]),
  ...
  '#withAvailabilityZoneRelocation':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-redshift-cluster.html#cfn-redshift-cluster-availabilityzonerelocation', args=[d.arg(name='availabilityZoneRelocation', type=d.T.string)]),
  ...
  '#withClassic':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-redshift-cluster.html#cfn-redshift-cluster-classic', args=[d.arg(name='classic', type=d.T.string)]),
  ...
  '#withClusterSecurityGroups':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-redshift-cluster.html#cfn-redshift-cluster-clustersecuritygroups', args=[d.arg(name='clusterSecurityGroups', type=d.T.string)]),
  ...
  '#withDeferMaintenance':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-redshift-cluster.html#cfn-redshift-cluster-defermaintenance', args=[d.arg(name='deferMaintenance', type=d.T.string)]),
  withDeferMaintenance(deferMaintenance): { Properties+: { DeferMaintenance: deferMaintenance } },
  '#withDeferMaintenanceDuration':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-redshift-cluster.html#cfn-redshift-cluster-defermaintenanceduration', args=[d.arg(name='deferMaintenanceDuration', type=d.T.string)]),
  ...
  '#withEncrypted':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-redshift-cluster.html#cfn-redshift-cluster-encrypted', args=[d.arg(name='encrypted', type=d.T.string)]),
  withEncrypted(encrypted): { Properties+: { Encrypted: encrypted } },
  '#withEndpoint':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-redshift-cluster.html#cfn-redshift-cluster-endpoint', args=[d.arg(name='endpoint', type=d.T.string)]),
  withEndpoint(endpoint): { Properties+: { Endpoint: endpoint } },
  '#withEnhancedVpcRouting':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-redshift-cluster.html#cfn-redshift-cluster-enhancedvpcrouting', args=[d.arg(name='enhancedVpcRouting', type=d.T.string)]),
  ...
  '#withIamRoles':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-redshift-cluster.html#cfn-redshift-cluster-iamroles', args=[d.arg(name='iamRoles', type=d.T.string)]),
  ...
  '#withLoggingProperties':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-redshift-cluster.html#cfn-redshift-cluster-loggingproperties', args=[d.arg(name='loggingProperties', type=d.T.string)]),
  ...
  '#withManualSnapshotRetentionPeriod':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-redshift-cluster.html#cfn-redshift-cluster-manualsnapshotretentionperiod', args=[d.arg(name='manualSnapshotRetentionPeriod', type=d.T.string)]),
  ...
  '#withNumberOfNodes':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-redshift-cluster.html#cfn-redshift-cluster-numberofnodes', args=[d.arg(name='numberOfNodes', type=d.T.string)]),
  ...
  '#withPort':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-redshift-cluster.html#cfn-redshift-cluster-port', args=[d.arg(name='port', type=d.T.string)]),
  ...
  '#withPubliclyAccessible':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-redshift-cluster.html#cfn-redshift-cluster-publiclyaccessible', args=[d.arg(name='publiclyAccessible', type=d.T.string)]),
  ...
  '#withRotateEncryptionKey':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-redshift-cluster.html#cfn-redshift-cluster-rotateencryptionkey', args=[d.arg(name='rotateEncryptionKey', type=d.T.string)]),
  ...
  '#withSnapshotCopyManual':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-redshift-cluster.html#cfn-redshift-cluster-snapshotcopymanual', args=[d.arg(name='snapshotCopyManual', type=d.T.string)]),
  withSnapshotCopyManual(snapshotCopyManual): { Properties+: { SnapshotCopyManual: snapshotCopyManual } },
  '#withSnapshotCopyRetentionPeriod':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-redshift-cluster.html#cfn-redshift-cluster-snapshotcopyretentionperiod', args=[d.arg(name='snapshotCopyRetentionPeriod', type=d.T.string)]),
  ...
  '#withTags':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-redshift-cluster.html#cfn-redshift-cluster-tags', args=[d.arg(name='tags', type=d.T.string)]),
  withTags(tags): { Properties+: { Tags: tags } },
  '#withVpcSecurityGroupIds':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-redshift-cluster.html#cfn-redshift-cluster-vpcsecuritygroupids', args=[d.arg(name='vpcSecurityGroupIds', type=d.T.string)]),
