{
  ...
  new(): { Type: 'AWS::Redshift::ClusterSecurityGroupIngress', Properties: { ClusterSecurityGroupName: (error 'You need to define ClusterSecurityGroupName properties for AWS::Redshift::ClusterSecurityGroupIngress resource') } },
