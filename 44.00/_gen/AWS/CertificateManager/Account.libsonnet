{
  ...
  new(): { Type: 'AWS::CertificateManager::Account', Properties: { ExpiryEventsConfiguration: (error 'You need to define ExpiryEventsConfiguration properties for AWS::CertificateManager::Account resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-certificatemanager-account.html', args=[]),
