{
  ...
  new(): { Type: 'AWS::Route53Resolver::ResolverDNSSECConfig', Properties: {} },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-route53resolver-resolverdnssecconfig.html', args=[]),
