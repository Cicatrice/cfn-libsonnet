{
  ...
  new(): { Type: 'AWS::Route53Resolver::ResolverQueryLoggingConfig', Properties: {} },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-route53resolver-resolverqueryloggingconfig.html', args=[]),
