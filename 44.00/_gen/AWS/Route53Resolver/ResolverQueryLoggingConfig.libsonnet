{
  ...
  '#':: d.pkg(name='AWS.Route53Resolver.ResolverQueryLoggingConfig', url='', help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-route53resolver-resolverqueryloggingconfig.html'),
