{
  ...
  new(): { Type: 'AWS::CodeStarNotifications::NotificationRule' },
  ...
  '#withEventTypeIds':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-codestarnotifications-notificationrule.html#cfn-codestarnotifications-notificationrule-eventtypeids', args=[d.arg(name='eventTypeIds', type=d.T.string)]),
  ...
  '#withTags':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-codestarnotifications-notificationrule.html#cfn-codestarnotifications-notificationrule-tags', args=[d.arg(name='tags', type=d.T.string)]),
  ...
  '#withTargets':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-codestarnotifications-notificationrule.html#cfn-codestarnotifications-notificationrule-targets', args=[d.arg(name='targets', type=d.T.string)]),
