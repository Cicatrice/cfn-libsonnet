{
  ...
  new(): { Type: 'AWS::WAFRegional::WebACL', Properties: { MetricName: (error 'You need to define MetricName properties for AWS::WAFRegional::WebACL resource'), DefaultAction: (error 'You need to define DefaultAction properties for AWS::WAFRegional::WebACL resource'), Name: (error 'You need to define Name properties for AWS::WAFRegional::WebACL resource') } },
