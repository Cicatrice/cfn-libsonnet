{
  ...
  new(): { Type: 'AWS::WAFRegional::ByteMatchSet', Properties: { Name: (error 'You need to define Name properties for AWS::WAFRegional::ByteMatchSet resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-wafregional-bytematchset.html', args=[]),
