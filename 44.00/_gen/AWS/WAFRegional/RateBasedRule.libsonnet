{
  ...
  '#':: d.pkg(name='AWS.WAFRegional.RateBasedRule', url='', help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-wafregional-ratebasedrule.html'),
