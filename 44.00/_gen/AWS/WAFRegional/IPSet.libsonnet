{
  ...
  new(): { Type: 'AWS::WAFRegional::IPSet', Properties: { Name: (error 'You need to define Name properties for AWS::WAFRegional::IPSet resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-wafregional-ipset.html', args=[]),
