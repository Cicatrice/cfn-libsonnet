{
  ...
  new(): { Type: 'AWS::WAFRegional::XssMatchSet', Properties: { Name: (error 'You need to define Name properties for AWS::WAFRegional::XssMatchSet resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-wafregional-xssmatchset.html', args=[]),
