{
  ...
  new(): { Type: 'AWS::WAFRegional::Rule', Properties: { MetricName: (error 'You need to define MetricName properties for AWS::WAFRegional::Rule resource'), Name: (error 'You need to define Name properties for AWS::WAFRegional::Rule resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-wafregional-rule.html', args=[]),
