{
  ...
  '#':: d.pkg(name='AWS.WAFRegional.SqlInjectionMatchSet', url='', help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-wafregional-sqlinjectionmatchset.html'),
