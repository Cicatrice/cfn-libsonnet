{
  ...
  new(): { Type: 'AWS::WAFRegional::SqlInjectionMatchSet', Properties: { Name: (error 'You need to define Name properties for AWS::WAFRegional::SqlInjectionMatchSet resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-wafregional-sqlinjectionmatchset.html', args=[]),
