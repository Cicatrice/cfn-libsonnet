{
  ...
  new(): { Type: 'AWS::WAFRegional::WebACLAssociation', Properties: { ResourceArn: (error 'You need to define ResourceArn properties for AWS::WAFRegional::WebACLAssociation resource'), WebACLId: (error 'You need to define WebACLId properties for AWS::WAFRegional::WebACLAssociation resource') } },
