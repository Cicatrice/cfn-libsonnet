{
  ...
  '#':: d.pkg(name='AWS.LookoutEquipment.InferenceScheduler', url='', help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-lookoutequipment-inferencescheduler.html'),
