(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::S3ObjectLambda::AccessPoint', Properties: { Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::S3ObjectLambda::AccessPoint resource') else null } },
