(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::S3ObjectLambda::AccessPointPolicy', Properties: { PolicyDocument: if errorOnEmptyProp then (error 'You need to define PolicyDocument properties for AWS::S3ObjectLambda::AccessPointPolicy resource') else null, ObjectLambdaAccessPoint: if errorOnEmptyProp then (error 'You need to define ObjectLambdaAccessPoint properties for AWS::S3ObjectLambda::AccessPointPolicy resource') else null } },
