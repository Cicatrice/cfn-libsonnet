{
  ...
  new(): { Type: 'AWS::Route53RecoveryControl::Cluster', Properties: {} },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-route53recoverycontrol-cluster.html', args=[]),
