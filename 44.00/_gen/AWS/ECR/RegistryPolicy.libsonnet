{
  ...
  new(): { Type: 'AWS::ECR::RegistryPolicy', Properties: { PolicyText: (error 'You need to define PolicyText properties for AWS::ECR::RegistryPolicy resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ecr-registrypolicy.html', args=[]),
