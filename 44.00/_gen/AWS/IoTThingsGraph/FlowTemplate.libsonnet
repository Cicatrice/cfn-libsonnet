{
  ...
  new(): { Type: 'AWS::IoTThingsGraph::FlowTemplate', Properties: { Definition: (error 'You need to define Definition properties for AWS::IoTThingsGraph::FlowTemplate resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iotthingsgraph-flowtemplate.html', args=[]),
