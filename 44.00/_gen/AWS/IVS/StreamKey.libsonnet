{
  ...
  new(): { Type: 'AWS::IVS::StreamKey', Properties: { ChannelArn: (error 'You need to define ChannelArn properties for AWS::IVS::StreamKey resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ivs-streamkey.html', args=[]),
