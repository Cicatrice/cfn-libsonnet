{
  ...
  new(): { Type: 'AWS::EMR::Cluster', Properties: { ServiceRole: (error 'You need to define ServiceRole properties for AWS::EMR::Cluster resource'), Instances: (error 'You need to define Instances properties for AWS::EMR::Cluster resource'), JobFlowRole: (error 'You need to define JobFlowRole properties for AWS::EMR::Cluster resource'), Name: (error 'You need to define Name properties for AWS::EMR::Cluster resource') } },
