{
  ...
  new(): { Type: 'AWS::S3Outposts::BucketPolicy', Properties: { Bucket: (error 'You need to define Bucket properties for AWS::S3Outposts::BucketPolicy resource'), PolicyDocument: (error 'You need to define PolicyDocument properties for AWS::S3Outposts::BucketPolicy resource') } },
