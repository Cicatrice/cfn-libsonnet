{
  ...
  new(): { Type: 'AWS::S3Outposts::AccessPoint', Properties: { Bucket: (error 'You need to define Bucket properties for AWS::S3Outposts::AccessPoint resource'), Name: (error 'You need to define Name properties for AWS::S3Outposts::AccessPoint resource'), VpcConfiguration: (error 'You need to define VpcConfiguration properties for AWS::S3Outposts::AccessPoint resource') } },
