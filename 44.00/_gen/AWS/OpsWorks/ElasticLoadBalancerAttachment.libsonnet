{
  ...
  new(): { Type: 'AWS::OpsWorks::ElasticLoadBalancerAttachment', Properties: { ElasticLoadBalancerName: (error 'You need to define ElasticLoadBalancerName properties for AWS::OpsWorks::ElasticLoadBalancerAttachment resource'), LayerId: (error 'You need to define LayerId properties for AWS::OpsWorks::ElasticLoadBalancerAttachment resource') } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-opsworks-elbattachment.html', args=[]),
