{
  ...
  '#':: d.pkg(name='AWS.OpsWorks.ElasticLoadBalancerAttachment', url='', help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-opsworks-elbattachment.html'),
