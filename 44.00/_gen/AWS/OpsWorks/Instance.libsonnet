(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::OpsWorks::Instance', Properties: { StackId: if errorOnEmptyProp then (error 'You need to define StackId properties for AWS::OpsWorks::Instance resource') else null, InstanceType: if errorOnEmptyProp then (error 'You need to define InstanceType properties for AWS::OpsWorks::Instance resource') else null, LayerIds: if errorOnEmptyProp then (error 'You need to define LayerIds properties for AWS::OpsWorks::Instance resource') else null } },
