{
  ...
  new(): { Type: 'AWS::OpsWorks::Stack', Properties: { Name: (error 'You need to define Name properties for AWS::OpsWorks::Stack resource'), ServiceRoleArn: (error 'You need to define ServiceRoleArn properties for AWS::OpsWorks::Stack resource'), DefaultInstanceProfileArn: (error 'You need to define DefaultInstanceProfileArn properties for AWS::OpsWorks::Stack resource') } },
