(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::FraudDetector::Variable', Properties: { DefaultValue: if errorOnEmptyProp then (error 'You need to define DefaultValue properties for AWS::FraudDetector::Variable resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::FraudDetector::Variable resource') else null, DataSource: if errorOnEmptyProp then (error 'You need to define DataSource properties for AWS::FraudDetector::Variable resource') else null, DataType: if errorOnEmptyProp then (error 'You need to define DataType properties for AWS::FraudDetector::Variable resource') else null } },
