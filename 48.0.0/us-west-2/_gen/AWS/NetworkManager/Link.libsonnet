(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::NetworkManager::Link', Properties: { Bandwidth: if errorOnEmptyProp then (error 'You need to define Bandwidth properties for AWS::NetworkManager::Link resource') else null, GlobalNetworkId: if errorOnEmptyProp then (error 'You need to define GlobalNetworkId properties for AWS::NetworkManager::Link resource') else null, SiteId: if errorOnEmptyProp then (error 'You need to define SiteId properties for AWS::NetworkManager::Link resource') else null } },
