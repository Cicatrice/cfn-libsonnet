(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Kinesis::StreamConsumer', Properties: { ConsumerName: if errorOnEmptyProp then (error 'You need to define ConsumerName properties for AWS::Kinesis::StreamConsumer resource') else null, StreamARN: if errorOnEmptyProp then (error 'You need to define StreamARN properties for AWS::Kinesis::StreamConsumer resource') else null } },
