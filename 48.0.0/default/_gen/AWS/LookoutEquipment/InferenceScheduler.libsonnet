(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::LookoutEquipment::InferenceScheduler', Properties: { ModelName: if errorOnEmptyProp then (error 'You need to define ModelName properties for AWS::LookoutEquipment::InferenceScheduler resource') else null, RoleArn: if errorOnEmptyProp then (error 'You need to define RoleArn properties for AWS::LookoutEquipment::InferenceScheduler resource') else null, DataUploadFrequency: if errorOnEmptyProp then (error 'You need to define DataUploadFrequency properties for AWS::LookoutEquipment::InferenceScheduler resource') else null, DataInputConfiguration: if errorOnEmptyProp then (error 'You need to define DataInputConfiguration properties for AWS::LookoutEquipment::InferenceScheduler resource') else null, DataOutputConfiguration: if errorOnEmptyProp then (error 'You need to define DataOutputConfiguration properties for AWS::LookoutEquipment::InferenceScheduler resource') else null } },
