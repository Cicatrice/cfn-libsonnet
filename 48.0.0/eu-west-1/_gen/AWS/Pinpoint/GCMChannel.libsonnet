(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Pinpoint::GCMChannel', Properties: { ApplicationId: if errorOnEmptyProp then (error 'You need to define ApplicationId properties for AWS::Pinpoint::GCMChannel resource') else null, ApiKey: if errorOnEmptyProp then (error 'You need to define ApiKey properties for AWS::Pinpoint::GCMChannel resource') else null } },
