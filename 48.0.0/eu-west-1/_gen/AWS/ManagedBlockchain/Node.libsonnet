(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ManagedBlockchain::Node', Properties: { NodeConfiguration: if errorOnEmptyProp then (error 'You need to define NodeConfiguration properties for AWS::ManagedBlockchain::Node resource') else null, NetworkId: if errorOnEmptyProp then (error 'You need to define NetworkId properties for AWS::ManagedBlockchain::Node resource') else null } },
