(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::SES::ReceiptRule', Properties: { RuleSetName: if errorOnEmptyProp then (error 'You need to define RuleSetName properties for AWS::SES::ReceiptRule resource') else null, Rule: if errorOnEmptyProp then (error 'You need to define Rule properties for AWS::SES::ReceiptRule resource') else null } },
