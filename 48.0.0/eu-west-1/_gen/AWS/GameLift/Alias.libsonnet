(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::GameLift::Alias', Properties: { RoutingStrategy: if errorOnEmptyProp then (error 'You need to define RoutingStrategy properties for AWS::GameLift::Alias resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::GameLift::Alias resource') else null } },
