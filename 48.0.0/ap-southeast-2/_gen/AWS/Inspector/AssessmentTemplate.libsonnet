(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Inspector::AssessmentTemplate', Properties: { DurationInSeconds: if errorOnEmptyProp then (error 'You need to define DurationInSeconds properties for AWS::Inspector::AssessmentTemplate resource') else null, RulesPackageArns: if errorOnEmptyProp then (error 'You need to define RulesPackageArns properties for AWS::Inspector::AssessmentTemplate resource') else null, AssessmentTargetArn: if errorOnEmptyProp then (error 'You need to define AssessmentTargetArn properties for AWS::Inspector::AssessmentTemplate resource') else null } },
