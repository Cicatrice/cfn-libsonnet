(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::IoTSiteWise::Portal', Properties: { PortalName: if errorOnEmptyProp then (error 'You need to define PortalName properties for AWS::IoTSiteWise::Portal resource') else null, RoleArn: if errorOnEmptyProp then (error 'You need to define RoleArn properties for AWS::IoTSiteWise::Portal resource') else null, PortalContactEmail: if errorOnEmptyProp then (error 'You need to define PortalContactEmail properties for AWS::IoTSiteWise::Portal resource') else null } },
