(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::WAF::XssMatchSet', Properties: { XssMatchTuples: if errorOnEmptyProp then (error 'You need to define XssMatchTuples properties for AWS::WAF::XssMatchSet resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::WAF::XssMatchSet resource') else null } },
