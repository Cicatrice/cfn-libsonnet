(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Logs::MetricFilter', Properties: { MetricTransformations: if errorOnEmptyProp then (error 'You need to define MetricTransformations properties for AWS::Logs::MetricFilter resource') else null, FilterPattern: if errorOnEmptyProp then (error 'You need to define FilterPattern properties for AWS::Logs::MetricFilter resource') else null, LogGroupName: if errorOnEmptyProp then (error 'You need to define LogGroupName properties for AWS::Logs::MetricFilter resource') else null } },
