(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::IAM::UserToGroupAddition', Properties: { Users: if errorOnEmptyProp then (error 'You need to define Users properties for AWS::IAM::UserToGroupAddition resource') else null, GroupName: if errorOnEmptyProp then (error 'You need to define GroupName properties for AWS::IAM::UserToGroupAddition resource') else null } },
