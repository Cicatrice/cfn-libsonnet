(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::DAX::Cluster', Properties: { NodeType: if errorOnEmptyProp then (error 'You need to define NodeType properties for AWS::DAX::Cluster resource') else null, ReplicationFactor: if errorOnEmptyProp then (error 'You need to define ReplicationFactor properties for AWS::DAX::Cluster resource') else null, IAMRoleARN: if errorOnEmptyProp then (error 'You need to define IAMRoleARN properties for AWS::DAX::Cluster resource') else null } },
