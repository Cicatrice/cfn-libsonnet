(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::AppConfig::DeploymentStrategy', Properties: { GrowthFactor: if errorOnEmptyProp then (error 'You need to define GrowthFactor properties for AWS::AppConfig::DeploymentStrategy resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::AppConfig::DeploymentStrategy resource') else null, ReplicateTo: if errorOnEmptyProp then (error 'You need to define ReplicateTo properties for AWS::AppConfig::DeploymentStrategy resource') else null, DeploymentDurationInMinutes: if errorOnEmptyProp then (error 'You need to define DeploymentDurationInMinutes properties for AWS::AppConfig::DeploymentStrategy resource') else null } },
