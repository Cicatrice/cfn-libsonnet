(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::DirectoryService::MicrosoftAD', Properties: { Password: if errorOnEmptyProp then (error 'You need to define Password properties for AWS::DirectoryService::MicrosoftAD resource') else null, VpcSettings: if errorOnEmptyProp then (error 'You need to define VpcSettings properties for AWS::DirectoryService::MicrosoftAD resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::DirectoryService::MicrosoftAD resource') else null } },
