(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::DataSync::LocationObjectStorage', Properties: { AgentArns: if errorOnEmptyProp then (error 'You need to define AgentArns properties for AWS::DataSync::LocationObjectStorage resource') else null, ServerHostname: if errorOnEmptyProp then (error 'You need to define ServerHostname properties for AWS::DataSync::LocationObjectStorage resource') else null, BucketName: if errorOnEmptyProp then (error 'You need to define BucketName properties for AWS::DataSync::LocationObjectStorage resource') else null } },
