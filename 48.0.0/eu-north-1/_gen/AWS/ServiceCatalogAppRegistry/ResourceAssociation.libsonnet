(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ServiceCatalogAppRegistry::ResourceAssociation', Properties: { Application: if errorOnEmptyProp then (error 'You need to define Application properties for AWS::ServiceCatalogAppRegistry::ResourceAssociation resource') else null, Resource: if errorOnEmptyProp then (error 'You need to define Resource properties for AWS::ServiceCatalogAppRegistry::ResourceAssociation resource') else null, ResourceType: if errorOnEmptyProp then (error 'You need to define ResourceType properties for AWS::ServiceCatalogAppRegistry::ResourceAssociation resource') else null } },
