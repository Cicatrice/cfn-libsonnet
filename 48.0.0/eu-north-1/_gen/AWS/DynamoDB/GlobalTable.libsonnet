(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::DynamoDB::GlobalTable', Properties: { KeySchema: if errorOnEmptyProp then (error 'You need to define KeySchema properties for AWS::DynamoDB::GlobalTable resource') else null, Replicas: if errorOnEmptyProp then (error 'You need to define Replicas properties for AWS::DynamoDB::GlobalTable resource') else null, AttributeDefinitions: if errorOnEmptyProp then (error 'You need to define AttributeDefinitions properties for AWS::DynamoDB::GlobalTable resource') else null } },
