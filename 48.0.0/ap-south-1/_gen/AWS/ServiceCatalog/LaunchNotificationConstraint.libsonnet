(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ServiceCatalog::LaunchNotificationConstraint', Properties: { NotificationArns: if errorOnEmptyProp then (error 'You need to define NotificationArns properties for AWS::ServiceCatalog::LaunchNotificationConstraint resource') else null, PortfolioId: if errorOnEmptyProp then (error 'You need to define PortfolioId properties for AWS::ServiceCatalog::LaunchNotificationConstraint resource') else null, ProductId: if errorOnEmptyProp then (error 'You need to define ProductId properties for AWS::ServiceCatalog::LaunchNotificationConstraint resource') else null } },
