(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::NetworkManager::LinkAssociation', Properties: { LinkId: if errorOnEmptyProp then (error 'You need to define LinkId properties for AWS::NetworkManager::LinkAssociation resource') else null, DeviceId: if errorOnEmptyProp then (error 'You need to define DeviceId properties for AWS::NetworkManager::LinkAssociation resource') else null, GlobalNetworkId: if errorOnEmptyProp then (error 'You need to define GlobalNetworkId properties for AWS::NetworkManager::LinkAssociation resource') else null } },
