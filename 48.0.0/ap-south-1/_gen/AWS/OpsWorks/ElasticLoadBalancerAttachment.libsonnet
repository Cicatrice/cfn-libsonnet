(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::OpsWorks::ElasticLoadBalancerAttachment', Properties: { LayerId: if errorOnEmptyProp then (error 'You need to define LayerId properties for AWS::OpsWorks::ElasticLoadBalancerAttachment resource') else null, ElasticLoadBalancerName: if errorOnEmptyProp then (error 'You need to define ElasticLoadBalancerName properties for AWS::OpsWorks::ElasticLoadBalancerAttachment resource') else null } },
