(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ApiGatewayV2::ApiMapping', Properties: { ApiId: if errorOnEmptyProp then (error 'You need to define ApiId properties for AWS::ApiGatewayV2::ApiMapping resource') else null, DomainName: if errorOnEmptyProp then (error 'You need to define DomainName properties for AWS::ApiGatewayV2::ApiMapping resource') else null, Stage: if errorOnEmptyProp then (error 'You need to define Stage properties for AWS::ApiGatewayV2::ApiMapping resource') else null } },
