(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::EKS::Nodegroup', Properties: { NodeRole: if errorOnEmptyProp then (error 'You need to define NodeRole properties for AWS::EKS::Nodegroup resource') else null, Subnets: if errorOnEmptyProp then (error 'You need to define Subnets properties for AWS::EKS::Nodegroup resource') else null, ClusterName: if errorOnEmptyProp then (error 'You need to define ClusterName properties for AWS::EKS::Nodegroup resource') else null } },
