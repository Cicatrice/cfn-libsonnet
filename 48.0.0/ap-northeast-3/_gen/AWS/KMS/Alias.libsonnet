(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::KMS::Alias', Properties: { TargetKeyId: if errorOnEmptyProp then (error 'You need to define TargetKeyId properties for AWS::KMS::Alias resource') else null, AliasName: if errorOnEmptyProp then (error 'You need to define AliasName properties for AWS::KMS::Alias resource') else null } },
