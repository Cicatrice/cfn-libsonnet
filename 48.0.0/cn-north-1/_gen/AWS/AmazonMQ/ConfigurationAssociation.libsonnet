(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::AmazonMQ::ConfigurationAssociation', Properties: { Configuration: if errorOnEmptyProp then (error 'You need to define Configuration properties for AWS::AmazonMQ::ConfigurationAssociation resource') else null, Broker: if errorOnEmptyProp then (error 'You need to define Broker properties for AWS::AmazonMQ::ConfigurationAssociation resource') else null } },
