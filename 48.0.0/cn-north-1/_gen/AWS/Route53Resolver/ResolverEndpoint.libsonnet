(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Route53Resolver::ResolverEndpoint', Properties: { SecurityGroupIds: if errorOnEmptyProp then (error 'You need to define SecurityGroupIds properties for AWS::Route53Resolver::ResolverEndpoint resource') else null, Direction: if errorOnEmptyProp then (error 'You need to define Direction properties for AWS::Route53Resolver::ResolverEndpoint resource') else null, IpAddresses: if errorOnEmptyProp then (error 'You need to define IpAddresses properties for AWS::Route53Resolver::ResolverEndpoint resource') else null } },
