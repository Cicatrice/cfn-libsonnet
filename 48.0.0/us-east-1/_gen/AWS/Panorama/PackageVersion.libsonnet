(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Panorama::PackageVersion', Properties: { PackageId: if errorOnEmptyProp then (error 'You need to define PackageId properties for AWS::Panorama::PackageVersion resource') else null, PackageVersion: if errorOnEmptyProp then (error 'You need to define PackageVersion properties for AWS::Panorama::PackageVersion resource') else null, PatchVersion: if errorOnEmptyProp then (error 'You need to define PatchVersion properties for AWS::Panorama::PackageVersion resource') else null } },
