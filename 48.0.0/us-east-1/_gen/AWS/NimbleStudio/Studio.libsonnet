(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::NimbleStudio::Studio', Properties: { StudioName: if errorOnEmptyProp then (error 'You need to define StudioName properties for AWS::NimbleStudio::Studio resource') else null, UserRoleArn: if errorOnEmptyProp then (error 'You need to define UserRoleArn properties for AWS::NimbleStudio::Studio resource') else null, AdminRoleArn: if errorOnEmptyProp then (error 'You need to define AdminRoleArn properties for AWS::NimbleStudio::Studio resource') else null, DisplayName: if errorOnEmptyProp then (error 'You need to define DisplayName properties for AWS::NimbleStudio::Studio resource') else null } },
