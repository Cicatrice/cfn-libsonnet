(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ElastiCache::UserGroup', Properties: { UserGroupId: if errorOnEmptyProp then (error 'You need to define UserGroupId properties for AWS::ElastiCache::UserGroup resource') else null, Engine: if errorOnEmptyProp then (error 'You need to define Engine properties for AWS::ElastiCache::UserGroup resource') else null } },
