(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Pinpoint::BaiduChannel', Properties: { ApiKey: if errorOnEmptyProp then (error 'You need to define ApiKey properties for AWS::Pinpoint::BaiduChannel resource') else null, ApplicationId: if errorOnEmptyProp then (error 'You need to define ApplicationId properties for AWS::Pinpoint::BaiduChannel resource') else null, SecretKey: if errorOnEmptyProp then (error 'You need to define SecretKey properties for AWS::Pinpoint::BaiduChannel resource') else null } },
