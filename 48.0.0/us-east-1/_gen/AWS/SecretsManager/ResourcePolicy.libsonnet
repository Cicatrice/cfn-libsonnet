(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::SecretsManager::ResourcePolicy', Properties: { ResourcePolicy: if errorOnEmptyProp then (error 'You need to define ResourcePolicy properties for AWS::SecretsManager::ResourcePolicy resource') else null, SecretId: if errorOnEmptyProp then (error 'You need to define SecretId properties for AWS::SecretsManager::ResourcePolicy resource') else null } },
