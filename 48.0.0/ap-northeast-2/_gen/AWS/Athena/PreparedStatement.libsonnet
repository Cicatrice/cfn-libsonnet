(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Athena::PreparedStatement', Properties: { WorkGroup: if errorOnEmptyProp then (error 'You need to define WorkGroup properties for AWS::Athena::PreparedStatement resource') else null, QueryStatement: if errorOnEmptyProp then (error 'You need to define QueryStatement properties for AWS::Athena::PreparedStatement resource') else null, StatementName: if errorOnEmptyProp then (error 'You need to define StatementName properties for AWS::Athena::PreparedStatement resource') else null } },
