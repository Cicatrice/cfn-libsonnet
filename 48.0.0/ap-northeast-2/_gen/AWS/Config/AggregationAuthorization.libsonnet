(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Config::AggregationAuthorization', Properties: { AuthorizedAwsRegion: if errorOnEmptyProp then (error 'You need to define AuthorizedAwsRegion properties for AWS::Config::AggregationAuthorization resource') else null, AuthorizedAccountId: if errorOnEmptyProp then (error 'You need to define AuthorizedAccountId properties for AWS::Config::AggregationAuthorization resource') else null } },
