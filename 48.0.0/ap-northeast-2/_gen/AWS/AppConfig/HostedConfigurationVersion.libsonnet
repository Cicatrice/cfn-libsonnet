(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::AppConfig::HostedConfigurationVersion', Properties: { ConfigurationProfileId: if errorOnEmptyProp then (error 'You need to define ConfigurationProfileId properties for AWS::AppConfig::HostedConfigurationVersion resource') else null, Content: if errorOnEmptyProp then (error 'You need to define Content properties for AWS::AppConfig::HostedConfigurationVersion resource') else null, ContentType: if errorOnEmptyProp then (error 'You need to define ContentType properties for AWS::AppConfig::HostedConfigurationVersion resource') else null, ApplicationId: if errorOnEmptyProp then (error 'You need to define ApplicationId properties for AWS::AppConfig::HostedConfigurationVersion resource') else null } },
