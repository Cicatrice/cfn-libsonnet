(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::AppFlow::ConnectorProfile', Properties: { ConnectionMode: if errorOnEmptyProp then (error 'You need to define ConnectionMode properties for AWS::AppFlow::ConnectorProfile resource') else null, ConnectorProfileName: if errorOnEmptyProp then (error 'You need to define ConnectorProfileName properties for AWS::AppFlow::ConnectorProfile resource') else null, ConnectorType: if errorOnEmptyProp then (error 'You need to define ConnectorType properties for AWS::AppFlow::ConnectorProfile resource') else null } },
