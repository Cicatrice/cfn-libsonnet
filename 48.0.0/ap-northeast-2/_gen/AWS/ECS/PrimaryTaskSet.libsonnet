(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ECS::PrimaryTaskSet', Properties: { Cluster: if errorOnEmptyProp then (error 'You need to define Cluster properties for AWS::ECS::PrimaryTaskSet resource') else null, Service: if errorOnEmptyProp then (error 'You need to define Service properties for AWS::ECS::PrimaryTaskSet resource') else null, TaskSetId: if errorOnEmptyProp then (error 'You need to define TaskSetId properties for AWS::ECS::PrimaryTaskSet resource') else null } },
