(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ElasticLoadBalancingV2::ListenerRule', Properties: { Conditions: if errorOnEmptyProp then (error 'You need to define Conditions properties for AWS::ElasticLoadBalancingV2::ListenerRule resource') else null, ListenerArn: if errorOnEmptyProp then (error 'You need to define ListenerArn properties for AWS::ElasticLoadBalancingV2::ListenerRule resource') else null, Priority: if errorOnEmptyProp then (error 'You need to define Priority properties for AWS::ElasticLoadBalancingV2::ListenerRule resource') else null, Actions: if errorOnEmptyProp then (error 'You need to define Actions properties for AWS::ElasticLoadBalancingV2::ListenerRule resource') else null } },
