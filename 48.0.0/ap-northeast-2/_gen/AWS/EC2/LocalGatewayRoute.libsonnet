(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::EC2::LocalGatewayRoute', Properties: { DestinationCidrBlock: if errorOnEmptyProp then (error 'You need to define DestinationCidrBlock properties for AWS::EC2::LocalGatewayRoute resource') else null, LocalGatewayRouteTableId: if errorOnEmptyProp then (error 'You need to define LocalGatewayRouteTableId properties for AWS::EC2::LocalGatewayRoute resource') else null, LocalGatewayVirtualInterfaceGroupId: if errorOnEmptyProp then (error 'You need to define LocalGatewayVirtualInterfaceGroupId properties for AWS::EC2::LocalGatewayRoute resource') else null } },
