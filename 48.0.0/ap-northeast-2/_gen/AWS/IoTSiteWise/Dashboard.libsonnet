(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::IoTSiteWise::Dashboard', Properties: { DashboardName: if errorOnEmptyProp then (error 'You need to define DashboardName properties for AWS::IoTSiteWise::Dashboard resource') else null, DashboardDefinition: if errorOnEmptyProp then (error 'You need to define DashboardDefinition properties for AWS::IoTSiteWise::Dashboard resource') else null, DashboardDescription: if errorOnEmptyProp then (error 'You need to define DashboardDescription properties for AWS::IoTSiteWise::Dashboard resource') else null } },
