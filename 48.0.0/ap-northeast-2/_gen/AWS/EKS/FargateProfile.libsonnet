(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::EKS::FargateProfile', Properties: { ClusterName: if errorOnEmptyProp then (error 'You need to define ClusterName properties for AWS::EKS::FargateProfile resource') else null, PodExecutionRoleArn: if errorOnEmptyProp then (error 'You need to define PodExecutionRoleArn properties for AWS::EKS::FargateProfile resource') else null, Selectors: if errorOnEmptyProp then (error 'You need to define Selectors properties for AWS::EKS::FargateProfile resource') else null } },
