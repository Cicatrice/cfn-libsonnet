(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::EC2::TransitGatewayMulticastGroupMember', Properties: { TransitGatewayMulticastDomainId: if errorOnEmptyProp then (error 'You need to define TransitGatewayMulticastDomainId properties for AWS::EC2::TransitGatewayMulticastGroupMember resource') else null, GroupIpAddress: if errorOnEmptyProp then (error 'You need to define GroupIpAddress properties for AWS::EC2::TransitGatewayMulticastGroupMember resource') else null, NetworkInterfaceId: if errorOnEmptyProp then (error 'You need to define NetworkInterfaceId properties for AWS::EC2::TransitGatewayMulticastGroupMember resource') else null } },
