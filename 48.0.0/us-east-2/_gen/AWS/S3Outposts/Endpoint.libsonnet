(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::S3Outposts::Endpoint', Properties: { SubnetId: if errorOnEmptyProp then (error 'You need to define SubnetId properties for AWS::S3Outposts::Endpoint resource') else null, OutpostId: if errorOnEmptyProp then (error 'You need to define OutpostId properties for AWS::S3Outposts::Endpoint resource') else null, SecurityGroupId: if errorOnEmptyProp then (error 'You need to define SecurityGroupId properties for AWS::S3Outposts::Endpoint resource') else null } },
