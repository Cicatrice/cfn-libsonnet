(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ServiceCatalog::PortfolioShare', Properties: { AccountId: if errorOnEmptyProp then (error 'You need to define AccountId properties for AWS::ServiceCatalog::PortfolioShare resource') else null, PortfolioId: if errorOnEmptyProp then (error 'You need to define PortfolioId properties for AWS::ServiceCatalog::PortfolioShare resource') else null } },
