(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::CloudFront::StreamingDistribution', Properties: { StreamingDistributionConfig: if errorOnEmptyProp then (error 'You need to define StreamingDistributionConfig properties for AWS::CloudFront::StreamingDistribution resource') else null, Tags: if errorOnEmptyProp then (error 'You need to define Tags properties for AWS::CloudFront::StreamingDistribution resource') else null } },
