(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Cognito::UserPoolDomain', Properties: { UserPoolId: if errorOnEmptyProp then (error 'You need to define UserPoolId properties for AWS::Cognito::UserPoolDomain resource') else null, Domain: if errorOnEmptyProp then (error 'You need to define Domain properties for AWS::Cognito::UserPoolDomain resource') else null } },
