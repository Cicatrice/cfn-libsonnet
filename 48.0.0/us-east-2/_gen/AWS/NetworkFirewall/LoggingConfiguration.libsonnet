(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::NetworkFirewall::LoggingConfiguration', Properties: { FirewallArn: if errorOnEmptyProp then (error 'You need to define FirewallArn properties for AWS::NetworkFirewall::LoggingConfiguration resource') else null, LoggingConfiguration: if errorOnEmptyProp then (error 'You need to define LoggingConfiguration properties for AWS::NetworkFirewall::LoggingConfiguration resource') else null } },
