(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::NetworkFirewall::RuleGroup', Properties: { Type: if errorOnEmptyProp then (error 'You need to define Type properties for AWS::NetworkFirewall::RuleGroup resource') else null, Capacity: if errorOnEmptyProp then (error 'You need to define Capacity properties for AWS::NetworkFirewall::RuleGroup resource') else null, RuleGroupName: if errorOnEmptyProp then (error 'You need to define RuleGroupName properties for AWS::NetworkFirewall::RuleGroup resource') else null } },
