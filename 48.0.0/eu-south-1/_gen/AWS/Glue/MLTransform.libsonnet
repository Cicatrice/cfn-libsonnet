(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Glue::MLTransform', Properties: { TransformParameters: if errorOnEmptyProp then (error 'You need to define TransformParameters properties for AWS::Glue::MLTransform resource') else null, Role: if errorOnEmptyProp then (error 'You need to define Role properties for AWS::Glue::MLTransform resource') else null, InputRecordTables: if errorOnEmptyProp then (error 'You need to define InputRecordTables properties for AWS::Glue::MLTransform resource') else null } },
