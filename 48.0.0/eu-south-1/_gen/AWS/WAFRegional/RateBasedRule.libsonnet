(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::WAFRegional::RateBasedRule', Properties: { MetricName: if errorOnEmptyProp then (error 'You need to define MetricName properties for AWS::WAFRegional::RateBasedRule resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::WAFRegional::RateBasedRule resource') else null, RateKey: if errorOnEmptyProp then (error 'You need to define RateKey properties for AWS::WAFRegional::RateBasedRule resource') else null, RateLimit: if errorOnEmptyProp then (error 'You need to define RateLimit properties for AWS::WAFRegional::RateBasedRule resource') else null } },
