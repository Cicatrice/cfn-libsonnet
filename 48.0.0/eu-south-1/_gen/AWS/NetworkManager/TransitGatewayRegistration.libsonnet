(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::NetworkManager::TransitGatewayRegistration', Properties: { TransitGatewayArn: if errorOnEmptyProp then (error 'You need to define TransitGatewayArn properties for AWS::NetworkManager::TransitGatewayRegistration resource') else null, GlobalNetworkId: if errorOnEmptyProp then (error 'You need to define GlobalNetworkId properties for AWS::NetworkManager::TransitGatewayRegistration resource') else null } },
