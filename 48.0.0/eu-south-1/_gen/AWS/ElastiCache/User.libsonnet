(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ElastiCache::User', Properties: { UserName: if errorOnEmptyProp then (error 'You need to define UserName properties for AWS::ElastiCache::User resource') else null, Engine: if errorOnEmptyProp then (error 'You need to define Engine properties for AWS::ElastiCache::User resource') else null, UserId: if errorOnEmptyProp then (error 'You need to define UserId properties for AWS::ElastiCache::User resource') else null } },
