(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Connect::HoursOfOperation', Properties: { InstanceArn: if errorOnEmptyProp then (error 'You need to define InstanceArn properties for AWS::Connect::HoursOfOperation resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::Connect::HoursOfOperation resource') else null, TimeZone: if errorOnEmptyProp then (error 'You need to define TimeZone properties for AWS::Connect::HoursOfOperation resource') else null, Config: if errorOnEmptyProp then (error 'You need to define Config properties for AWS::Connect::HoursOfOperation resource') else null } },
