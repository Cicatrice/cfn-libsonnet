(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::AppConfig::Deployment', Properties: { ApplicationId: if errorOnEmptyProp then (error 'You need to define ApplicationId properties for AWS::AppConfig::Deployment resource') else null, ConfigurationProfileId: if errorOnEmptyProp then (error 'You need to define ConfigurationProfileId properties for AWS::AppConfig::Deployment resource') else null, ConfigurationVersion: if errorOnEmptyProp then (error 'You need to define ConfigurationVersion properties for AWS::AppConfig::Deployment resource') else null, DeploymentStrategyId: if errorOnEmptyProp then (error 'You need to define DeploymentStrategyId properties for AWS::AppConfig::Deployment resource') else null, EnvironmentId: if errorOnEmptyProp then (error 'You need to define EnvironmentId properties for AWS::AppConfig::Deployment resource') else null } },
