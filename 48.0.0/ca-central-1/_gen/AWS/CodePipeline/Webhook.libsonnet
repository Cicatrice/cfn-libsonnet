(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::CodePipeline::Webhook', Properties: { AuthenticationConfiguration: if errorOnEmptyProp then (error 'You need to define AuthenticationConfiguration properties for AWS::CodePipeline::Webhook resource') else null, Filters: if errorOnEmptyProp then (error 'You need to define Filters properties for AWS::CodePipeline::Webhook resource') else null, TargetAction: if errorOnEmptyProp then (error 'You need to define TargetAction properties for AWS::CodePipeline::Webhook resource') else null, TargetPipeline: if errorOnEmptyProp then (error 'You need to define TargetPipeline properties for AWS::CodePipeline::Webhook resource') else null, TargetPipelineVersion: if errorOnEmptyProp then (error 'You need to define TargetPipelineVersion properties for AWS::CodePipeline::Webhook resource') else null, Authentication: if errorOnEmptyProp then (error 'You need to define Authentication properties for AWS::CodePipeline::Webhook resource') else null } },
