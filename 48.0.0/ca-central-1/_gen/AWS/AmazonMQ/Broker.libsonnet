(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::AmazonMQ::Broker', Properties: { AutoMinorVersionUpgrade: if errorOnEmptyProp then (error 'You need to define AutoMinorVersionUpgrade properties for AWS::AmazonMQ::Broker resource') else null, BrokerName: if errorOnEmptyProp then (error 'You need to define BrokerName properties for AWS::AmazonMQ::Broker resource') else null, Users: if errorOnEmptyProp then (error 'You need to define Users properties for AWS::AmazonMQ::Broker resource') else null, EngineType: if errorOnEmptyProp then (error 'You need to define EngineType properties for AWS::AmazonMQ::Broker resource') else null, EngineVersion: if errorOnEmptyProp then (error 'You need to define EngineVersion properties for AWS::AmazonMQ::Broker resource') else null, PubliclyAccessible: if errorOnEmptyProp then (error 'You need to define PubliclyAccessible properties for AWS::AmazonMQ::Broker resource') else null, DeploymentMode: if errorOnEmptyProp then (error 'You need to define DeploymentMode properties for AWS::AmazonMQ::Broker resource') else null, HostInstanceType: if errorOnEmptyProp then (error 'You need to define HostInstanceType properties for AWS::AmazonMQ::Broker resource') else null } },
