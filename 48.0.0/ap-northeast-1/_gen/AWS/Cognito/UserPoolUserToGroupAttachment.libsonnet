(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Cognito::UserPoolUserToGroupAttachment', Properties: { GroupName: if errorOnEmptyProp then (error 'You need to define GroupName properties for AWS::Cognito::UserPoolUserToGroupAttachment resource') else null, UserPoolId: if errorOnEmptyProp then (error 'You need to define UserPoolId properties for AWS::Cognito::UserPoolUserToGroupAttachment resource') else null, Username: if errorOnEmptyProp then (error 'You need to define Username properties for AWS::Cognito::UserPoolUserToGroupAttachment resource') else null } },
