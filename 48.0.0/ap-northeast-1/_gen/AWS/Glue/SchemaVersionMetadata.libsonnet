(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Glue::SchemaVersionMetadata', Properties: { SchemaVersionId: if errorOnEmptyProp then (error 'You need to define SchemaVersionId properties for AWS::Glue::SchemaVersionMetadata resource') else null, Value: if errorOnEmptyProp then (error 'You need to define Value properties for AWS::Glue::SchemaVersionMetadata resource') else null, Key: if errorOnEmptyProp then (error 'You need to define Key properties for AWS::Glue::SchemaVersionMetadata resource') else null } },
