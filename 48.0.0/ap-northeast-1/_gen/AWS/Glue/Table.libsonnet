(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Glue::Table', Properties: { DatabaseName: if errorOnEmptyProp then (error 'You need to define DatabaseName properties for AWS::Glue::Table resource') else null, TableInput: if errorOnEmptyProp then (error 'You need to define TableInput properties for AWS::Glue::Table resource') else null, CatalogId: if errorOnEmptyProp then (error 'You need to define CatalogId properties for AWS::Glue::Table resource') else null } },
