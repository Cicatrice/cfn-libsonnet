(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::IoTWireless::Destination', Properties: { Expression: if errorOnEmptyProp then (error 'You need to define Expression properties for AWS::IoTWireless::Destination resource') else null, ExpressionType: if errorOnEmptyProp then (error 'You need to define ExpressionType properties for AWS::IoTWireless::Destination resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::IoTWireless::Destination resource') else null, RoleArn: if errorOnEmptyProp then (error 'You need to define RoleArn properties for AWS::IoTWireless::Destination resource') else null } },
