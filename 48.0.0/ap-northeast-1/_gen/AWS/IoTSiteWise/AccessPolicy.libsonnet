(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::IoTSiteWise::AccessPolicy', Properties: { AccessPolicyResource: if errorOnEmptyProp then (error 'You need to define AccessPolicyResource properties for AWS::IoTSiteWise::AccessPolicy resource') else null, AccessPolicyIdentity: if errorOnEmptyProp then (error 'You need to define AccessPolicyIdentity properties for AWS::IoTSiteWise::AccessPolicy resource') else null, AccessPolicyPermission: if errorOnEmptyProp then (error 'You need to define AccessPolicyPermission properties for AWS::IoTSiteWise::AccessPolicy resource') else null } },
