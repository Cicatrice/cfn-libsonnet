(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Route53Resolver::ResolverConfig', Properties: { AutodefinedReverseFlag: if errorOnEmptyProp then (error 'You need to define AutodefinedReverseFlag properties for AWS::Route53Resolver::ResolverConfig resource') else null, ResourceId: if errorOnEmptyProp then (error 'You need to define ResourceId properties for AWS::Route53Resolver::ResolverConfig resource') else null } },
