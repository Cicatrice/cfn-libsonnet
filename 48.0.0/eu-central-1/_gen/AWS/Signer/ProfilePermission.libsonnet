(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Signer::ProfilePermission', Properties: { ProfileName: if errorOnEmptyProp then (error 'You need to define ProfileName properties for AWS::Signer::ProfilePermission resource') else null, StatementId: if errorOnEmptyProp then (error 'You need to define StatementId properties for AWS::Signer::ProfilePermission resource') else null, Action: if errorOnEmptyProp then (error 'You need to define Action properties for AWS::Signer::ProfilePermission resource') else null, Principal: if errorOnEmptyProp then (error 'You need to define Principal properties for AWS::Signer::ProfilePermission resource') else null } },
