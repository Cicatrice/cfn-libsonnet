(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::PinpointEmail::ConfigurationSetEventDestination', Properties: { ConfigurationSetName: if errorOnEmptyProp then (error 'You need to define ConfigurationSetName properties for AWS::PinpointEmail::ConfigurationSetEventDestination resource') else null, EventDestinationName: if errorOnEmptyProp then (error 'You need to define EventDestinationName properties for AWS::PinpointEmail::ConfigurationSetEventDestination resource') else null } },
