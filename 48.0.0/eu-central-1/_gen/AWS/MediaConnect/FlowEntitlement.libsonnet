(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::MediaConnect::FlowEntitlement', Properties: { Subscribers: if errorOnEmptyProp then (error 'You need to define Subscribers properties for AWS::MediaConnect::FlowEntitlement resource') else null, Description: if errorOnEmptyProp then (error 'You need to define Description properties for AWS::MediaConnect::FlowEntitlement resource') else null, FlowArn: if errorOnEmptyProp then (error 'You need to define FlowArn properties for AWS::MediaConnect::FlowEntitlement resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::MediaConnect::FlowEntitlement resource') else null } },
