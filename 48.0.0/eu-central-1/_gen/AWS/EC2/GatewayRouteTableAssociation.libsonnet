(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::EC2::GatewayRouteTableAssociation', Properties: { GatewayId: if errorOnEmptyProp then (error 'You need to define GatewayId properties for AWS::EC2::GatewayRouteTableAssociation resource') else null, RouteTableId: if errorOnEmptyProp then (error 'You need to define RouteTableId properties for AWS::EC2::GatewayRouteTableAssociation resource') else null } },
