(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::WAF::SizeConstraintSet', Properties: { Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::WAF::SizeConstraintSet resource') else null, SizeConstraints: if errorOnEmptyProp then (error 'You need to define SizeConstraints properties for AWS::WAF::SizeConstraintSet resource') else null } },
