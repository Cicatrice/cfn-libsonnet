(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'Alexa::ASK::Skill', Properties: { AuthenticationConfiguration: if errorOnEmptyProp then (error 'You need to define AuthenticationConfiguration properties for Alexa::ASK::Skill resource') else null, SkillPackage: if errorOnEmptyProp then (error 'You need to define SkillPackage properties for Alexa::ASK::Skill resource') else null, VendorId: if errorOnEmptyProp then (error 'You need to define VendorId properties for Alexa::ASK::Skill resource') else null } },
