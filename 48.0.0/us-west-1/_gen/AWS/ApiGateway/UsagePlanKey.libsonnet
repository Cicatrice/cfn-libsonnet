(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ApiGateway::UsagePlanKey', Properties: { KeyId: if errorOnEmptyProp then (error 'You need to define KeyId properties for AWS::ApiGateway::UsagePlanKey resource') else null, KeyType: if errorOnEmptyProp then (error 'You need to define KeyType properties for AWS::ApiGateway::UsagePlanKey resource') else null, UsagePlanId: if errorOnEmptyProp then (error 'You need to define UsagePlanId properties for AWS::ApiGateway::UsagePlanKey resource') else null } },
