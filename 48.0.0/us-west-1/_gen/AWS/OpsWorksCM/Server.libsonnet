(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::OpsWorksCM::Server', Properties: { ServiceRoleArn: if errorOnEmptyProp then (error 'You need to define ServiceRoleArn properties for AWS::OpsWorksCM::Server resource') else null, InstanceType: if errorOnEmptyProp then (error 'You need to define InstanceType properties for AWS::OpsWorksCM::Server resource') else null, InstanceProfileArn: if errorOnEmptyProp then (error 'You need to define InstanceProfileArn properties for AWS::OpsWorksCM::Server resource') else null } },
