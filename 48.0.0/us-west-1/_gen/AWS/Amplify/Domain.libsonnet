(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Amplify::Domain', Properties: { SubDomainSettings: if errorOnEmptyProp then (error 'You need to define SubDomainSettings properties for AWS::Amplify::Domain resource') else null, AppId: if errorOnEmptyProp then (error 'You need to define AppId properties for AWS::Amplify::Domain resource') else null, DomainName: if errorOnEmptyProp then (error 'You need to define DomainName properties for AWS::Amplify::Domain resource') else null } },
