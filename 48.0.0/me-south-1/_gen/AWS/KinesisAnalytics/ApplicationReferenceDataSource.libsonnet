(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::KinesisAnalytics::ApplicationReferenceDataSource', Properties: { ReferenceDataSource: if errorOnEmptyProp then (error 'You need to define ReferenceDataSource properties for AWS::KinesisAnalytics::ApplicationReferenceDataSource resource') else null, ApplicationName: if errorOnEmptyProp then (error 'You need to define ApplicationName properties for AWS::KinesisAnalytics::ApplicationReferenceDataSource resource') else null } },
