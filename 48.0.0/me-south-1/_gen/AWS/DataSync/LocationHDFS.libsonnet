(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::DataSync::LocationHDFS', Properties: { AuthenticationType: if errorOnEmptyProp then (error 'You need to define AuthenticationType properties for AWS::DataSync::LocationHDFS resource') else null, AgentArns: if errorOnEmptyProp then (error 'You need to define AgentArns properties for AWS::DataSync::LocationHDFS resource') else null, NameNodes: if errorOnEmptyProp then (error 'You need to define NameNodes properties for AWS::DataSync::LocationHDFS resource') else null } },
