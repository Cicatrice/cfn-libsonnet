(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::WAFRegional::RegexPatternSet', Properties: { Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::WAFRegional::RegexPatternSet resource') else null, RegexPatternStrings: if errorOnEmptyProp then (error 'You need to define RegexPatternStrings properties for AWS::WAFRegional::RegexPatternSet resource') else null } },
