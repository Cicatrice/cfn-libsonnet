(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ElastiCache::CacheCluster', Properties: { CacheNodeType: if errorOnEmptyProp then (error 'You need to define CacheNodeType properties for AWS::ElastiCache::CacheCluster resource') else null, NumCacheNodes: if errorOnEmptyProp then (error 'You need to define NumCacheNodes properties for AWS::ElastiCache::CacheCluster resource') else null, Engine: if errorOnEmptyProp then (error 'You need to define Engine properties for AWS::ElastiCache::CacheCluster resource') else null } },
