(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::EC2::ClientVpnRoute', Properties: { DestinationCidrBlock: if errorOnEmptyProp then (error 'You need to define DestinationCidrBlock properties for AWS::EC2::ClientVpnRoute resource') else null, TargetVpcSubnetId: if errorOnEmptyProp then (error 'You need to define TargetVpcSubnetId properties for AWS::EC2::ClientVpnRoute resource') else null, ClientVpnEndpointId: if errorOnEmptyProp then (error 'You need to define ClientVpnEndpointId properties for AWS::EC2::ClientVpnRoute resource') else null } },
