(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::S3::MultiRegionAccessPointPolicy', Properties: { MrapName: if errorOnEmptyProp then (error 'You need to define MrapName properties for AWS::S3::MultiRegionAccessPointPolicy resource') else null, Policy: if errorOnEmptyProp then (error 'You need to define Policy properties for AWS::S3::MultiRegionAccessPointPolicy resource') else null } },
