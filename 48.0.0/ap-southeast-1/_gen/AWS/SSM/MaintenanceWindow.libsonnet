(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::SSM::MaintenanceWindow', Properties: { Schedule: if errorOnEmptyProp then (error 'You need to define Schedule properties for AWS::SSM::MaintenanceWindow resource') else null, AllowUnassociatedTargets: if errorOnEmptyProp then (error 'You need to define AllowUnassociatedTargets properties for AWS::SSM::MaintenanceWindow resource') else null, Cutoff: if errorOnEmptyProp then (error 'You need to define Cutoff properties for AWS::SSM::MaintenanceWindow resource') else null, Duration: if errorOnEmptyProp then (error 'You need to define Duration properties for AWS::SSM::MaintenanceWindow resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::SSM::MaintenanceWindow resource') else null } },
