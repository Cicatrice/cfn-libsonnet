(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::LakeFormation::Resource', Properties: { UseServiceLinkedRole: if errorOnEmptyProp then (error 'You need to define UseServiceLinkedRole properties for AWS::LakeFormation::Resource resource') else null, ResourceArn: if errorOnEmptyProp then (error 'You need to define ResourceArn properties for AWS::LakeFormation::Resource resource') else null } },
