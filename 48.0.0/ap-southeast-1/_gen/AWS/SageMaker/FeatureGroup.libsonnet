(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::SageMaker::FeatureGroup', Properties: { FeatureDefinitions: if errorOnEmptyProp then (error 'You need to define FeatureDefinitions properties for AWS::SageMaker::FeatureGroup resource') else null, EventTimeFeatureName: if errorOnEmptyProp then (error 'You need to define EventTimeFeatureName properties for AWS::SageMaker::FeatureGroup resource') else null, FeatureGroupName: if errorOnEmptyProp then (error 'You need to define FeatureGroupName properties for AWS::SageMaker::FeatureGroup resource') else null, RecordIdentifierFeatureName: if errorOnEmptyProp then (error 'You need to define RecordIdentifierFeatureName properties for AWS::SageMaker::FeatureGroup resource') else null } },
