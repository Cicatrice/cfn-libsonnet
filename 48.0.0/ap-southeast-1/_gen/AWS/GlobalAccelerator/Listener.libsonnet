(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::GlobalAccelerator::Listener', Properties: { AcceleratorArn: if errorOnEmptyProp then (error 'You need to define AcceleratorArn properties for AWS::GlobalAccelerator::Listener resource') else null, PortRanges: if errorOnEmptyProp then (error 'You need to define PortRanges properties for AWS::GlobalAccelerator::Listener resource') else null, Protocol: if errorOnEmptyProp then (error 'You need to define Protocol properties for AWS::GlobalAccelerator::Listener resource') else null } },
