(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::EC2::SubnetCidrBlock', Properties: { SubnetId: if errorOnEmptyProp then (error 'You need to define SubnetId properties for AWS::EC2::SubnetCidrBlock resource') else null, Ipv6CidrBlock: if errorOnEmptyProp then (error 'You need to define Ipv6CidrBlock properties for AWS::EC2::SubnetCidrBlock resource') else null } },
