(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ServiceCatalog::PortfolioPrincipalAssociation', Properties: { PrincipalARN: if errorOnEmptyProp then (error 'You need to define PrincipalARN properties for AWS::ServiceCatalog::PortfolioPrincipalAssociation resource') else null, PrincipalType: if errorOnEmptyProp then (error 'You need to define PrincipalType properties for AWS::ServiceCatalog::PortfolioPrincipalAssociation resource') else null, PortfolioId: if errorOnEmptyProp then (error 'You need to define PortfolioId properties for AWS::ServiceCatalog::PortfolioPrincipalAssociation resource') else null } },
