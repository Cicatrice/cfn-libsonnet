(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ServiceCatalog::LaunchTemplateConstraint', Properties: { ProductId: if errorOnEmptyProp then (error 'You need to define ProductId properties for AWS::ServiceCatalog::LaunchTemplateConstraint resource') else null, Rules: if errorOnEmptyProp then (error 'You need to define Rules properties for AWS::ServiceCatalog::LaunchTemplateConstraint resource') else null, PortfolioId: if errorOnEmptyProp then (error 'You need to define PortfolioId properties for AWS::ServiceCatalog::LaunchTemplateConstraint resource') else null } },
