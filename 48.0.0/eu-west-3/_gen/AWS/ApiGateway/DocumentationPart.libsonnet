(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ApiGateway::DocumentationPart', Properties: { Properties: if errorOnEmptyProp then (error 'You need to define Properties properties for AWS::ApiGateway::DocumentationPart resource') else null, RestApiId: if errorOnEmptyProp then (error 'You need to define RestApiId properties for AWS::ApiGateway::DocumentationPart resource') else null, Location: if errorOnEmptyProp then (error 'You need to define Location properties for AWS::ApiGateway::DocumentationPart resource') else null } },
