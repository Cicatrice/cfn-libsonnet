(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::CloudFront::RealtimeLogConfig', Properties: { Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::CloudFront::RealtimeLogConfig resource') else null, SamplingRate: if errorOnEmptyProp then (error 'You need to define SamplingRate properties for AWS::CloudFront::RealtimeLogConfig resource') else null, EndPoints: if errorOnEmptyProp then (error 'You need to define EndPoints properties for AWS::CloudFront::RealtimeLogConfig resource') else null, Fields: if errorOnEmptyProp then (error 'You need to define Fields properties for AWS::CloudFront::RealtimeLogConfig resource') else null } },
