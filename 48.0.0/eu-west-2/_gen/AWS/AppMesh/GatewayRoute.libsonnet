(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::AppMesh::GatewayRoute', Properties: { VirtualGatewayName: if errorOnEmptyProp then (error 'You need to define VirtualGatewayName properties for AWS::AppMesh::GatewayRoute resource') else null, MeshName: if errorOnEmptyProp then (error 'You need to define MeshName properties for AWS::AppMesh::GatewayRoute resource') else null, Spec: if errorOnEmptyProp then (error 'You need to define Spec properties for AWS::AppMesh::GatewayRoute resource') else null } },
