(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::NimbleStudio::StudioComponent', Properties: { StudioId: if errorOnEmptyProp then (error 'You need to define StudioId properties for AWS::NimbleStudio::StudioComponent resource') else null, Type: if errorOnEmptyProp then (error 'You need to define Type properties for AWS::NimbleStudio::StudioComponent resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::NimbleStudio::StudioComponent resource') else null } },
