(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::AppSync::DataSource', Properties: { ApiId: if errorOnEmptyProp then (error 'You need to define ApiId properties for AWS::AppSync::DataSource resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::AppSync::DataSource resource') else null, Type: if errorOnEmptyProp then (error 'You need to define Type properties for AWS::AppSync::DataSource resource') else null } },
