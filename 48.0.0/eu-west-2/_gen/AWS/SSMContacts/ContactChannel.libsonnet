(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::SSMContacts::ContactChannel', Properties: { ContactId: if errorOnEmptyProp then (error 'You need to define ContactId properties for AWS::SSMContacts::ContactChannel resource') else null, ChannelAddress: if errorOnEmptyProp then (error 'You need to define ChannelAddress properties for AWS::SSMContacts::ContactChannel resource') else null, ChannelName: if errorOnEmptyProp then (error 'You need to define ChannelName properties for AWS::SSMContacts::ContactChannel resource') else null, ChannelType: if errorOnEmptyProp then (error 'You need to define ChannelType properties for AWS::SSMContacts::ContactChannel resource') else null } },
