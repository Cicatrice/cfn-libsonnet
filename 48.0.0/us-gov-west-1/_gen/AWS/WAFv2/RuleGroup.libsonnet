(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::WAFv2::RuleGroup', Properties: { VisibilityConfig: if errorOnEmptyProp then (error 'You need to define VisibilityConfig properties for AWS::WAFv2::RuleGroup resource') else null, Capacity: if errorOnEmptyProp then (error 'You need to define Capacity properties for AWS::WAFv2::RuleGroup resource') else null, Scope: if errorOnEmptyProp then (error 'You need to define Scope properties for AWS::WAFv2::RuleGroup resource') else null } },
