(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ServiceCatalog::ResourceUpdateConstraint', Properties: { TagUpdateOnProvisionedProduct: if errorOnEmptyProp then (error 'You need to define TagUpdateOnProvisionedProduct properties for AWS::ServiceCatalog::ResourceUpdateConstraint resource') else null, PortfolioId: if errorOnEmptyProp then (error 'You need to define PortfolioId properties for AWS::ServiceCatalog::ResourceUpdateConstraint resource') else null, ProductId: if errorOnEmptyProp then (error 'You need to define ProductId properties for AWS::ServiceCatalog::ResourceUpdateConstraint resource') else null } },
