(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ServiceCatalog::ServiceAction', Properties: { Definition: if errorOnEmptyProp then (error 'You need to define Definition properties for AWS::ServiceCatalog::ServiceAction resource') else null, DefinitionType: if errorOnEmptyProp then (error 'You need to define DefinitionType properties for AWS::ServiceCatalog::ServiceAction resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::ServiceCatalog::ServiceAction resource') else null } },
