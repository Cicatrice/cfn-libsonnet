(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::NetworkManager::CustomerGatewayAssociation', Properties: { DeviceId: if errorOnEmptyProp then (error 'You need to define DeviceId properties for AWS::NetworkManager::CustomerGatewayAssociation resource') else null, GlobalNetworkId: if errorOnEmptyProp then (error 'You need to define GlobalNetworkId properties for AWS::NetworkManager::CustomerGatewayAssociation resource') else null, CustomerGatewayArn: if errorOnEmptyProp then (error 'You need to define CustomerGatewayArn properties for AWS::NetworkManager::CustomerGatewayAssociation resource') else null } },
