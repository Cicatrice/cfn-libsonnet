(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::EC2::VPNConnectionRoute', Properties: { DestinationCidrBlock: if errorOnEmptyProp then (error 'You need to define DestinationCidrBlock properties for AWS::EC2::VPNConnectionRoute resource') else null, VpnConnectionId: if errorOnEmptyProp then (error 'You need to define VpnConnectionId properties for AWS::EC2::VPNConnectionRoute resource') else null } },
