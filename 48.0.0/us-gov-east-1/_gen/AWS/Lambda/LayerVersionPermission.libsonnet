(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Lambda::LayerVersionPermission', Properties: { Principal: if errorOnEmptyProp then (error 'You need to define Principal properties for AWS::Lambda::LayerVersionPermission resource') else null, Action: if errorOnEmptyProp then (error 'You need to define Action properties for AWS::Lambda::LayerVersionPermission resource') else null, LayerVersionArn: if errorOnEmptyProp then (error 'You need to define LayerVersionArn properties for AWS::Lambda::LayerVersionPermission resource') else null } },
