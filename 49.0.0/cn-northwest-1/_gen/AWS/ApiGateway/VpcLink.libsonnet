(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ApiGateway::VpcLink', Properties: { Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::ApiGateway::VpcLink resource') else null, TargetArns: if errorOnEmptyProp then (error 'You need to define TargetArns properties for AWS::ApiGateway::VpcLink resource') else null } },
