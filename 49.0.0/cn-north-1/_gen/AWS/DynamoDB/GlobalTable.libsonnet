(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::DynamoDB::GlobalTable', Properties: { AttributeDefinitions: if errorOnEmptyProp then (error 'You need to define AttributeDefinitions properties for AWS::DynamoDB::GlobalTable resource') else null, Replicas: if errorOnEmptyProp then (error 'You need to define Replicas properties for AWS::DynamoDB::GlobalTable resource') else null, KeySchema: if errorOnEmptyProp then (error 'You need to define KeySchema properties for AWS::DynamoDB::GlobalTable resource') else null } },
