(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::EC2::SubnetNetworkAclAssociation', Properties: { NetworkAclId: if errorOnEmptyProp then (error 'You need to define NetworkAclId properties for AWS::EC2::SubnetNetworkAclAssociation resource') else null, SubnetId: if errorOnEmptyProp then (error 'You need to define SubnetId properties for AWS::EC2::SubnetNetworkAclAssociation resource') else null } },
