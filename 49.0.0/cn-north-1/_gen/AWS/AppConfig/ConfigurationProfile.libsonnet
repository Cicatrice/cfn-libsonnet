(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::AppConfig::ConfigurationProfile', Properties: { ApplicationId: if errorOnEmptyProp then (error 'You need to define ApplicationId properties for AWS::AppConfig::ConfigurationProfile resource') else null, LocationUri: if errorOnEmptyProp then (error 'You need to define LocationUri properties for AWS::AppConfig::ConfigurationProfile resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::AppConfig::ConfigurationProfile resource') else null } },
