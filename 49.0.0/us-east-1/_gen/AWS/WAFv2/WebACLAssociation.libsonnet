(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::WAFv2::WebACLAssociation', Properties: { ResourceArn: if errorOnEmptyProp then (error 'You need to define ResourceArn properties for AWS::WAFv2::WebACLAssociation resource') else null, WebACLArn: if errorOnEmptyProp then (error 'You need to define WebACLArn properties for AWS::WAFv2::WebACLAssociation resource') else null } },
