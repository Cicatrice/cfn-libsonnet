(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::NimbleStudio::StreamingImage', Properties: { Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::NimbleStudio::StreamingImage resource') else null, StudioId: if errorOnEmptyProp then (error 'You need to define StudioId properties for AWS::NimbleStudio::StreamingImage resource') else null, Ec2ImageId: if errorOnEmptyProp then (error 'You need to define Ec2ImageId properties for AWS::NimbleStudio::StreamingImage resource') else null } },
