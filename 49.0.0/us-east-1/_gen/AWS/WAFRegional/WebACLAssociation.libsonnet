(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::WAFRegional::WebACLAssociation', Properties: { WebACLId: if errorOnEmptyProp then (error 'You need to define WebACLId properties for AWS::WAFRegional::WebACLAssociation resource') else null, ResourceArn: if errorOnEmptyProp then (error 'You need to define ResourceArn properties for AWS::WAFRegional::WebACLAssociation resource') else null } },
