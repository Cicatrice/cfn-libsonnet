(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Backup::BackupSelection', Properties: { BackupSelection: if errorOnEmptyProp then (error 'You need to define BackupSelection properties for AWS::Backup::BackupSelection resource') else null, BackupPlanId: if errorOnEmptyProp then (error 'You need to define BackupPlanId properties for AWS::Backup::BackupSelection resource') else null } },
