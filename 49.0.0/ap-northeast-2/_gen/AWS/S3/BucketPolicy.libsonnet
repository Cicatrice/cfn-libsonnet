(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::S3::BucketPolicy', Properties: { Bucket: if errorOnEmptyProp then (error 'You need to define Bucket properties for AWS::S3::BucketPolicy resource') else null, PolicyDocument: if errorOnEmptyProp then (error 'You need to define PolicyDocument properties for AWS::S3::BucketPolicy resource') else null } },
