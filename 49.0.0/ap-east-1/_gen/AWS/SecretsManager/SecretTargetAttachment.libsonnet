(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::SecretsManager::SecretTargetAttachment', Properties: { TargetId: if errorOnEmptyProp then (error 'You need to define TargetId properties for AWS::SecretsManager::SecretTargetAttachment resource') else null, TargetType: if errorOnEmptyProp then (error 'You need to define TargetType properties for AWS::SecretsManager::SecretTargetAttachment resource') else null, SecretId: if errorOnEmptyProp then (error 'You need to define SecretId properties for AWS::SecretsManager::SecretTargetAttachment resource') else null } },
