(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Greengrass::SubscriptionDefinitionVersion', Properties: { SubscriptionDefinitionId: if errorOnEmptyProp then (error 'You need to define SubscriptionDefinitionId properties for AWS::Greengrass::SubscriptionDefinitionVersion resource') else null, Subscriptions: if errorOnEmptyProp then (error 'You need to define Subscriptions properties for AWS::Greengrass::SubscriptionDefinitionVersion resource') else null } },
