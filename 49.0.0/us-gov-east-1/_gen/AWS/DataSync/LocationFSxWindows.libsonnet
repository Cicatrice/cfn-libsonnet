(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::DataSync::LocationFSxWindows', Properties: { User: if errorOnEmptyProp then (error 'You need to define User properties for AWS::DataSync::LocationFSxWindows resource') else null, FsxFilesystemArn: if errorOnEmptyProp then (error 'You need to define FsxFilesystemArn properties for AWS::DataSync::LocationFSxWindows resource') else null, Password: if errorOnEmptyProp then (error 'You need to define Password properties for AWS::DataSync::LocationFSxWindows resource') else null, SecurityGroupArns: if errorOnEmptyProp then (error 'You need to define SecurityGroupArns properties for AWS::DataSync::LocationFSxWindows resource') else null } },
