(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::EC2::ClientVpnTargetNetworkAssociation', Properties: { ClientVpnEndpointId: if errorOnEmptyProp then (error 'You need to define ClientVpnEndpointId properties for AWS::EC2::ClientVpnTargetNetworkAssociation resource') else null, SubnetId: if errorOnEmptyProp then (error 'You need to define SubnetId properties for AWS::EC2::ClientVpnTargetNetworkAssociation resource') else null } },
