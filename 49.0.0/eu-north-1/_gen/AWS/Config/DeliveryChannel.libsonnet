(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Config::DeliveryChannel', Properties: { S3BucketName: if errorOnEmptyProp then (error 'You need to define S3BucketName properties for AWS::Config::DeliveryChannel resource') else null } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-config-deliverychannel.html', args=[d.arg(name='errorOnEmptyProp', type=d.T.bool)]),
