(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ServiceCatalog::StackSetConstraint', Properties: { AdminRole: if errorOnEmptyProp then (error 'You need to define AdminRole properties for AWS::ServiceCatalog::StackSetConstraint resource') else null, ExecutionRole: if errorOnEmptyProp then (error 'You need to define ExecutionRole properties for AWS::ServiceCatalog::StackSetConstraint resource') else null, PortfolioId: if errorOnEmptyProp then (error 'You need to define PortfolioId properties for AWS::ServiceCatalog::StackSetConstraint resource') else null, StackInstanceControl: if errorOnEmptyProp then (error 'You need to define StackInstanceControl properties for AWS::ServiceCatalog::StackSetConstraint resource') else null, AccountList: if errorOnEmptyProp then (error 'You need to define AccountList properties for AWS::ServiceCatalog::StackSetConstraint resource') else null, Description: if errorOnEmptyProp then (error 'You need to define Description properties for AWS::ServiceCatalog::StackSetConstraint resource') else null, ProductId: if errorOnEmptyProp then (error 'You need to define ProductId properties for AWS::ServiceCatalog::StackSetConstraint resource') else null, RegionList: if errorOnEmptyProp then (error 'You need to define RegionList properties for AWS::ServiceCatalog::StackSetConstraint resource') else null } },
