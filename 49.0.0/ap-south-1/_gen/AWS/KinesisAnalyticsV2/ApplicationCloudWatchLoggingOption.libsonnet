(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::KinesisAnalyticsV2::ApplicationCloudWatchLoggingOption', Properties: { ApplicationName: if errorOnEmptyProp then (error 'You need to define ApplicationName properties for AWS::KinesisAnalyticsV2::ApplicationCloudWatchLoggingOption resource') else null, CloudWatchLoggingOption: if errorOnEmptyProp then (error 'You need to define CloudWatchLoggingOption properties for AWS::KinesisAnalyticsV2::ApplicationCloudWatchLoggingOption resource') else null } },
