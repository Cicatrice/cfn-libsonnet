(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::AppStream::StackUserAssociation', Properties: { AuthenticationType: if errorOnEmptyProp then (error 'You need to define AuthenticationType properties for AWS::AppStream::StackUserAssociation resource') else null, StackName: if errorOnEmptyProp then (error 'You need to define StackName properties for AWS::AppStream::StackUserAssociation resource') else null, UserName: if errorOnEmptyProp then (error 'You need to define UserName properties for AWS::AppStream::StackUserAssociation resource') else null } },
