(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ApplicationAutoScaling::ScalableTarget', Properties: { ResourceId: if errorOnEmptyProp then (error 'You need to define ResourceId properties for AWS::ApplicationAutoScaling::ScalableTarget resource') else null, RoleARN: if errorOnEmptyProp then (error 'You need to define RoleARN properties for AWS::ApplicationAutoScaling::ScalableTarget resource') else null, ScalableDimension: if errorOnEmptyProp then (error 'You need to define ScalableDimension properties for AWS::ApplicationAutoScaling::ScalableTarget resource') else null, ServiceNamespace: if errorOnEmptyProp then (error 'You need to define ServiceNamespace properties for AWS::ApplicationAutoScaling::ScalableTarget resource') else null, MaxCapacity: if errorOnEmptyProp then (error 'You need to define MaxCapacity properties for AWS::ApplicationAutoScaling::ScalableTarget resource') else null, MinCapacity: if errorOnEmptyProp then (error 'You need to define MinCapacity properties for AWS::ApplicationAutoScaling::ScalableTarget resource') else null } },
