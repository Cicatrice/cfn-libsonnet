(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::AppSync::FunctionConfiguration', Properties: { Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::AppSync::FunctionConfiguration resource') else null, FunctionVersion: if errorOnEmptyProp then (error 'You need to define FunctionVersion properties for AWS::AppSync::FunctionConfiguration resource') else null, ApiId: if errorOnEmptyProp then (error 'You need to define ApiId properties for AWS::AppSync::FunctionConfiguration resource') else null, DataSourceName: if errorOnEmptyProp then (error 'You need to define DataSourceName properties for AWS::AppSync::FunctionConfiguration resource') else null } },
