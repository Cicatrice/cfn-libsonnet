(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ManagedBlockchain::Node', Properties: { NetworkId: if errorOnEmptyProp then (error 'You need to define NetworkId properties for AWS::ManagedBlockchain::Node resource') else null, NodeConfiguration: if errorOnEmptyProp then (error 'You need to define NodeConfiguration properties for AWS::ManagedBlockchain::Node resource') else null, MemberId: if errorOnEmptyProp then (error 'You need to define MemberId properties for AWS::ManagedBlockchain::Node resource') else null } },
