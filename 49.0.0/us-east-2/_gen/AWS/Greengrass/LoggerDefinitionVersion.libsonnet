(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Greengrass::LoggerDefinitionVersion', Properties: { LoggerDefinitionId: if errorOnEmptyProp then (error 'You need to define LoggerDefinitionId properties for AWS::Greengrass::LoggerDefinitionVersion resource') else null, Loggers: if errorOnEmptyProp then (error 'You need to define Loggers properties for AWS::Greengrass::LoggerDefinitionVersion resource') else null } },
