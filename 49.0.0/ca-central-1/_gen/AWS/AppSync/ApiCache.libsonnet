(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::AppSync::ApiCache', Properties: { Type: if errorOnEmptyProp then (error 'You need to define Type properties for AWS::AppSync::ApiCache resource') else null, ApiCachingBehavior: if errorOnEmptyProp then (error 'You need to define ApiCachingBehavior properties for AWS::AppSync::ApiCache resource') else null, ApiId: if errorOnEmptyProp then (error 'You need to define ApiId properties for AWS::AppSync::ApiCache resource') else null, Ttl: if errorOnEmptyProp then (error 'You need to define Ttl properties for AWS::AppSync::ApiCache resource') else null } },
