(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::DocDB::DBClusterParameterGroup', Properties: { Parameters: if errorOnEmptyProp then (error 'You need to define Parameters properties for AWS::DocDB::DBClusterParameterGroup resource') else null, Description: if errorOnEmptyProp then (error 'You need to define Description properties for AWS::DocDB::DBClusterParameterGroup resource') else null, Family: if errorOnEmptyProp then (error 'You need to define Family properties for AWS::DocDB::DBClusterParameterGroup resource') else null } },
