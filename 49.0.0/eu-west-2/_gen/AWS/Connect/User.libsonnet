(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Connect::User', Properties: { RoutingProfileArn: if errorOnEmptyProp then (error 'You need to define RoutingProfileArn properties for AWS::Connect::User resource') else null, Username: if errorOnEmptyProp then (error 'You need to define Username properties for AWS::Connect::User resource') else null, InstanceArn: if errorOnEmptyProp then (error 'You need to define InstanceArn properties for AWS::Connect::User resource') else null, PhoneConfig: if errorOnEmptyProp then (error 'You need to define PhoneConfig properties for AWS::Connect::User resource') else null, SecurityProfileArns: if errorOnEmptyProp then (error 'You need to define SecurityProfileArns properties for AWS::Connect::User resource') else null } },
