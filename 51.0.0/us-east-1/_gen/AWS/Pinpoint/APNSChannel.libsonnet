(import '../../../extensions/attributes.libsonnet') + {
  ...
  '#':: d.pkg(name='APNSChannel', url='', help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pinpoint-apnschannel.html'),
  new(errorOnEmptyProp=true): { Type: 'AWS::Pinpoint::APNSChannel', Properties: { ApplicationId: if errorOnEmptyProp then (error 'You need to define ApplicationId properties for AWS::Pinpoint::APNSChannel resource') else null } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pinpoint-apnschannel.html', args=[d.arg(name='errorOnEmptyProp', type=d.T.bool)]),
  ...
  '#withEnabled':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pinpoint-apnschannel.html#cfn-pinpoint-apnschannel-enabled', args=[d.arg(name='enabled', type=d.T.bool)]),
