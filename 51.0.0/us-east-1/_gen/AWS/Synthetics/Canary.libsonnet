(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Synthetics::Canary', Properties: { Code: if errorOnEmptyProp then (error 'You need to define Code properties for AWS::Synthetics::Canary resource') else null, ArtifactS3Location: if errorOnEmptyProp then (error 'You need to define ArtifactS3Location properties for AWS::Synthetics::Canary resource') else null, ExecutionRoleArn: if errorOnEmptyProp then (error 'You need to define ExecutionRoleArn properties for AWS::Synthetics::Canary resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::Synthetics::Canary resource') else null, RuntimeVersion: if errorOnEmptyProp then (error 'You need to define RuntimeVersion properties for AWS::Synthetics::Canary resource') else null, Schedule: if errorOnEmptyProp then (error 'You need to define Schedule properties for AWS::Synthetics::Canary resource') else null, StartCanaryAfterCreation: if errorOnEmptyProp then (error 'You need to define StartCanaryAfterCreation properties for AWS::Synthetics::Canary resource') else null } },
