(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ServiceCatalog::TagOption', Properties: { Key: if errorOnEmptyProp then (error 'You need to define Key properties for AWS::ServiceCatalog::TagOption resource') else null, Value: if errorOnEmptyProp then (error 'You need to define Value properties for AWS::ServiceCatalog::TagOption resource') else null } },
