(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::IoT::PolicyPrincipalAttachment', Properties: { Principal: if errorOnEmptyProp then (error 'You need to define Principal properties for AWS::IoT::PolicyPrincipalAttachment resource') else null, PolicyName: if errorOnEmptyProp then (error 'You need to define PolicyName properties for AWS::IoT::PolicyPrincipalAttachment resource') else null } },
