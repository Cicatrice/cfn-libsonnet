(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::MemoryDB::SubnetGroup', Properties: { SubnetIds: if errorOnEmptyProp then (error 'You need to define SubnetIds properties for AWS::MemoryDB::SubnetGroup resource') else null, SubnetGroupName: if errorOnEmptyProp then (error 'You need to define SubnetGroupName properties for AWS::MemoryDB::SubnetGroup resource') else null } },
