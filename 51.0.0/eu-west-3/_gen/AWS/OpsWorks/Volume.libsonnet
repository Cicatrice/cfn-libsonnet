(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::OpsWorks::Volume', Properties: { Ec2VolumeId: if errorOnEmptyProp then (error 'You need to define Ec2VolumeId properties for AWS::OpsWorks::Volume resource') else null, StackId: if errorOnEmptyProp then (error 'You need to define StackId properties for AWS::OpsWorks::Volume resource') else null } },
