(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::EC2::CapacityReservation', Properties: { AvailabilityZone: if errorOnEmptyProp then (error 'You need to define AvailabilityZone properties for AWS::EC2::CapacityReservation resource') else null, InstancePlatform: if errorOnEmptyProp then (error 'You need to define InstancePlatform properties for AWS::EC2::CapacityReservation resource') else null, InstanceType: if errorOnEmptyProp then (error 'You need to define InstanceType properties for AWS::EC2::CapacityReservation resource') else null, InstanceCount: if errorOnEmptyProp then (error 'You need to define InstanceCount properties for AWS::EC2::CapacityReservation resource') else null } },
