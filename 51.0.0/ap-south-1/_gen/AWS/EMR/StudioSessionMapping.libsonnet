(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::EMR::StudioSessionMapping', Properties: { IdentityType: if errorOnEmptyProp then (error 'You need to define IdentityType properties for AWS::EMR::StudioSessionMapping resource') else null, SessionPolicyArn: if errorOnEmptyProp then (error 'You need to define SessionPolicyArn properties for AWS::EMR::StudioSessionMapping resource') else null, StudioId: if errorOnEmptyProp then (error 'You need to define StudioId properties for AWS::EMR::StudioSessionMapping resource') else null, IdentityName: if errorOnEmptyProp then (error 'You need to define IdentityName properties for AWS::EMR::StudioSessionMapping resource') else null } },
