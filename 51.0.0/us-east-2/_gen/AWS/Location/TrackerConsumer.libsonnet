(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Location::TrackerConsumer', Properties: { ConsumerArn: if errorOnEmptyProp then (error 'You need to define ConsumerArn properties for AWS::Location::TrackerConsumer resource') else null, TrackerName: if errorOnEmptyProp then (error 'You need to define TrackerName properties for AWS::Location::TrackerConsumer resource') else null } },
