(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::SSM::Parameter', Properties: { Type: if errorOnEmptyProp then (error 'You need to define Type properties for AWS::SSM::Parameter resource') else null, Value: if errorOnEmptyProp then (error 'You need to define Value properties for AWS::SSM::Parameter resource') else null } },
