(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Lex::BotVersion', Properties: { BotVersionLocaleSpecification: if errorOnEmptyProp then (error 'You need to define BotVersionLocaleSpecification properties for AWS::Lex::BotVersion resource') else null, BotId: if errorOnEmptyProp then (error 'You need to define BotId properties for AWS::Lex::BotVersion resource') else null } },
