(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::DataSync::LocationObjectStorage', Properties: { ServerHostname: if errorOnEmptyProp then (error 'You need to define ServerHostname properties for AWS::DataSync::LocationObjectStorage resource') else null, AgentArns: if errorOnEmptyProp then (error 'You need to define AgentArns properties for AWS::DataSync::LocationObjectStorage resource') else null, BucketName: if errorOnEmptyProp then (error 'You need to define BucketName properties for AWS::DataSync::LocationObjectStorage resource') else null } },
