(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ServiceCatalog::TagOptionAssociation', Properties: { ResourceId: if errorOnEmptyProp then (error 'You need to define ResourceId properties for AWS::ServiceCatalog::TagOptionAssociation resource') else null, TagOptionId: if errorOnEmptyProp then (error 'You need to define TagOptionId properties for AWS::ServiceCatalog::TagOptionAssociation resource') else null } },
