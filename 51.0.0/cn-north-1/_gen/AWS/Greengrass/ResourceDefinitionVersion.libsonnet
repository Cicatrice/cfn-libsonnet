(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Greengrass::ResourceDefinitionVersion', Properties: { Resources: if errorOnEmptyProp then (error 'You need to define Resources properties for AWS::Greengrass::ResourceDefinitionVersion resource') else null, ResourceDefinitionId: if errorOnEmptyProp then (error 'You need to define ResourceDefinitionId properties for AWS::Greengrass::ResourceDefinitionVersion resource') else null } },
