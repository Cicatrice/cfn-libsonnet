(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::EMR::InstanceGroupConfig', Properties: { InstanceRole: if errorOnEmptyProp then (error 'You need to define InstanceRole properties for AWS::EMR::InstanceGroupConfig resource') else null, InstanceType: if errorOnEmptyProp then (error 'You need to define InstanceType properties for AWS::EMR::InstanceGroupConfig resource') else null, JobFlowId: if errorOnEmptyProp then (error 'You need to define JobFlowId properties for AWS::EMR::InstanceGroupConfig resource') else null, InstanceCount: if errorOnEmptyProp then (error 'You need to define InstanceCount properties for AWS::EMR::InstanceGroupConfig resource') else null } },
