(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::WAFv2::WebACL', Properties: { Scope: if errorOnEmptyProp then (error 'You need to define Scope properties for AWS::WAFv2::WebACL resource') else null, DefaultAction: if errorOnEmptyProp then (error 'You need to define DefaultAction properties for AWS::WAFv2::WebACL resource') else null, VisibilityConfig: if errorOnEmptyProp then (error 'You need to define VisibilityConfig properties for AWS::WAFv2::WebACL resource') else null } },
