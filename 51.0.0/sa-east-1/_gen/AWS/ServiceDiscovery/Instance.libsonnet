(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ServiceDiscovery::Instance', Properties: { InstanceAttributes: if errorOnEmptyProp then (error 'You need to define InstanceAttributes properties for AWS::ServiceDiscovery::Instance resource') else null, ServiceId: if errorOnEmptyProp then (error 'You need to define ServiceId properties for AWS::ServiceDiscovery::Instance resource') else null } },
