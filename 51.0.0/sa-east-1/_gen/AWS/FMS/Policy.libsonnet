(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::FMS::Policy', Properties: { SecurityServicePolicyData: if errorOnEmptyProp then (error 'You need to define SecurityServicePolicyData properties for AWS::FMS::Policy resource') else null, ExcludeResourceTags: if errorOnEmptyProp then (error 'You need to define ExcludeResourceTags properties for AWS::FMS::Policy resource') else null, RemediationEnabled: if errorOnEmptyProp then (error 'You need to define RemediationEnabled properties for AWS::FMS::Policy resource') else null, ResourceType: if errorOnEmptyProp then (error 'You need to define ResourceType properties for AWS::FMS::Policy resource') else null, PolicyName: if errorOnEmptyProp then (error 'You need to define PolicyName properties for AWS::FMS::Policy resource') else null } },
