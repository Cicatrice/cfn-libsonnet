(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::MemoryDB::User', Properties: { AuthenticationMode: if errorOnEmptyProp then (error 'You need to define AuthenticationMode properties for AWS::MemoryDB::User resource') else null, UserName: if errorOnEmptyProp then (error 'You need to define UserName properties for AWS::MemoryDB::User resource') else null, AccessString: if errorOnEmptyProp then (error 'You need to define AccessString properties for AWS::MemoryDB::User resource') else null } },
