(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::DirectoryService::SimpleAD', Properties: { VpcSettings: if errorOnEmptyProp then (error 'You need to define VpcSettings properties for AWS::DirectoryService::SimpleAD resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::DirectoryService::SimpleAD resource') else null, Password: if errorOnEmptyProp then (error 'You need to define Password properties for AWS::DirectoryService::SimpleAD resource') else null, Size: if errorOnEmptyProp then (error 'You need to define Size properties for AWS::DirectoryService::SimpleAD resource') else null } },
