(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::CUR::ReportDefinition', Properties: { RefreshClosedReports: if errorOnEmptyProp then (error 'You need to define RefreshClosedReports properties for AWS::CUR::ReportDefinition resource') else null, ReportVersioning: if errorOnEmptyProp then (error 'You need to define ReportVersioning properties for AWS::CUR::ReportDefinition resource') else null, S3Bucket: if errorOnEmptyProp then (error 'You need to define S3Bucket properties for AWS::CUR::ReportDefinition resource') else null, S3Region: if errorOnEmptyProp then (error 'You need to define S3Region properties for AWS::CUR::ReportDefinition resource') else null, Compression: if errorOnEmptyProp then (error 'You need to define Compression properties for AWS::CUR::ReportDefinition resource') else null, Format: if errorOnEmptyProp then (error 'You need to define Format properties for AWS::CUR::ReportDefinition resource') else null, ReportName: if errorOnEmptyProp then (error 'You need to define ReportName properties for AWS::CUR::ReportDefinition resource') else null, S3Prefix: if errorOnEmptyProp then (error 'You need to define S3Prefix properties for AWS::CUR::ReportDefinition resource') else null, TimeUnit: if errorOnEmptyProp then (error 'You need to define TimeUnit properties for AWS::CUR::ReportDefinition resource') else null } },
