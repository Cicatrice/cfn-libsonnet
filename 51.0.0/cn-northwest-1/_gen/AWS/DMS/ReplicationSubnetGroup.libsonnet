(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::DMS::ReplicationSubnetGroup', Properties: { SubnetIds: if errorOnEmptyProp then (error 'You need to define SubnetIds properties for AWS::DMS::ReplicationSubnetGroup resource') else null, ReplicationSubnetGroupDescription: if errorOnEmptyProp then (error 'You need to define ReplicationSubnetGroupDescription properties for AWS::DMS::ReplicationSubnetGroup resource') else null } },
