(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::SageMaker::ImageVersion', Properties: { ImageName: if errorOnEmptyProp then (error 'You need to define ImageName properties for AWS::SageMaker::ImageVersion resource') else null, BaseImage: if errorOnEmptyProp then (error 'You need to define BaseImage properties for AWS::SageMaker::ImageVersion resource') else null } },
