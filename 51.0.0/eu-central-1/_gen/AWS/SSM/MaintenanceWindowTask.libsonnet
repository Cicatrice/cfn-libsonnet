(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::SSM::MaintenanceWindowTask', Properties: { TaskType: if errorOnEmptyProp then (error 'You need to define TaskType properties for AWS::SSM::MaintenanceWindowTask resource') else null, WindowId: if errorOnEmptyProp then (error 'You need to define WindowId properties for AWS::SSM::MaintenanceWindowTask resource') else null, TaskArn: if errorOnEmptyProp then (error 'You need to define TaskArn properties for AWS::SSM::MaintenanceWindowTask resource') else null, Priority: if errorOnEmptyProp then (error 'You need to define Priority properties for AWS::SSM::MaintenanceWindowTask resource') else null } },
