(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::KinesisAnalyticsV2::ApplicationReferenceDataSource', Properties: { ReferenceDataSource: if errorOnEmptyProp then (error 'You need to define ReferenceDataSource properties for AWS::KinesisAnalyticsV2::ApplicationReferenceDataSource resource') else null, ApplicationName: if errorOnEmptyProp then (error 'You need to define ApplicationName properties for AWS::KinesisAnalyticsV2::ApplicationReferenceDataSource resource') else null } },
