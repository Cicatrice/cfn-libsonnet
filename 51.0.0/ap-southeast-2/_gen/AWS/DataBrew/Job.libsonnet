(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::DataBrew::Job', Properties: { Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::DataBrew::Job resource') else null, RoleArn: if errorOnEmptyProp then (error 'You need to define RoleArn properties for AWS::DataBrew::Job resource') else null, Type: if errorOnEmptyProp then (error 'You need to define Type properties for AWS::DataBrew::Job resource') else null } },
