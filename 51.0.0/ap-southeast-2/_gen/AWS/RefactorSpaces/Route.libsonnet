(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::RefactorSpaces::Route', Properties: { EnvironmentIdentifier: if errorOnEmptyProp then (error 'You need to define EnvironmentIdentifier properties for AWS::RefactorSpaces::Route resource') else null, ServiceIdentifier: if errorOnEmptyProp then (error 'You need to define ServiceIdentifier properties for AWS::RefactorSpaces::Route resource') else null, ApplicationIdentifier: if errorOnEmptyProp then (error 'You need to define ApplicationIdentifier properties for AWS::RefactorSpaces::Route resource') else null } },
