(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::CloudWatch::InsightRule', Properties: { RuleState: if errorOnEmptyProp then (error 'You need to define RuleState properties for AWS::CloudWatch::InsightRule resource') else null, RuleBody: if errorOnEmptyProp then (error 'You need to define RuleBody properties for AWS::CloudWatch::InsightRule resource') else null, RuleName: if errorOnEmptyProp then (error 'You need to define RuleName properties for AWS::CloudWatch::InsightRule resource') else null } },
