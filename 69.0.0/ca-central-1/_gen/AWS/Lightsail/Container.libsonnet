(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Lightsail::Container', Properties: { Power: if errorOnEmptyProp then (error 'You need to define Power properties for AWS::Lightsail::Container resource') else null, Scale: if errorOnEmptyProp then (error 'You need to define Scale properties for AWS::Lightsail::Container resource') else null, ServiceName: if errorOnEmptyProp then (error 'You need to define ServiceName properties for AWS::Lightsail::Container resource') else null } },
