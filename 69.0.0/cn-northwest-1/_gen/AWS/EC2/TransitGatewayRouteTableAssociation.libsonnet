(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::EC2::TransitGatewayRouteTableAssociation', Properties: { TransitGatewayAttachmentId: if errorOnEmptyProp then (error 'You need to define TransitGatewayAttachmentId properties for AWS::EC2::TransitGatewayRouteTableAssociation resource') else null, TransitGatewayRouteTableId: if errorOnEmptyProp then (error 'You need to define TransitGatewayRouteTableId properties for AWS::EC2::TransitGatewayRouteTableAssociation resource') else null } },
