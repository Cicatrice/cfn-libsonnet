(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ApiGatewayV2::IntegrationResponse', Properties: { IntegrationResponseKey: if errorOnEmptyProp then (error 'You need to define IntegrationResponseKey properties for AWS::ApiGatewayV2::IntegrationResponse resource') else null, ApiId: if errorOnEmptyProp then (error 'You need to define ApiId properties for AWS::ApiGatewayV2::IntegrationResponse resource') else null, IntegrationId: if errorOnEmptyProp then (error 'You need to define IntegrationId properties for AWS::ApiGatewayV2::IntegrationResponse resource') else null } },
