(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::EC2::LocalGatewayRouteTableVPCAssociation', Properties: { VpcId: if errorOnEmptyProp then (error 'You need to define VpcId properties for AWS::EC2::LocalGatewayRouteTableVPCAssociation resource') else null, LocalGatewayRouteTableId: if errorOnEmptyProp then (error 'You need to define LocalGatewayRouteTableId properties for AWS::EC2::LocalGatewayRouteTableVPCAssociation resource') else null } },
