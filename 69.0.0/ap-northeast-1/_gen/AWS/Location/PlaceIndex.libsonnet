(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Location::PlaceIndex', Properties: { DataSource: if errorOnEmptyProp then (error 'You need to define DataSource properties for AWS::Location::PlaceIndex resource') else null, IndexName: if errorOnEmptyProp then (error 'You need to define IndexName properties for AWS::Location::PlaceIndex resource') else null } },
