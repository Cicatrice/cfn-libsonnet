(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ResilienceHub::App', Properties: { AppTemplateBody: if errorOnEmptyProp then (error 'You need to define AppTemplateBody properties for AWS::ResilienceHub::App resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::ResilienceHub::App resource') else null, ResourceMappings: if errorOnEmptyProp then (error 'You need to define ResourceMappings properties for AWS::ResilienceHub::App resource') else null } },
