(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Forecast::Dataset', Properties: { Schema: if errorOnEmptyProp then (error 'You need to define Schema properties for AWS::Forecast::Dataset resource') else null, DatasetName: if errorOnEmptyProp then (error 'You need to define DatasetName properties for AWS::Forecast::Dataset resource') else null, DatasetType: if errorOnEmptyProp then (error 'You need to define DatasetType properties for AWS::Forecast::Dataset resource') else null, Domain: if errorOnEmptyProp then (error 'You need to define Domain properties for AWS::Forecast::Dataset resource') else null } },
