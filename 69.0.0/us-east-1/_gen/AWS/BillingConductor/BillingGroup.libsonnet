(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::BillingConductor::BillingGroup', Properties: { ComputationPreference: if errorOnEmptyProp then (error 'You need to define ComputationPreference properties for AWS::BillingConductor::BillingGroup resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::BillingConductor::BillingGroup resource') else null, PrimaryAccountId: if errorOnEmptyProp then (error 'You need to define PrimaryAccountId properties for AWS::BillingConductor::BillingGroup resource') else null, AccountGrouping: if errorOnEmptyProp then (error 'You need to define AccountGrouping properties for AWS::BillingConductor::BillingGroup resource') else null } },
