(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Personalize::Schema', Properties: { Schema: if errorOnEmptyProp then (error 'You need to define Schema properties for AWS::Personalize::Schema resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::Personalize::Schema resource') else null } },
