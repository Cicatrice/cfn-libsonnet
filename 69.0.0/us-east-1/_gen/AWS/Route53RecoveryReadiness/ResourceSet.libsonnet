(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Route53RecoveryReadiness::ResourceSet', Properties: { ResourceSetType: if errorOnEmptyProp then (error 'You need to define ResourceSetType properties for AWS::Route53RecoveryReadiness::ResourceSet resource') else null, Resources: if errorOnEmptyProp then (error 'You need to define Resources properties for AWS::Route53RecoveryReadiness::ResourceSet resource') else null, ResourceSetName: if errorOnEmptyProp then (error 'You need to define ResourceSetName properties for AWS::Route53RecoveryReadiness::ResourceSet resource') else null } },
