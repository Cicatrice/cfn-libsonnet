(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::InspectorV2::Filter', Properties: { FilterAction: if errorOnEmptyProp then (error 'You need to define FilterAction properties for AWS::InspectorV2::Filter resource') else null, FilterCriteria: if errorOnEmptyProp then (error 'You need to define FilterCriteria properties for AWS::InspectorV2::Filter resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::InspectorV2::Filter resource') else null } },
