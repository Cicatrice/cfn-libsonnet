(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Location::RouteCalculator', Properties: { DataSource: if errorOnEmptyProp then (error 'You need to define DataSource properties for AWS::Location::RouteCalculator resource') else null, CalculatorName: if errorOnEmptyProp then (error 'You need to define CalculatorName properties for AWS::Location::RouteCalculator resource') else null } },
