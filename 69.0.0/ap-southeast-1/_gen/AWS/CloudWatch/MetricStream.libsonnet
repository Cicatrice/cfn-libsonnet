(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::CloudWatch::MetricStream', Properties: { FirehoseArn: if errorOnEmptyProp then (error 'You need to define FirehoseArn properties for AWS::CloudWatch::MetricStream resource') else null, OutputFormat: if errorOnEmptyProp then (error 'You need to define OutputFormat properties for AWS::CloudWatch::MetricStream resource') else null, RoleArn: if errorOnEmptyProp then (error 'You need to define RoleArn properties for AWS::CloudWatch::MetricStream resource') else null } },
