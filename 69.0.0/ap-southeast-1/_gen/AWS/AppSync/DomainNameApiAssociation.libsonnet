(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::AppSync::DomainNameApiAssociation', Properties: { DomainName: if errorOnEmptyProp then (error 'You need to define DomainName properties for AWS::AppSync::DomainNameApiAssociation resource') else null, ApiId: if errorOnEmptyProp then (error 'You need to define ApiId properties for AWS::AppSync::DomainNameApiAssociation resource') else null } },
