(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::MediaTailor::PlaybackConfiguration', Properties: { Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::MediaTailor::PlaybackConfiguration resource') else null, AdDecisionServerUrl: if errorOnEmptyProp then (error 'You need to define AdDecisionServerUrl properties for AWS::MediaTailor::PlaybackConfiguration resource') else null, VideoContentSourceUrl: if errorOnEmptyProp then (error 'You need to define VideoContentSourceUrl properties for AWS::MediaTailor::PlaybackConfiguration resource') else null } },
