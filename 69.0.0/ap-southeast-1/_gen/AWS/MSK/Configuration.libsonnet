(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::MSK::Configuration', Properties: { Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::MSK::Configuration resource') else null, ServerProperties: if errorOnEmptyProp then (error 'You need to define ServerProperties properties for AWS::MSK::Configuration resource') else null } },
