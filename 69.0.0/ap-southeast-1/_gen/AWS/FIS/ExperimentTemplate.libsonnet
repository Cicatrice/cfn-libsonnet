(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::FIS::ExperimentTemplate', Properties: { Tags: if errorOnEmptyProp then (error 'You need to define Tags properties for AWS::FIS::ExperimentTemplate resource') else null, Targets: if errorOnEmptyProp then (error 'You need to define Targets properties for AWS::FIS::ExperimentTemplate resource') else null, Description: if errorOnEmptyProp then (error 'You need to define Description properties for AWS::FIS::ExperimentTemplate resource') else null, RoleArn: if errorOnEmptyProp then (error 'You need to define RoleArn properties for AWS::FIS::ExperimentTemplate resource') else null, StopConditions: if errorOnEmptyProp then (error 'You need to define StopConditions properties for AWS::FIS::ExperimentTemplate resource') else null } },
