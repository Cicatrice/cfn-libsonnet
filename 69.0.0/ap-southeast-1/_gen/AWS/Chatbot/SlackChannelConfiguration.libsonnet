(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Chatbot::SlackChannelConfiguration', Properties: { IamRoleArn: if errorOnEmptyProp then (error 'You need to define IamRoleArn properties for AWS::Chatbot::SlackChannelConfiguration resource') else null, SlackChannelId: if errorOnEmptyProp then (error 'You need to define SlackChannelId properties for AWS::Chatbot::SlackChannelConfiguration resource') else null, SlackWorkspaceId: if errorOnEmptyProp then (error 'You need to define SlackWorkspaceId properties for AWS::Chatbot::SlackChannelConfiguration resource') else null, ConfigurationName: if errorOnEmptyProp then (error 'You need to define ConfigurationName properties for AWS::Chatbot::SlackChannelConfiguration resource') else null } },
  ...
  '#withGuardrailPolicies':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-chatbot-slackchannelconfiguration.html#cfn-chatbot-slackchannelconfiguration-guardrailpolicies', args=[d.arg(name='guardrailPolicies', type=d.T.array)]),
  withGuardrailPolicies(guardrailPolicies): { Properties+: { GuardrailPolicies: guardrailPolicies } },
  '#withGuardrailPoliciesMixin':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-chatbot-slackchannelconfiguration.html#cfn-chatbot-slackchannelconfiguration-guardrailpolicies', args=[d.arg(name='guardrailPolicies', type=d.T.array)]),
  withGuardrailPoliciesMixin(guardrailPolicies): { Properties+: { GuardrailPolicies+: guardrailPolicies } },
  ...
  '#withUserRoleRequired':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-chatbot-slackchannelconfiguration.html#cfn-chatbot-slackchannelconfiguration-userrolerequired', args=[d.arg(name='userRoleRequired', type=d.T.bool)]),
  withUserRoleRequired(userRoleRequired): { Properties+: { UserRoleRequired: userRoleRequired } },
}
