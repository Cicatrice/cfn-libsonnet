(import '../../../extensions/attributes.libsonnet') + {
  ...
  '#withEnableCachingForHttp':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iot-authorizer.html#cfn-iot-authorizer-enablecachingforhttp', args=[d.arg(name='enableCachingForHttp', type=d.T.bool)]),
  withEnableCachingForHttp(enableCachingForHttp): { Properties+: { EnableCachingForHttp: enableCachingForHttp } },
