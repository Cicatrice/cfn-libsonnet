(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ElasticBeanstalk::ApplicationVersion', Properties: { SourceBundle: if errorOnEmptyProp then (error 'You need to define SourceBundle properties for AWS::ElasticBeanstalk::ApplicationVersion resource') else null, ApplicationName: if errorOnEmptyProp then (error 'You need to define ApplicationName properties for AWS::ElasticBeanstalk::ApplicationVersion resource') else null } },
