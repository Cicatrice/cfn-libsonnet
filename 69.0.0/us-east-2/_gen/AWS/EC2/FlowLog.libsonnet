(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::EC2::FlowLog', Properties: { ResourceId: if errorOnEmptyProp then (error 'You need to define ResourceId properties for AWS::EC2::FlowLog resource') else null, TrafficType: if errorOnEmptyProp then (error 'You need to define TrafficType properties for AWS::EC2::FlowLog resource') else null, ResourceType: if errorOnEmptyProp then (error 'You need to define ResourceType properties for AWS::EC2::FlowLog resource') else null } },
