(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::CodeStar::GitHubRepository', Properties: { RepositoryOwner: if errorOnEmptyProp then (error 'You need to define RepositoryOwner properties for AWS::CodeStar::GitHubRepository resource') else null, RepositoryName: if errorOnEmptyProp then (error 'You need to define RepositoryName properties for AWS::CodeStar::GitHubRepository resource') else null } },
