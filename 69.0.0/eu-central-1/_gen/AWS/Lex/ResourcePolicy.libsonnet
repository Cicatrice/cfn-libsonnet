(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Lex::ResourcePolicy', Properties: { Policy: if errorOnEmptyProp then (error 'You need to define Policy properties for AWS::Lex::ResourcePolicy resource') else null, ResourceArn: if errorOnEmptyProp then (error 'You need to define ResourceArn properties for AWS::Lex::ResourcePolicy resource') else null } },
