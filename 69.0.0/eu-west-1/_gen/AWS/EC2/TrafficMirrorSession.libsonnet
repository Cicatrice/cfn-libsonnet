(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::EC2::TrafficMirrorSession', Properties: { SessionNumber: if errorOnEmptyProp then (error 'You need to define SessionNumber properties for AWS::EC2::TrafficMirrorSession resource') else null, TrafficMirrorFilterId: if errorOnEmptyProp then (error 'You need to define TrafficMirrorFilterId properties for AWS::EC2::TrafficMirrorSession resource') else null, TrafficMirrorTargetId: if errorOnEmptyProp then (error 'You need to define TrafficMirrorTargetId properties for AWS::EC2::TrafficMirrorSession resource') else null, NetworkInterfaceId: if errorOnEmptyProp then (error 'You need to define NetworkInterfaceId properties for AWS::EC2::TrafficMirrorSession resource') else null } },
