(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::SES::ConfigurationSetEventDestination', Properties: { ConfigurationSetName: if errorOnEmptyProp then (error 'You need to define ConfigurationSetName properties for AWS::SES::ConfigurationSetEventDestination resource') else null, EventDestination: if errorOnEmptyProp then (error 'You need to define EventDestination properties for AWS::SES::ConfigurationSetEventDestination resource') else null } },
