(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::OpsWorksCM::Server', Properties: { InstanceProfileArn: if errorOnEmptyProp then (error 'You need to define InstanceProfileArn properties for AWS::OpsWorksCM::Server resource') else null, ServiceRoleArn: if errorOnEmptyProp then (error 'You need to define ServiceRoleArn properties for AWS::OpsWorksCM::Server resource') else null, InstanceType: if errorOnEmptyProp then (error 'You need to define InstanceType properties for AWS::OpsWorksCM::Server resource') else null } },
