(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::FSx::Snapshot', Properties: { Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::FSx::Snapshot resource') else null, VolumeId: if errorOnEmptyProp then (error 'You need to define VolumeId properties for AWS::FSx::Snapshot resource') else null } },
