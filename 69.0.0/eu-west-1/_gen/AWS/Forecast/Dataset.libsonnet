(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Forecast::Dataset', Properties: { DatasetName: if errorOnEmptyProp then (error 'You need to define DatasetName properties for AWS::Forecast::Dataset resource') else null, DatasetType: if errorOnEmptyProp then (error 'You need to define DatasetType properties for AWS::Forecast::Dataset resource') else null, Domain: if errorOnEmptyProp then (error 'You need to define Domain properties for AWS::Forecast::Dataset resource') else null, Schema: if errorOnEmptyProp then (error 'You need to define Schema properties for AWS::Forecast::Dataset resource') else null } },
