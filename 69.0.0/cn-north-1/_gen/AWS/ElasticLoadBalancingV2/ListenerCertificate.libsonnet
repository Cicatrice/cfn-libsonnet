(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ElasticLoadBalancingV2::ListenerCertificate', Properties: { Certificates: if errorOnEmptyProp then (error 'You need to define Certificates properties for AWS::ElasticLoadBalancingV2::ListenerCertificate resource') else null, ListenerArn: if errorOnEmptyProp then (error 'You need to define ListenerArn properties for AWS::ElasticLoadBalancingV2::ListenerCertificate resource') else null } },
