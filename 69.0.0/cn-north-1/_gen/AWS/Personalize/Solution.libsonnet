(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Personalize::Solution', Properties: { DatasetGroupArn: if errorOnEmptyProp then (error 'You need to define DatasetGroupArn properties for AWS::Personalize::Solution resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::Personalize::Solution resource') else null } },
