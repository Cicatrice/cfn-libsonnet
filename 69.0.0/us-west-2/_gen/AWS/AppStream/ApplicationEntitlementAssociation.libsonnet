(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::AppStream::ApplicationEntitlementAssociation', Properties: { StackName: if errorOnEmptyProp then (error 'You need to define StackName properties for AWS::AppStream::ApplicationEntitlementAssociation resource') else null, ApplicationIdentifier: if errorOnEmptyProp then (error 'You need to define ApplicationIdentifier properties for AWS::AppStream::ApplicationEntitlementAssociation resource') else null, EntitlementName: if errorOnEmptyProp then (error 'You need to define EntitlementName properties for AWS::AppStream::ApplicationEntitlementAssociation resource') else null } },
