(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::AppStream::Entitlement', Properties: { Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::AppStream::Entitlement resource') else null, StackName: if errorOnEmptyProp then (error 'You need to define StackName properties for AWS::AppStream::Entitlement resource') else null, AppVisibility: if errorOnEmptyProp then (error 'You need to define AppVisibility properties for AWS::AppStream::Entitlement resource') else null, Attributes: if errorOnEmptyProp then (error 'You need to define Attributes properties for AWS::AppStream::Entitlement resource') else null } },
