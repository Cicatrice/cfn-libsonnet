(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::SageMaker::Domain', Properties: { AuthMode: if errorOnEmptyProp then (error 'You need to define AuthMode properties for AWS::SageMaker::Domain resource') else null, DefaultUserSettings: if errorOnEmptyProp then (error 'You need to define DefaultUserSettings properties for AWS::SageMaker::Domain resource') else null, SubnetIds: if errorOnEmptyProp then (error 'You need to define SubnetIds properties for AWS::SageMaker::Domain resource') else null, VpcId: if errorOnEmptyProp then (error 'You need to define VpcId properties for AWS::SageMaker::Domain resource') else null, DomainName: if errorOnEmptyProp then (error 'You need to define DomainName properties for AWS::SageMaker::Domain resource') else null } },
