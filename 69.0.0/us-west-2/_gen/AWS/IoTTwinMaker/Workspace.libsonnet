(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::IoTTwinMaker::Workspace', Properties: { Role: if errorOnEmptyProp then (error 'You need to define Role properties for AWS::IoTTwinMaker::Workspace resource') else null, S3Location: if errorOnEmptyProp then (error 'You need to define S3Location properties for AWS::IoTTwinMaker::Workspace resource') else null, WorkspaceId: if errorOnEmptyProp then (error 'You need to define WorkspaceId properties for AWS::IoTTwinMaker::Workspace resource') else null } },
