(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::MediaPackage::Asset', Properties: { SourceArn: if errorOnEmptyProp then (error 'You need to define SourceArn properties for AWS::MediaPackage::Asset resource') else null, SourceRoleArn: if errorOnEmptyProp then (error 'You need to define SourceRoleArn properties for AWS::MediaPackage::Asset resource') else null, Id: if errorOnEmptyProp then (error 'You need to define Id properties for AWS::MediaPackage::Asset resource') else null, PackagingGroupId: if errorOnEmptyProp then (error 'You need to define PackagingGroupId properties for AWS::MediaPackage::Asset resource') else null } },
