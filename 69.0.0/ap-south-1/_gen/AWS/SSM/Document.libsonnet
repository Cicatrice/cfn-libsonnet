(import '../../../extensions/attributes.libsonnet') + {
  ...
  '#withUpdateMethod':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ssm-document.html#cfn-ssm-document-updatemethod', args=[d.arg(name='updateMethod', type=d.T.string)]),
  withUpdateMethod(updateMethod): { Properties+: { UpdateMethod: updateMethod } },
