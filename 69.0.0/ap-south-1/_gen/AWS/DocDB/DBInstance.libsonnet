(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::DocDB::DBInstance', Properties: { DBClusterIdentifier: if errorOnEmptyProp then (error 'You need to define DBClusterIdentifier properties for AWS::DocDB::DBInstance resource') else null, DBInstanceClass: if errorOnEmptyProp then (error 'You need to define DBInstanceClass properties for AWS::DocDB::DBInstance resource') else null } },
