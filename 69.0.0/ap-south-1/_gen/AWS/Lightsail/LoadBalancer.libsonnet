(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Lightsail::LoadBalancer', Properties: { LoadBalancerName: if errorOnEmptyProp then (error 'You need to define LoadBalancerName properties for AWS::Lightsail::LoadBalancer resource') else null, InstancePort: if errorOnEmptyProp then (error 'You need to define InstancePort properties for AWS::Lightsail::LoadBalancer resource') else null } },
