(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::DataSync::LocationFSxLustre', Properties: { SecurityGroupArns: if errorOnEmptyProp then (error 'You need to define SecurityGroupArns properties for AWS::DataSync::LocationFSxLustre resource') else null, FsxFilesystemArn: if errorOnEmptyProp then (error 'You need to define FsxFilesystemArn properties for AWS::DataSync::LocationFSxLustre resource') else null } },
