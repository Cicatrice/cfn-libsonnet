(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Greengrass::ConnectorDefinitionVersion', Properties: { ConnectorDefinitionId: if errorOnEmptyProp then (error 'You need to define ConnectorDefinitionId properties for AWS::Greengrass::ConnectorDefinitionVersion resource') else null, Connectors: if errorOnEmptyProp then (error 'You need to define Connectors properties for AWS::Greengrass::ConnectorDefinitionVersion resource') else null } },
