(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::EC2::ClientVpnEndpoint', Properties: { AuthenticationOptions: if errorOnEmptyProp then (error 'You need to define AuthenticationOptions properties for AWS::EC2::ClientVpnEndpoint resource') else null, ServerCertificateArn: if errorOnEmptyProp then (error 'You need to define ServerCertificateArn properties for AWS::EC2::ClientVpnEndpoint resource') else null, ClientCidrBlock: if errorOnEmptyProp then (error 'You need to define ClientCidrBlock properties for AWS::EC2::ClientVpnEndpoint resource') else null, ConnectionLogOptions: if errorOnEmptyProp then (error 'You need to define ConnectionLogOptions properties for AWS::EC2::ClientVpnEndpoint resource') else null } },
