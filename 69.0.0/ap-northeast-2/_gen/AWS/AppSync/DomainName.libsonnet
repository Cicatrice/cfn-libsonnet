(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::AppSync::DomainName', Properties: { DomainName: if errorOnEmptyProp then (error 'You need to define DomainName properties for AWS::AppSync::DomainName resource') else null, CertificateArn: if errorOnEmptyProp then (error 'You need to define CertificateArn properties for AWS::AppSync::DomainName resource') else null } },
