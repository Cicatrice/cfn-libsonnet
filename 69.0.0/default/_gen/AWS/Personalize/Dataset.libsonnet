(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Personalize::Dataset', Properties: { DatasetGroupArn: if errorOnEmptyProp then (error 'You need to define DatasetGroupArn properties for AWS::Personalize::Dataset resource') else null, DatasetType: if errorOnEmptyProp then (error 'You need to define DatasetType properties for AWS::Personalize::Dataset resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::Personalize::Dataset resource') else null, SchemaArn: if errorOnEmptyProp then (error 'You need to define SchemaArn properties for AWS::Personalize::Dataset resource') else null } },
