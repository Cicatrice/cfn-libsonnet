(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::GameLift::MatchmakingConfiguration', Properties: { Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::GameLift::MatchmakingConfiguration resource') else null, RequestTimeoutSeconds: if errorOnEmptyProp then (error 'You need to define RequestTimeoutSeconds properties for AWS::GameLift::MatchmakingConfiguration resource') else null, RuleSetName: if errorOnEmptyProp then (error 'You need to define RuleSetName properties for AWS::GameLift::MatchmakingConfiguration resource') else null, AcceptanceRequired: if errorOnEmptyProp then (error 'You need to define AcceptanceRequired properties for AWS::GameLift::MatchmakingConfiguration resource') else null } },
