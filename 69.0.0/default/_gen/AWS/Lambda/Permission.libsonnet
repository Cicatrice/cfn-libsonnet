(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Lambda::Permission', Properties: { Principal: if errorOnEmptyProp then (error 'You need to define Principal properties for AWS::Lambda::Permission resource') else null, Action: if errorOnEmptyProp then (error 'You need to define Action properties for AWS::Lambda::Permission resource') else null, FunctionName: if errorOnEmptyProp then (error 'You need to define FunctionName properties for AWS::Lambda::Permission resource') else null } },
