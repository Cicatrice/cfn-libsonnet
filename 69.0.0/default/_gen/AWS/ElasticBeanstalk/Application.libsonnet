(import '../../../extensions/attributes.libsonnet') + {
  ...
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-beanstalk.html', args=[d.arg(name='errorOnEmptyProp', type=d.T.bool)]),
  ...
  '#withResourceLifecycleConfig':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-beanstalk.html#cfn-elasticbeanstalk-application-resourcelifecycleconfig', args=[d.arg(name='resourceLifecycleConfig', type=d.T.object)]),
  withResourceLifecycleConfig(resourceLifecycleConfig): { Properties+: { ResourceLifecycleConfig: resourceLifecycleConfig } },
  '#withResourceLifecycleConfigMixin':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-beanstalk.html#cfn-elasticbeanstalk-application-resourcelifecycleconfig', args=[d.arg(name='resourceLifecycleConfig', type=d.T.object)]),
