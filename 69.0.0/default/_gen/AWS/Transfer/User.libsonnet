(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Transfer::User', Properties: { ServerId: if errorOnEmptyProp then (error 'You need to define ServerId properties for AWS::Transfer::User resource') else null, Role: if errorOnEmptyProp then (error 'You need to define Role properties for AWS::Transfer::User resource') else null, UserName: if errorOnEmptyProp then (error 'You need to define UserName properties for AWS::Transfer::User resource') else null } },
