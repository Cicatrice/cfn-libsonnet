(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::S3ObjectLambda::AccessPoint', Properties: { ObjectLambdaConfiguration: if errorOnEmptyProp then (error 'You need to define ObjectLambdaConfiguration properties for AWS::S3ObjectLambda::AccessPoint resource') else null } },
