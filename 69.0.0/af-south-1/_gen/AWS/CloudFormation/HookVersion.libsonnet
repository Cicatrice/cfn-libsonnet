(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::CloudFormation::HookVersion', Properties: { TypeName: if errorOnEmptyProp then (error 'You need to define TypeName properties for AWS::CloudFormation::HookVersion resource') else null, SchemaHandlerPackage: if errorOnEmptyProp then (error 'You need to define SchemaHandlerPackage properties for AWS::CloudFormation::HookVersion resource') else null } },
