(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::IoT::Certificate', Properties: { Status: if errorOnEmptyProp then (error 'You need to define Status properties for AWS::IoT::Certificate resource') else null, CertificateSigningRequest: if errorOnEmptyProp then (error 'You need to define CertificateSigningRequest properties for AWS::IoT::Certificate resource') else null } },
