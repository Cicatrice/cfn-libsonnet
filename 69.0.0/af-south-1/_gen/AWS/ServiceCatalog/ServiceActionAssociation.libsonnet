(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ServiceCatalog::ServiceActionAssociation', Properties: { ProductId: if errorOnEmptyProp then (error 'You need to define ProductId properties for AWS::ServiceCatalog::ServiceActionAssociation resource') else null, ProvisioningArtifactId: if errorOnEmptyProp then (error 'You need to define ProvisioningArtifactId properties for AWS::ServiceCatalog::ServiceActionAssociation resource') else null, ServiceActionId: if errorOnEmptyProp then (error 'You need to define ServiceActionId properties for AWS::ServiceCatalog::ServiceActionAssociation resource') else null } },
