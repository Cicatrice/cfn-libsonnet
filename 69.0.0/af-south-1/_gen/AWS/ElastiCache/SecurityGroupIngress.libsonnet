(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ElastiCache::SecurityGroupIngress', Properties: { EC2SecurityGroupName: if errorOnEmptyProp then (error 'You need to define EC2SecurityGroupName properties for AWS::ElastiCache::SecurityGroupIngress resource') else null, CacheSecurityGroupName: if errorOnEmptyProp then (error 'You need to define CacheSecurityGroupName properties for AWS::ElastiCache::SecurityGroupIngress resource') else null } },
