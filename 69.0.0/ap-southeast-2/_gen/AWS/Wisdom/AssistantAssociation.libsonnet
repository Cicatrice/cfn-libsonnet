(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Wisdom::AssistantAssociation', Properties: { Association: if errorOnEmptyProp then (error 'You need to define Association properties for AWS::Wisdom::AssistantAssociation resource') else null, AssociationType: if errorOnEmptyProp then (error 'You need to define AssociationType properties for AWS::Wisdom::AssistantAssociation resource') else null, AssistantId: if errorOnEmptyProp then (error 'You need to define AssistantId properties for AWS::Wisdom::AssistantAssociation resource') else null } },
