(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Glue::SecurityConfiguration', Properties: { EncryptionConfiguration: if errorOnEmptyProp then (error 'You need to define EncryptionConfiguration properties for AWS::Glue::SecurityConfiguration resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::Glue::SecurityConfiguration resource') else null } },
