(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Evidently::Feature', Properties: { Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::Evidently::Feature resource') else null, Project: if errorOnEmptyProp then (error 'You need to define Project properties for AWS::Evidently::Feature resource') else null, Variations: if errorOnEmptyProp then (error 'You need to define Variations properties for AWS::Evidently::Feature resource') else null } },
