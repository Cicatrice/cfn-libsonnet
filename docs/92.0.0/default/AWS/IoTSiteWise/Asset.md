---
permalink: /92.0.0/default/AWS/IoTSiteWise/Asset/
---
...
* [`fn withAssetDescription(assetDescription)`](#fn-withassetdescription)
...
### fn withAssetDescription

```ts
withAssetDescription(assetDescription)
```

https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iotsitewise-asset.html#cfn-iotsitewise-asset-assetdescription
