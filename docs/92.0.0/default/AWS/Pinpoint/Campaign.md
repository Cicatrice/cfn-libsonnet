---
permalink: /92.0.0/default/AWS/Pinpoint/Campaign/
---
...
* [`fn withCustomDeliveryConfiguration(customDeliveryConfiguration)`](#fn-withcustomdeliveryconfiguration)
* [`fn withCustomDeliveryConfigurationMixin(customDeliveryConfiguration)`](#fn-withcustomdeliveryconfigurationmixin)
...
* [`fn withTemplateConfiguration(templateConfiguration)`](#fn-withtemplateconfiguration)
* [`fn withTemplateConfigurationMixin(templateConfiguration)`](#fn-withtemplateconfigurationmixin)
...
### fn withCustomDeliveryConfiguration

```ts
withCustomDeliveryConfiguration(customDeliveryConfiguration)
```

https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pinpoint-campaign.html#cfn-pinpoint-campaign-customdeliveryconfiguration

### fn withCustomDeliveryConfigurationMixin

```ts
withCustomDeliveryConfigurationMixin(customDeliveryConfiguration)
```
...
https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pinpoint-campaign.html#cfn-pinpoint-campaign-description
...
### fn withTemplateConfiguration

```ts
withTemplateConfiguration(templateConfiguration)
```

https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pinpoint-campaign.html#cfn-pinpoint-campaign-templateconfiguration

### fn withTemplateConfigurationMixin
