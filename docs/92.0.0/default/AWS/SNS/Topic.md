---
permalink: /92.0.0/default/AWS/SNS/Topic/
---
...
* [`fn withDataProtectionPolicy(dataProtectionPolicy)`](#fn-withdataprotectionpolicy)
* [`fn withDataProtectionPolicyMixin(dataProtectionPolicy)`](#fn-withdataprotectionpolicymixin)
...
https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sns-topic.html#cfn-sns-topic-contentbaseddeduplication

### fn withDataProtectionPolicy

```ts
withDataProtectionPolicy(dataProtectionPolicy)
```

https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sns-topic.html#cfn-sns-topic-dataprotectionpolicy

### fn withDataProtectionPolicyMixin

```ts
withDataProtectionPolicyMixin(dataProtectionPolicy)
```
...
https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sns-topic.html#cfn-sns-topic-fifotopic
...
https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sns-topic.html#cfn-sns-topic-kmsmasterkeyid
...
https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sns-topic.html#cfn-sns-topic-subscription
