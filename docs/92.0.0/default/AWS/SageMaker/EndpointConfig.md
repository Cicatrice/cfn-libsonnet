---
permalink: /92.0.0/default/AWS/SageMaker/EndpointConfig/
---
...
* [`fn withExplainerConfig(explainerConfig)`](#fn-withexplainerconfig)
* [`fn withExplainerConfigMixin(explainerConfig)`](#fn-withexplainerconfigmixin)
...
### fn withExplainerConfig

```ts
withExplainerConfig(explainerConfig)
```

https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sagemaker-endpointconfig.html#cfn-sagemaker-endpointconfig-explainerconfig

### fn withExplainerConfigMixin

```ts
withExplainerConfigMixin(explainerConfig)
```
