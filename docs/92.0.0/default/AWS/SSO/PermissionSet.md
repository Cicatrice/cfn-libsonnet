---
permalink: /92.0.0/default/AWS/SSO/PermissionSet/
---
...
* [`fn withCustomerManagedPolicyReferences(customerManagedPolicyReferences)`](#fn-withcustomermanagedpolicyreferences)
* [`fn withCustomerManagedPolicyReferencesMixin(customerManagedPolicyReferences)`](#fn-withcustomermanagedpolicyreferencesmixin)
...
* [`fn withPermissionsBoundaryMixin(permissionsBoundary)`](#fn-withpermissionsboundarymixin)
...
### fn withCustomerManagedPolicyReferences

```ts
withCustomerManagedPolicyReferences(customerManagedPolicyReferences)
```

https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sso-permissionset.html#cfn-sso-permissionset-customermanagedpolicyreferences

### fn withCustomerManagedPolicyReferencesMixin
...
https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sso-permissionset.html#cfn-sso-permissionset-permissionsboundary
