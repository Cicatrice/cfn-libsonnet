---
permalink: /92.0.0/default/AWS/Config/ConformancePack/
---
...
* [`fn withTemplateSSMDocumentDetails(templateSsmdocumentDetails)`](#fn-withtemplatessmdocumentdetails)
* [`fn withTemplateSSMDocumentDetailsMixin(templateSsmdocumentDetails)`](#fn-withtemplatessmdocumentdetailsmixin)
...
### fn withTemplateSSMDocumentDetails

```ts
withTemplateSSMDocumentDetails(templateSsmdocumentDetails)
```

https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-config-conformancepack.html#cfn-config-conformancepack-templatessmdocumentdetails

### fn withTemplateSSMDocumentDetailsMixin

```ts
withTemplateSSMDocumentDetailsMixin(templateSsmdocumentDetails)
```
