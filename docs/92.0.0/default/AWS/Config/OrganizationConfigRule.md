---
permalink: /92.0.0/default/AWS/Config/OrganizationConfigRule/
---
...
* [`fn withOrganizationCustomCodeRuleMetadata(organizationCustomCodeRuleMetadata)`](#fn-withorganizationcustomcoderulemetadata)
* [`fn withOrganizationCustomCodeRuleMetadataMixin(organizationCustomCodeRuleMetadata)`](#fn-withorganizationcustomcoderulemetadatamixin)
...
### fn withOrganizationCustomCodeRuleMetadata

```ts
withOrganizationCustomCodeRuleMetadata(organizationCustomCodeRuleMetadata)
```

https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-config-organizationconfigrule.html#cfn-config-organizationconfigrule-organizationcustomcoderulemetadata

### fn withOrganizationCustomCodeRuleMetadataMixin

```ts
withOrganizationCustomCodeRuleMetadataMixin(organizationCustomCodeRuleMetadata)
```
