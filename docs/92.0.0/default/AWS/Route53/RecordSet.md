---
permalink: /92.0.0/default/AWS/Route53/RecordSet/
---
...
* [`fn withCidrRoutingConfig(cidrRoutingConfig)`](#fn-withcidrroutingconfig)
* [`fn withCidrRoutingConfigMixin(cidrRoutingConfig)`](#fn-withcidrroutingconfigmixin)
...
### fn withCidrRoutingConfig

```ts
withCidrRoutingConfig(cidrRoutingConfig)
```

https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-route53-recordset.html#cfn-route53-recordset-cidrroutingconfig

### fn withCidrRoutingConfigMixin

```ts
withCidrRoutingConfigMixin(cidrRoutingConfig)
```
