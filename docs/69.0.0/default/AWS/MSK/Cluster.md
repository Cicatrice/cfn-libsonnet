---
permalink: /69.0.0/default/AWS/MSK/Cluster/
---
...
* [`fn withCurrentVersion(currentVersion)`](#fn-withcurrentversion)
...
### fn withCurrentVersion

```ts
withCurrentVersion(currentVersion)
```

https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-msk-cluster.html#cfn-msk-cluster-currentversion
