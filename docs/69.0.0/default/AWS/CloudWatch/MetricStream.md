---
permalink: /69.0.0/default/AWS/CloudWatch/MetricStream/
---
...
* [`fn withStatisticsConfigurations(statisticsConfigurations)`](#fn-withstatisticsconfigurations)
* [`fn withStatisticsConfigurationsMixin(statisticsConfigurations)`](#fn-withstatisticsconfigurationsmixin)
...
### fn withStatisticsConfigurations

```ts
withStatisticsConfigurations(statisticsConfigurations)
```

https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cloudwatch-metricstream.html#cfn-cloudwatch-metricstream-statisticsconfigurations

### fn withStatisticsConfigurationsMixin
