---
permalink: /69.0.0/default/AWS/DMS/Endpoint/
---
...
* [`fn withGcpMySQLSettings(gcpMySqlsettings)`](#fn-withgcpmysqlsettings)
* [`fn withGcpMySQLSettingsMixin(gcpMySqlsettings)`](#fn-withgcpmysqlsettingsmixin)
...
### fn withGcpMySQLSettings

```ts
withGcpMySQLSettings(gcpMySqlsettings)
```

https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-dms-endpoint.html#cfn-dms-endpoint-gcpmysqlsettings

### fn withGcpMySQLSettingsMixin

```ts
withGcpMySQLSettingsMixin(gcpMySqlsettings)
```
