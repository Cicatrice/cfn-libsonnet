---
permalink: /69.0.0/default/AWS/CustomerProfiles/Integration/
---
...
* [`fn withObjectTypeNames(objectTypeNames)`](#fn-withobjecttypenames)
* [`fn withObjectTypeNamesMixin(objectTypeNames)`](#fn-withobjecttypenamesmixin)
...
### fn withObjectTypeNames

```ts
withObjectTypeNames(objectTypeNames)
```

https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-customerprofiles-integration.html#cfn-customerprofiles-integration-objecttypenames

### fn withObjectTypeNamesMixin
