---
permalink: /69.0.0/default/AWS/IoT/JobTemplate/
---
...
* [`fn withJobExecutionsRetryConfig(jobExecutionsRetryConfig)`](#fn-withjobexecutionsretryconfig)
* [`fn withJobExecutionsRetryConfigMixin(jobExecutionsRetryConfig)`](#fn-withjobexecutionsretryconfigmixin)
...
### fn withJobExecutionsRetryConfig

```ts
withJobExecutionsRetryConfig(jobExecutionsRetryConfig)
```

https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iot-jobtemplate.html#cfn-iot-jobtemplate-jobexecutionsretryconfig

### fn withJobExecutionsRetryConfigMixin

```ts
withJobExecutionsRetryConfigMixin(jobExecutionsRetryConfig)
```
