---
permalink: /44.00/AWS/AWS.AppMesh/AWS.AppMesh.VirtualNode/
---

# AWS.AWS.AppMesh.AWS.AppMesh.VirtualNode
...
https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appmesh-virtualnode.html#cfn-appmesh-virtualnode-meshname
...
https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appmesh-virtualnode.html#cfn-appmesh-virtualnode-meshowner
...
### fn withVirtualNodeName

```ts
withVirtualNodeName(virtualNodeName)
```

https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appmesh-virtualnode.html#cfn-appmesh-virtualnode-virtualnodename