---
permalink: /48.0.0/ap-northeast-2/AWS/CloudFront/KeyGroup/
---
...
* [`fn withKeyGroupConfigMixin(keyGroupConfig)`](#fn-withkeygroupconfigmixin)
...
### fn withKeyGroupConfigMixin

```ts
withKeyGroupConfigMixin(keyGroupConfig)
```
