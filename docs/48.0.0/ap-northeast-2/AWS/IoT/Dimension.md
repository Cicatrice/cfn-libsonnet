---
permalink: /48.0.0/ap-northeast-2/AWS/IoT/Dimension/
---
...
* [`fn withStringValuesMixin(stringValues)`](#fn-withstringvaluesmixin)
...
### fn withStringValuesMixin

```ts
withStringValuesMixin(stringValues)
```
