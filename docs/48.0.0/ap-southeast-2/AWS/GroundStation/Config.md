---
permalink: /48.0.0/ap-southeast-2/AWS/GroundStation/Config/
---
...
* [`fn withConfigDataMixin(configData)`](#fn-withconfigdatamixin)
...
### fn withConfigDataMixin

```ts
withConfigDataMixin(configData)
```
