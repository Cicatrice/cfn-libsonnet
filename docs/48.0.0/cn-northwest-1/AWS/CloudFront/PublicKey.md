---
permalink: /48.0.0/cn-northwest-1/AWS/CloudFront/PublicKey/
---
...
* [`fn withPublicKeyConfigMixin(publicKeyConfig)`](#fn-withpublickeyconfigmixin)
...
### fn withPublicKeyConfigMixin

```ts
withPublicKeyConfigMixin(publicKeyConfig)
```
