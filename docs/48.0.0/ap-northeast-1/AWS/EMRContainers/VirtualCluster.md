---
permalink: /48.0.0/ap-northeast-1/AWS/EMRContainers/VirtualCluster/
---
...
* [`fn withContainerProviderMixin(containerProvider)`](#fn-withcontainerprovidermixin)
...
```ts
withContainerProviderMixin(containerProvider)
```
