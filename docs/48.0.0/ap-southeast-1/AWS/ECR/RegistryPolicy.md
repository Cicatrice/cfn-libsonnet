---
permalink: /48.0.0/ap-southeast-1/AWS/ECR/RegistryPolicy/
---
...
* [`fn withPolicyTextMixin(policyText)`](#fn-withpolicytextmixin)
...
### fn withPolicyTextMixin

```ts
withPolicyTextMixin(policyText)
```
