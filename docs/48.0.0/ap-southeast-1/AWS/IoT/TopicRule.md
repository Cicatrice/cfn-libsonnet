---
permalink: /48.0.0/ap-southeast-1/AWS/IoT/TopicRule/
---
...
* [`fn withTopicRulePayloadMixin(topicRulePayload)`](#fn-withtopicrulepayloadmixin)
...
### fn withTopicRulePayloadMixin

```ts
withTopicRulePayloadMixin(topicRulePayload)
```
