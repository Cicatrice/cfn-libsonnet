---
permalink: /48.0.0/ap-southeast-1/AWS/IoTEvents/Input/
---
...
* [`fn withInputDefinitionMixin(inputDefinition)`](#fn-withinputdefinitionmixin)
...
### fn withInputDefinitionMixin

```ts
withInputDefinitionMixin(inputDefinition)
```
