---
permalink: /51.0.0/default/AWS/WAFv2/WebACL/
---
...
* [`fn withCaptchaConfig(captchaConfig)`](#fn-withcaptchaconfig)
* [`fn withCaptchaConfigMixin(captchaConfig)`](#fn-withcaptchaconfigmixin)
...
### fn withCaptchaConfig

```ts
withCaptchaConfig(captchaConfig)
```

https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-wafv2-webacl.html#cfn-wafv2-webacl-captchaconfig

### fn withCaptchaConfigMixin

```ts
withCaptchaConfigMixin(captchaConfig)
```
