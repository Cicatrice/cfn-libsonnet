(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::LookoutMetrics::Alert', Properties: { Action: if errorOnEmptyProp then (error 'You need to define Action properties for AWS::LookoutMetrics::Alert resource') else null, AlertSensitivityThreshold: if errorOnEmptyProp then (error 'You need to define AlertSensitivityThreshold properties for AWS::LookoutMetrics::Alert resource') else null, AnomalyDetectorArn: if errorOnEmptyProp then (error 'You need to define AnomalyDetectorArn properties for AWS::LookoutMetrics::Alert resource') else null } },
