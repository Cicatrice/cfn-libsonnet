(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::DataBrew::Job', Properties: { RoleArn: if errorOnEmptyProp then (error 'You need to define RoleArn properties for AWS::DataBrew::Job resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::DataBrew::Job resource') else null, Type: if errorOnEmptyProp then (error 'You need to define Type properties for AWS::DataBrew::Job resource') else null } },
  ...
  '#withValidationConfigurations':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-databrew-job.html#cfn-databrew-job-validationconfigurations', args=[d.arg(name='validationConfigurations', type=d.T.array)]),
  withValidationConfigurations(validationConfigurations): { Properties+: { ValidationConfigurations: validationConfigurations } },
  '#withValidationConfigurationsMixin':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-databrew-job.html#cfn-databrew-job-validationconfigurations', args=[d.arg(name='validationConfigurations', type=d.T.array)]),
  withValidationConfigurationsMixin(validationConfigurations): { Properties+: { ValidationConfigurations+: validationConfigurations } },
}
