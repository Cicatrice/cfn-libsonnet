(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::AutoScalingPlans::ScalingPlan', Properties: { ScalingInstructions: if errorOnEmptyProp then (error 'You need to define ScalingInstructions properties for AWS::AutoScalingPlans::ScalingPlan resource') else null, ApplicationSource: if errorOnEmptyProp then (error 'You need to define ApplicationSource properties for AWS::AutoScalingPlans::ScalingPlan resource') else null } },
