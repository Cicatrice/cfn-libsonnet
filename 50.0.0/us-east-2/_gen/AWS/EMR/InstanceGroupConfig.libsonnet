(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::EMR::InstanceGroupConfig', Properties: { InstanceRole: if errorOnEmptyProp then (error 'You need to define InstanceRole properties for AWS::EMR::InstanceGroupConfig resource') else null, JobFlowId: if errorOnEmptyProp then (error 'You need to define JobFlowId properties for AWS::EMR::InstanceGroupConfig resource') else null, InstanceCount: if errorOnEmptyProp then (error 'You need to define InstanceCount properties for AWS::EMR::InstanceGroupConfig resource') else null, InstanceType: if errorOnEmptyProp then (error 'You need to define InstanceType properties for AWS::EMR::InstanceGroupConfig resource') else null } },
  ...
  '#withCustomAmiId':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-emr-instancegroupconfig.html#cfn-emr-instancegroupconfig-customamiid', args=[d.arg(name='customAmiId', type=d.T.string)]),
