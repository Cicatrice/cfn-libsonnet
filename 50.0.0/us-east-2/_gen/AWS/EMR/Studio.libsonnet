(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::EMR::Studio', Properties: { Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::EMR::Studio resource') else null, ServiceRole: if errorOnEmptyProp then (error 'You need to define ServiceRole properties for AWS::EMR::Studio resource') else null, AuthMode: if errorOnEmptyProp then (error 'You need to define AuthMode properties for AWS::EMR::Studio resource') else null, WorkspaceSecurityGroupId: if errorOnEmptyProp then (error 'You need to define WorkspaceSecurityGroupId properties for AWS::EMR::Studio resource') else null, VpcId: if errorOnEmptyProp then (error 'You need to define VpcId properties for AWS::EMR::Studio resource') else null, EngineSecurityGroupId: if errorOnEmptyProp then (error 'You need to define EngineSecurityGroupId properties for AWS::EMR::Studio resource') else null, SubnetIds: if errorOnEmptyProp then (error 'You need to define SubnetIds properties for AWS::EMR::Studio resource') else null, DefaultS3Location: if errorOnEmptyProp then (error 'You need to define DefaultS3Location properties for AWS::EMR::Studio resource') else null } },
