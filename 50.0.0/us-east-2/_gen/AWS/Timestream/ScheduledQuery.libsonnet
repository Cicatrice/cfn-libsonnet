(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Timestream::ScheduledQuery', Properties: { ScheduledQueryExecutionRoleArn: if errorOnEmptyProp then (error 'You need to define ScheduledQueryExecutionRoleArn properties for AWS::Timestream::ScheduledQuery resource') else null, ErrorReportConfiguration: if errorOnEmptyProp then (error 'You need to define ErrorReportConfiguration properties for AWS::Timestream::ScheduledQuery resource') else null, QueryString: if errorOnEmptyProp then (error 'You need to define QueryString properties for AWS::Timestream::ScheduledQuery resource') else null, ScheduleConfiguration: if errorOnEmptyProp then (error 'You need to define ScheduleConfiguration properties for AWS::Timestream::ScheduledQuery resource') else null, NotificationConfiguration: if errorOnEmptyProp then (error 'You need to define NotificationConfiguration properties for AWS::Timestream::ScheduledQuery resource') else null } },
