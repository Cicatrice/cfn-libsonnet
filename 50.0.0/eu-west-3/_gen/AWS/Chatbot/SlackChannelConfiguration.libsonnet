(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Chatbot::SlackChannelConfiguration', Properties: { SlackWorkspaceId: if errorOnEmptyProp then (error 'You need to define SlackWorkspaceId properties for AWS::Chatbot::SlackChannelConfiguration resource') else null, ConfigurationName: if errorOnEmptyProp then (error 'You need to define ConfigurationName properties for AWS::Chatbot::SlackChannelConfiguration resource') else null, IamRoleArn: if errorOnEmptyProp then (error 'You need to define IamRoleArn properties for AWS::Chatbot::SlackChannelConfiguration resource') else null, SlackChannelId: if errorOnEmptyProp then (error 'You need to define SlackChannelId properties for AWS::Chatbot::SlackChannelConfiguration resource') else null } },
