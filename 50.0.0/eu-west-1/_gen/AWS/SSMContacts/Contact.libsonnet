(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::SSMContacts::Contact', Properties: { Plan: if errorOnEmptyProp then (error 'You need to define Plan properties for AWS::SSMContacts::Contact resource') else null, Type: if errorOnEmptyProp then (error 'You need to define Type properties for AWS::SSMContacts::Contact resource') else null, Alias: if errorOnEmptyProp then (error 'You need to define Alias properties for AWS::SSMContacts::Contact resource') else null, DisplayName: if errorOnEmptyProp then (error 'You need to define DisplayName properties for AWS::SSMContacts::Contact resource') else null } },
