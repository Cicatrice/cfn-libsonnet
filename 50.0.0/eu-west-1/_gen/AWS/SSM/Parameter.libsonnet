(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::SSM::Parameter', Properties: { Value: if errorOnEmptyProp then (error 'You need to define Value properties for AWS::SSM::Parameter resource') else null, Type: if errorOnEmptyProp then (error 'You need to define Type properties for AWS::SSM::Parameter resource') else null } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ssm-parameter.html', args=[d.arg(name='errorOnEmptyProp', type=d.T.bool)]),
