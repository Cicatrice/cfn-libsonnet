(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ImageBuilder::ImageRecipe', Properties: { Components: if errorOnEmptyProp then (error 'You need to define Components properties for AWS::ImageBuilder::ImageRecipe resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::ImageBuilder::ImageRecipe resource') else null, Version: if errorOnEmptyProp then (error 'You need to define Version properties for AWS::ImageBuilder::ImageRecipe resource') else null, ParentImage: if errorOnEmptyProp then (error 'You need to define ParentImage properties for AWS::ImageBuilder::ImageRecipe resource') else null } },
