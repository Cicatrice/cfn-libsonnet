(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::RDS::DBProxy', Properties: { VpcSubnetIds: if errorOnEmptyProp then (error 'You need to define VpcSubnetIds properties for AWS::RDS::DBProxy resource') else null, RoleArn: if errorOnEmptyProp then (error 'You need to define RoleArn properties for AWS::RDS::DBProxy resource') else null, Auth: if errorOnEmptyProp then (error 'You need to define Auth properties for AWS::RDS::DBProxy resource') else null, DBProxyName: if errorOnEmptyProp then (error 'You need to define DBProxyName properties for AWS::RDS::DBProxy resource') else null, EngineFamily: if errorOnEmptyProp then (error 'You need to define EngineFamily properties for AWS::RDS::DBProxy resource') else null } },
