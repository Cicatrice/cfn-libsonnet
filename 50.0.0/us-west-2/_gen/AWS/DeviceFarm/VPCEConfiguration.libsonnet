(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::DeviceFarm::VPCEConfiguration', Properties: { ServiceDnsName: if errorOnEmptyProp then (error 'You need to define ServiceDnsName properties for AWS::DeviceFarm::VPCEConfiguration resource') else null, VpceConfigurationName: if errorOnEmptyProp then (error 'You need to define VpceConfigurationName properties for AWS::DeviceFarm::VPCEConfiguration resource') else null, VpceServiceName: if errorOnEmptyProp then (error 'You need to define VpceServiceName properties for AWS::DeviceFarm::VPCEConfiguration resource') else null } },
