(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::AppFlow::Flow', Properties: { Tasks: if errorOnEmptyProp then (error 'You need to define Tasks properties for AWS::AppFlow::Flow resource') else null, TriggerConfig: if errorOnEmptyProp then (error 'You need to define TriggerConfig properties for AWS::AppFlow::Flow resource') else null, DestinationFlowConfigList: if errorOnEmptyProp then (error 'You need to define DestinationFlowConfigList properties for AWS::AppFlow::Flow resource') else null, FlowName: if errorOnEmptyProp then (error 'You need to define FlowName properties for AWS::AppFlow::Flow resource') else null, SourceFlowConfig: if errorOnEmptyProp then (error 'You need to define SourceFlowConfig properties for AWS::AppFlow::Flow resource') else null } },
