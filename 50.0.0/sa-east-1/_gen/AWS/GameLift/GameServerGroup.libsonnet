(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::GameLift::GameServerGroup', Properties: { InstanceDefinitions: if errorOnEmptyProp then (error 'You need to define InstanceDefinitions properties for AWS::GameLift::GameServerGroup resource') else null, LaunchTemplate: if errorOnEmptyProp then (error 'You need to define LaunchTemplate properties for AWS::GameLift::GameServerGroup resource') else null, GameServerGroupName: if errorOnEmptyProp then (error 'You need to define GameServerGroupName properties for AWS::GameLift::GameServerGroup resource') else null, RoleArn: if errorOnEmptyProp then (error 'You need to define RoleArn properties for AWS::GameLift::GameServerGroup resource') else null } },
