(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::SNS::TopicPolicy', Properties: { Topics: if errorOnEmptyProp then (error 'You need to define Topics properties for AWS::SNS::TopicPolicy resource') else null, PolicyDocument: if errorOnEmptyProp then (error 'You need to define PolicyDocument properties for AWS::SNS::TopicPolicy resource') else null } },
