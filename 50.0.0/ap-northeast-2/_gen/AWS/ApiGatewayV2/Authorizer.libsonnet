(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::ApiGatewayV2::Authorizer', Properties: { ApiId: if errorOnEmptyProp then (error 'You need to define ApiId properties for AWS::ApiGatewayV2::Authorizer resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::ApiGatewayV2::Authorizer resource') else null, AuthorizerType: if errorOnEmptyProp then (error 'You need to define AuthorizerType properties for AWS::ApiGatewayV2::Authorizer resource') else null } },
