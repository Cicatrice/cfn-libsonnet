(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::EMR::Step', Properties: { HadoopJarStep: if errorOnEmptyProp then (error 'You need to define HadoopJarStep properties for AWS::EMR::Step resource') else null, JobFlowId: if errorOnEmptyProp then (error 'You need to define JobFlowId properties for AWS::EMR::Step resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::EMR::Step resource') else null, ActionOnFailure: if errorOnEmptyProp then (error 'You need to define ActionOnFailure properties for AWS::EMR::Step resource') else null } },
