(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Greengrass::FunctionDefinitionVersion', Properties: { FunctionDefinitionId: if errorOnEmptyProp then (error 'You need to define FunctionDefinitionId properties for AWS::Greengrass::FunctionDefinitionVersion resource') else null, Functions: if errorOnEmptyProp then (error 'You need to define Functions properties for AWS::Greengrass::FunctionDefinitionVersion resource') else null } },
