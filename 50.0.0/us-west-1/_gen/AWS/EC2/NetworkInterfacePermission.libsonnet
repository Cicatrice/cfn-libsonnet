(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::EC2::NetworkInterfacePermission', Properties: { NetworkInterfaceId: if errorOnEmptyProp then (error 'You need to define NetworkInterfaceId properties for AWS::EC2::NetworkInterfacePermission resource') else null, Permission: if errorOnEmptyProp then (error 'You need to define Permission properties for AWS::EC2::NetworkInterfacePermission resource') else null, AwsAccountId: if errorOnEmptyProp then (error 'You need to define AwsAccountId properties for AWS::EC2::NetworkInterfacePermission resource') else null } },
