(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::CodeBuild::SourceCredential', Properties: { Token: if errorOnEmptyProp then (error 'You need to define Token properties for AWS::CodeBuild::SourceCredential resource') else null, AuthType: if errorOnEmptyProp then (error 'You need to define AuthType properties for AWS::CodeBuild::SourceCredential resource') else null, ServerType: if errorOnEmptyProp then (error 'You need to define ServerType properties for AWS::CodeBuild::SourceCredential resource') else null } },
