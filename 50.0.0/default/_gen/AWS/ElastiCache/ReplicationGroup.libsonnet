(import '../../../extensions/attributes.libsonnet') + {
  ...
  '#withDataTieringEnabled':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-elasticache-replicationgroup.html#cfn-elasticache-replicationgroup-datatieringenabled', args=[d.arg(name='dataTieringEnabled', type=d.T.bool)]),
  withDataTieringEnabled(dataTieringEnabled): { Properties+: { DataTieringEnabled: dataTieringEnabled } },
