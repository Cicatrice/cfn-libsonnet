(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Panorama::ApplicationInstance', Properties: { DefaultRuntimeContextDevice: if errorOnEmptyProp then (error 'You need to define DefaultRuntimeContextDevice properties for AWS::Panorama::ApplicationInstance resource') else null, ManifestPayload: if errorOnEmptyProp then (error 'You need to define ManifestPayload properties for AWS::Panorama::ApplicationInstance resource') else null } },
