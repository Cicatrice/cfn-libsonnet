(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Route53Resolver::ResolverRuleAssociation', Properties: { VPCId: if errorOnEmptyProp then (error 'You need to define VPCId properties for AWS::Route53Resolver::ResolverRuleAssociation resource') else null, ResolverRuleId: if errorOnEmptyProp then (error 'You need to define ResolverRuleId properties for AWS::Route53Resolver::ResolverRuleAssociation resource') else null } },
