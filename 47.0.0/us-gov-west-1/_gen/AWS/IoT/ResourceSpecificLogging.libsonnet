(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::IoT::ResourceSpecificLogging', Properties: { TargetType: if errorOnEmptyProp then (error 'You need to define TargetType properties for AWS::IoT::ResourceSpecificLogging resource') else null, LogLevel: if errorOnEmptyProp then (error 'You need to define LogLevel properties for AWS::IoT::ResourceSpecificLogging resource') else null, TargetName: if errorOnEmptyProp then (error 'You need to define TargetName properties for AWS::IoT::ResourceSpecificLogging resource') else null } },
