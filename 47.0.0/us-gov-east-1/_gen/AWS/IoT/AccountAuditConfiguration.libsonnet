(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::IoT::AccountAuditConfiguration', Properties: { AuditCheckConfigurations: if errorOnEmptyProp then (error 'You need to define AuditCheckConfigurations properties for AWS::IoT::AccountAuditConfiguration resource') else null, RoleArn: if errorOnEmptyProp then (error 'You need to define RoleArn properties for AWS::IoT::AccountAuditConfiguration resource') else null, AccountId: if errorOnEmptyProp then (error 'You need to define AccountId properties for AWS::IoT::AccountAuditConfiguration resource') else null } },
