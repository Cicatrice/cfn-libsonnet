(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::EC2::TransitGatewayMulticastGroupSource', Properties: { GroupIpAddress: if errorOnEmptyProp then (error 'You need to define GroupIpAddress properties for AWS::EC2::TransitGatewayMulticastGroupSource resource') else null, NetworkInterfaceId: if errorOnEmptyProp then (error 'You need to define NetworkInterfaceId properties for AWS::EC2::TransitGatewayMulticastGroupSource resource') else null, TransitGatewayMulticastDomainId: if errorOnEmptyProp then (error 'You need to define TransitGatewayMulticastDomainId properties for AWS::EC2::TransitGatewayMulticastGroupSource resource') else null } },
