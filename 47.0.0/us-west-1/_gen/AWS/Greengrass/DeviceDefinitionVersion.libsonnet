(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Greengrass::DeviceDefinitionVersion', Properties: { DeviceDefinitionId: if errorOnEmptyProp then (error 'You need to define DeviceDefinitionId properties for AWS::Greengrass::DeviceDefinitionVersion resource') else null, Devices: if errorOnEmptyProp then (error 'You need to define Devices properties for AWS::Greengrass::DeviceDefinitionVersion resource') else null } },
