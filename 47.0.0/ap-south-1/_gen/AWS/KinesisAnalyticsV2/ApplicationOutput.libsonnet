(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::KinesisAnalyticsV2::ApplicationOutput', Properties: { ApplicationName: if errorOnEmptyProp then (error 'You need to define ApplicationName properties for AWS::KinesisAnalyticsV2::ApplicationOutput resource') else null, Output: if errorOnEmptyProp then (error 'You need to define Output properties for AWS::KinesisAnalyticsV2::ApplicationOutput resource') else null } },
