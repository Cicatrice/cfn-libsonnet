(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::EC2::EnclaveCertificateIamRoleAssociation', Properties: { RoleArn: if errorOnEmptyProp then (error 'You need to define RoleArn properties for AWS::EC2::EnclaveCertificateIamRoleAssociation resource') else null, CertificateArn: if errorOnEmptyProp then (error 'You need to define CertificateArn properties for AWS::EC2::EnclaveCertificateIamRoleAssociation resource') else null } },
