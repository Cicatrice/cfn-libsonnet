(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::CloudFront::Function', Properties: { FunctionCode: if errorOnEmptyProp then (error 'You need to define FunctionCode properties for AWS::CloudFront::Function resource') else null, FunctionConfig: if errorOnEmptyProp then (error 'You need to define FunctionConfig properties for AWS::CloudFront::Function resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::CloudFront::Function resource') else null } },
