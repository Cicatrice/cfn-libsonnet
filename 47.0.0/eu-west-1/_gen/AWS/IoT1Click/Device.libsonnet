(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::IoT1Click::Device', Properties: { DeviceId: if errorOnEmptyProp then (error 'You need to define DeviceId properties for AWS::IoT1Click::Device resource') else null, Enabled: if errorOnEmptyProp then (error 'You need to define Enabled properties for AWS::IoT1Click::Device resource') else null } },
