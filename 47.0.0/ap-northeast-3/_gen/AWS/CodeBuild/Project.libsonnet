(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::CodeBuild::Project', Properties: { ServiceRole: if errorOnEmptyProp then (error 'You need to define ServiceRole properties for AWS::CodeBuild::Project resource') else null, Source: if errorOnEmptyProp then (error 'You need to define Source properties for AWS::CodeBuild::Project resource') else null, Environment: if errorOnEmptyProp then (error 'You need to define Environment properties for AWS::CodeBuild::Project resource') else null, Artifacts: if errorOnEmptyProp then (error 'You need to define Artifacts properties for AWS::CodeBuild::Project resource') else null } },
