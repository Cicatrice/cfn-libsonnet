(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::CloudWatch::AnomalyDetector', Properties: { MetricName: if errorOnEmptyProp then (error 'You need to define MetricName properties for AWS::CloudWatch::AnomalyDetector resource') else null, Namespace: if errorOnEmptyProp then (error 'You need to define Namespace properties for AWS::CloudWatch::AnomalyDetector resource') else null, Stat: if errorOnEmptyProp then (error 'You need to define Stat properties for AWS::CloudWatch::AnomalyDetector resource') else null } },
