(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::EMR::Cluster', Properties: { ServiceRole: if errorOnEmptyProp then (error 'You need to define ServiceRole properties for AWS::EMR::Cluster resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::EMR::Cluster resource') else null, JobFlowRole: if errorOnEmptyProp then (error 'You need to define JobFlowRole properties for AWS::EMR::Cluster resource') else null, Instances: if errorOnEmptyProp then (error 'You need to define Instances properties for AWS::EMR::Cluster resource') else null } },
