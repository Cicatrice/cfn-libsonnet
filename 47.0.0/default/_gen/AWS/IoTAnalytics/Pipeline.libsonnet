(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::IoTAnalytics::Pipeline', Properties: { PipelineActivities: if errorOnEmptyProp then (error 'You need to define PipelineActivities properties for AWS::IoTAnalytics::Pipeline resource') else null, PipelineName: if errorOnEmptyProp then (error 'You need to define PipelineName properties for AWS::IoTAnalytics::Pipeline resource') else null } },
