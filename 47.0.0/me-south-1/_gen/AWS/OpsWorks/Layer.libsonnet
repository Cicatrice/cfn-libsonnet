(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::OpsWorks::Layer', Properties: { Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::OpsWorks::Layer resource') else null, Shortname: if errorOnEmptyProp then (error 'You need to define Shortname properties for AWS::OpsWorks::Layer resource') else null, AutoAssignPublicIps: if errorOnEmptyProp then (error 'You need to define AutoAssignPublicIps properties for AWS::OpsWorks::Layer resource') else null, EnableAutoHealing: if errorOnEmptyProp then (error 'You need to define EnableAutoHealing properties for AWS::OpsWorks::Layer resource') else null, Type: if errorOnEmptyProp then (error 'You need to define Type properties for AWS::OpsWorks::Layer resource') else null, AutoAssignElasticIps: if errorOnEmptyProp then (error 'You need to define AutoAssignElasticIps properties for AWS::OpsWorks::Layer resource') else null, StackId: if errorOnEmptyProp then (error 'You need to define StackId properties for AWS::OpsWorks::Layer resource') else null } },
