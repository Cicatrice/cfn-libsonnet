(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::EC2::NetworkInterfaceAttachment', Properties: { DeviceIndex: if errorOnEmptyProp then (error 'You need to define DeviceIndex properties for AWS::EC2::NetworkInterfaceAttachment resource') else null, InstanceId: if errorOnEmptyProp then (error 'You need to define InstanceId properties for AWS::EC2::NetworkInterfaceAttachment resource') else null, NetworkInterfaceId: if errorOnEmptyProp then (error 'You need to define NetworkInterfaceId properties for AWS::EC2::NetworkInterfaceAttachment resource') else null } },
