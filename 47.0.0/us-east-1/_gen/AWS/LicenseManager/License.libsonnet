(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::LicenseManager::License', Properties: { Issuer: if errorOnEmptyProp then (error 'You need to define Issuer properties for AWS::LicenseManager::License resource') else null, ConsumptionConfiguration: if errorOnEmptyProp then (error 'You need to define ConsumptionConfiguration properties for AWS::LicenseManager::License resource') else null, Entitlements: if errorOnEmptyProp then (error 'You need to define Entitlements properties for AWS::LicenseManager::License resource') else null, HomeRegion: if errorOnEmptyProp then (error 'You need to define HomeRegion properties for AWS::LicenseManager::License resource') else null, LicenseName: if errorOnEmptyProp then (error 'You need to define LicenseName properties for AWS::LicenseManager::License resource') else null, ProductName: if errorOnEmptyProp then (error 'You need to define ProductName properties for AWS::LicenseManager::License resource') else null, Validity: if errorOnEmptyProp then (error 'You need to define Validity properties for AWS::LicenseManager::License resource') else null } },
