(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Cognito::UserPoolResourceServer', Properties: { UserPoolId: if errorOnEmptyProp then (error 'You need to define UserPoolId properties for AWS::Cognito::UserPoolResourceServer resource') else null, Identifier: if errorOnEmptyProp then (error 'You need to define Identifier properties for AWS::Cognito::UserPoolResourceServer resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::Cognito::UserPoolResourceServer resource') else null } },
