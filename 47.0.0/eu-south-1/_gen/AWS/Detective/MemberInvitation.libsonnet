(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Detective::MemberInvitation', Properties: { GraphArn: if errorOnEmptyProp then (error 'You need to define GraphArn properties for AWS::Detective::MemberInvitation resource') else null, MemberEmailAddress: if errorOnEmptyProp then (error 'You need to define MemberEmailAddress properties for AWS::Detective::MemberInvitation resource') else null, MemberId: if errorOnEmptyProp then (error 'You need to define MemberId properties for AWS::Detective::MemberInvitation resource') else null } },
