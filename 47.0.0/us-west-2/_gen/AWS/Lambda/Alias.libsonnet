(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Lambda::Alias', Properties: { FunctionVersion: if errorOnEmptyProp then (error 'You need to define FunctionVersion properties for AWS::Lambda::Alias resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::Lambda::Alias resource') else null, FunctionName: if errorOnEmptyProp then (error 'You need to define FunctionName properties for AWS::Lambda::Alias resource') else null } },
