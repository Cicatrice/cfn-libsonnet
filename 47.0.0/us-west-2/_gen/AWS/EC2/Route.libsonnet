(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::EC2::Route', Properties: { RouteTableId: if errorOnEmptyProp then (error 'You need to define RouteTableId properties for AWS::EC2::Route resource') else null } },
  '#new':: d.fn(help='https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-route.html', args=[d.arg(name='errorOnEmptyProp', type=d.T.bool)]),
