(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::NimbleStudio::LaunchProfile', Properties: { StudioComponentIds: if errorOnEmptyProp then (error 'You need to define StudioComponentIds properties for AWS::NimbleStudio::LaunchProfile resource') else null, StudioId: if errorOnEmptyProp then (error 'You need to define StudioId properties for AWS::NimbleStudio::LaunchProfile resource') else null, Ec2SubnetIds: if errorOnEmptyProp then (error 'You need to define Ec2SubnetIds properties for AWS::NimbleStudio::LaunchProfile resource') else null, LaunchProfileProtocolVersions: if errorOnEmptyProp then (error 'You need to define LaunchProfileProtocolVersions properties for AWS::NimbleStudio::LaunchProfile resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::NimbleStudio::LaunchProfile resource') else null, StreamConfiguration: if errorOnEmptyProp then (error 'You need to define StreamConfiguration properties for AWS::NimbleStudio::LaunchProfile resource') else null } },
