(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::Logs::Destination', Properties: { TargetArn: if errorOnEmptyProp then (error 'You need to define TargetArn properties for AWS::Logs::Destination resource') else null, DestinationName: if errorOnEmptyProp then (error 'You need to define DestinationName properties for AWS::Logs::Destination resource') else null, DestinationPolicy: if errorOnEmptyProp then (error 'You need to define DestinationPolicy properties for AWS::Logs::Destination resource') else null, RoleArn: if errorOnEmptyProp then (error 'You need to define RoleArn properties for AWS::Logs::Destination resource') else null } },
