(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::SageMaker::App', Properties: { UserProfileName: if errorOnEmptyProp then (error 'You need to define UserProfileName properties for AWS::SageMaker::App resource') else null, AppName: if errorOnEmptyProp then (error 'You need to define AppName properties for AWS::SageMaker::App resource') else null, AppType: if errorOnEmptyProp then (error 'You need to define AppType properties for AWS::SageMaker::App resource') else null, DomainId: if errorOnEmptyProp then (error 'You need to define DomainId properties for AWS::SageMaker::App resource') else null } },
