(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::AppConfig::ConfigurationProfile', Properties: { LocationUri: if errorOnEmptyProp then (error 'You need to define LocationUri properties for AWS::AppConfig::ConfigurationProfile resource') else null, Name: if errorOnEmptyProp then (error 'You need to define Name properties for AWS::AppConfig::ConfigurationProfile resource') else null, ApplicationId: if errorOnEmptyProp then (error 'You need to define ApplicationId properties for AWS::AppConfig::ConfigurationProfile resource') else null } },
