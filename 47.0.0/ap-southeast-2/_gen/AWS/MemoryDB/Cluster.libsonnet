(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::MemoryDB::Cluster', Properties: { ACLName: if errorOnEmptyProp then (error 'You need to define ACLName properties for AWS::MemoryDB::Cluster resource') else null, ClusterName: if errorOnEmptyProp then (error 'You need to define ClusterName properties for AWS::MemoryDB::Cluster resource') else null, NodeType: if errorOnEmptyProp then (error 'You need to define NodeType properties for AWS::MemoryDB::Cluster resource') else null } },
