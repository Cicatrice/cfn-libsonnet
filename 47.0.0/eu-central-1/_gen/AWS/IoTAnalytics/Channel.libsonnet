(import '../../../extensions/attributes.libsonnet') + {
  ...
  new(errorOnEmptyProp=true): { Type: 'AWS::IoTAnalytics::Channel', Properties: { ChannelName: if errorOnEmptyProp then (error 'You need to define ChannelName properties for AWS::IoTAnalytics::Channel resource') else null } },
